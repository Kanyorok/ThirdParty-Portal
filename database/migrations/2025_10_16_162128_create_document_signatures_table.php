...
return new class extends Migration {
    ...
    {
        Schema::create('t_DMSSignatures', static function (Blueprint $table) {
            $table->id('Id');
            $table->string('SignatureId', 200)->unique();
            $table->string('Name');
            $table->longText('Description')->nullable();
            $table->char('Visibility', 3)->default(VisibilityEnum::Private->value)->comment('pub,pri');
            $table->foreignId('ImageId')->nullable()->constrained('t_Documents', 'Id')->noActionOnDelete();
            ...
            $table->string('Content');#userId# #datetime#
        ...
        Schema::create('t_DocumentSignatures', static function (Blueprint $table) {
            $table->id('Id');
            $table->foreignId('DocumentId')->constrained('t_Documents', 'Id')->cascadeOnDelete();
            $table->foreignId('SignatureId')->constrained('t_DMSSignatures', 'Id')->noActionOnDelete();
