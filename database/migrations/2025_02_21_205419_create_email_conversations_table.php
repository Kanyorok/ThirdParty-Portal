...
return new class extends Migration {
    ...
    {
        Schema::create('t_EmailsConversations', static function (Blueprint $table) {
            $table->id('Id');
            $table->unsignedBigInteger('Emails')->default(1)->comment('Number of Emails in Conversation');
            $table->foreignId('EmailId')->comment('Latest Email of Conversation')->constrained('t_Emails', 'EmailID');
        ...
        Schema::table('t_Emails', static function (Blueprint $table) {
            $table->foreignId('EmailConversationId')->nullable()->after('Source')->constrained('t_EmailsConversations', 'Id');
