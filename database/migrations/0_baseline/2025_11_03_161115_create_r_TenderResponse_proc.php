...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE    PROC [dbo].[r_TenderResponse] @FromDate smalldatetime = null,
...
BEGIN
   ...
   INSERT INTO #TenderResponse
    SELECT I.InvitationId,
           T.Title        as TenderId,
           S.ThirdPartyName as SupplierId,
           I.InvitationDate,
           I.ResponseStatus,
           I.ResponseDate,
           I.DeclineReason,
    ...
    FROM t_TenderInvitations I
             ...
             JOIN t_ThirdParties S ON S.ID = I.SupplierID
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS r_TenderResponse");
    }
};
