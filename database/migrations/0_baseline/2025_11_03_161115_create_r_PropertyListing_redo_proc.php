...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE       PROCEDURE [dbo].[r_PropertyListing_redo]      
    @PropertyTypeName VARCHAR(200) = NULL      
AS        
BEGIN        
    SET NOCOUNT ON;      
           
    CREATE TABLE #SelectedTypes (PropertyTypeName VARCHAR(200));  
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS r_PropertyListing_redo");
    }
};
