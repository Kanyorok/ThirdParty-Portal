...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('t_OrderLines', function (Blueprint $table) {
            ...
            $table->bigInteger('iOrderID')->index();
            ...
            $table->integer('iStockCodeID')->nullable()->index();
            ...
            $table->decimal('TaxPercentage', 5)->default(0);
            $table->decimal('DiscountPercentage', 5)->default(0);

            $table->primary(['Id'], 'pk__t_orderl__3214ec0790f413cf');
        });
    }
