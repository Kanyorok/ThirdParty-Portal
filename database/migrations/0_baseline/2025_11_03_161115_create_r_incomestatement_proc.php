...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE   PROCEDURE r_incomestatement
    @ReportDate DATETIME,
...
--go
--EXEC  r_incomestatement

--	@Reportdate ='23 OCT 2025',
--	@branchID = 'Head Office,DODOMA,Moshi,TABORA,TANDAHIMBA',
--	@GLAccountType ='Income,Liability'
");
    }
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS r_incomestatement");
    }
};
