...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE PROC [dbo].[sp_generate_inserts]
(
	...
	BEGIN
		...
		CASE 
			...
			WHEN @Data_Type IN ('uniqueidentifier') 
				THEN  
					'COALESCE('''''''' + REPLACE(CONVERT(char(2000),RTRIM(' + @Column_Name + ')),'''''''','''''''''''')+'''''''',''NULL'')'
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS sp_generate_inserts");
    }
};
