...
return new class extends Migration
{
    ...
    {
        DB::unprepared("CREATE   PROC [dbo].[r_Interbranchrequisitions_TEST] @FromDate DATETIME = NULL,
...
");
    ...
    {
        DB::unprepared("DROP PROCEDURE IF EXISTS r_Interbranchrequisitions_TEST");
    }
};
