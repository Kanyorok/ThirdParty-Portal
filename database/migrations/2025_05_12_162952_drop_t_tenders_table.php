   ...
   /**
    ...
    public function up(): void
    {
        Schema::create('t_Tenders', function (Blueprint $table) {            
            ...
            $table->foreign('RelatedPRID')->references('RelatedPRID')->on('t_Requisitions')->onDelete('set null');
            $table->foreign('ProcurementModeId')->references('ProcurementModeId')->on('t_ProcurementModes')->onDelete('set null');
            $table->foreign('CreatedBy')->references('UserID')->on('t_Users')->onDelete('cascade');
            $table->foreign('ModifiedBy')->references('UserID')->on('t_Users')->onDelete('set null');
