...
return new class extends Migration
{
    ...
    {
        Schema::create('t_FleetDriverAssignments', function (Blueprint $table) {
            ...
            $table->primary(['Id'], 'pk__t_fleetd__3214ec07a5eb6842');
        });
    }
    ...
    {
        Schema::dropIfExists('t_FleetDriverAssignments');
    }
};
