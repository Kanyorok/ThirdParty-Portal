...
return new class extends Migration {
    ...
    {
        try {
            DB::statement("ALTER TABLE dbo.t_ApplicationCategoryStatus DROP CONSTRAINT FK_AppCatStatus_Application");
        } catch (\Throwable $e) {
        }
        try {
            DB::statement("ALTER TABLE dbo.t_ApplicationCategoryStatus DROP CONSTRAINT FK_AppCatStatus_Category");
        } catch (\Throwable $e) {
        }
        try {
            DB::statement("ALTER TABLE dbo.t_ApplicationCategoryStatus DROP CONSTRAINT FK_AppCatStatus_CreatedBy");
        } catch (\Throwable $e) {
        }
        try {
            DB::statement("ALTER TABLE dbo.t_ApplicationCategoryStatus DROP CONSTRAINT FK_AppCatStatus_ModifiedBy");
        } catch (\Throwable $e) {
        }
        try {
            DB::statement("ALTER TABLE dbo.t_ApplicationCategoryStatus DROP CONSTRAINT FK_AppCatStatus_DeletedBy");
        } catch (\Throwable $e) {
        }
