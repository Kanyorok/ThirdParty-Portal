...
class ModifyAndAlterApprovalTables extends Migration
{
    public function up(): void
    {
        ...
        // Create new workflow types table
    ...
    public function down(): void
    {
        ...
        Schema::create('t_PendingWorkflows', function (Blueprint $table) {
            $table->id('Id');
            $table->string("Source");
            $table->string("SourceID", 100);
            $table->string("Stage", 200);
