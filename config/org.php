...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | This value is the name of your organisation, which will be used when the
    | application needs to place the organisation's name in a notification or
    | other UI elements where an organisation name needs to be displayed.
    |
    */
