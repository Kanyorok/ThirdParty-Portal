    ...
    <script>const $Modal = $('#ticketActionsModal'), $commentsMessage = $('#commentsMessage');
        ...
        $(function () {
            ...
            $('#ticket_priority').on('change', async function () {
                let ticketPriorityMsg = $("#ticketPriorityMsg");
                ticketPriorityMsg.removeClass('d-none')
                await saveForm($('form#ticketPriorityForm'), ticketPriorityMsg, false, true, true);
                ticketPriorityMsg.addClass('d-none')
            });
