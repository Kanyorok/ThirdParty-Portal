...
@section('content')
    <div class="row">
            ...
            <div class="card mb-3">
                <form class="card-body row  px-2" id="searchForm">
                    <div class="col-12 col-md-10">
                        <input type="search" class="form-control w-100 search-form-item" name="phone" autocomplete="off" maxlength="50" id="phone"
        ...
        @else
                ...
                <div class="col-md-8 col-xxl-9">
                        <div class="card">
                            ...
                            <div class="card-body row">
                                <form action="{{ route('client-calls.store',[$party->ClientID]) }}" method="post" id="StartCallForm">
                                    @csrf
                                    <div class="mb-3">
            ...
            @elseif($party instanceof \App\Models\Lead)
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item"><b>Last Contacted </b><span
                                        class="float-end">{{ $party->LastContacted?->format('d M, Y h:i A') }}</span></li>
                            </ul>
                ...
                <div class="col-md-8 col-xxl-9">
                        <div class="card">
                            ...
                            <div class="card-body">
                                @if($party->RelationshipManager instanceof \App\Models\User)
                        ...
                        <div class="card">
                            ...
                            <div class="card-body row">
                                <form action="{{ route('lead-calls.store',[$party->LeadID]) }}" method="post" id="StartCallForm">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label" for="call_initiated">Call Time <span
                                                class="text-danger">*</span></label>
            ...
            @elseif($party instanceof \App\Models\Contact)
                <div class="col-md-4 col-xxl-3">
                    <div class="card">
                        <div class="card-header">
                ...
                <div class="col-md-8 col-xxl-9">
                    <div class="card">
                            ...
                            <div class="card-body row">
                                <form  action="{{ route('contacts-calls.store',[$party->ContactID]) }}" method="post" id="StartCallForm">
                                    @csrf
                                    <div class="mb-3">
                                        <label class="form-label" for="call_initiated">Call Time <span
                                                class="text-danger">*</span></label>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body row">
                            <form action="{{ route('contact.call.incoming.start') }}" method="post" id="StartCallForm">
                                ...
                                <div class="mb-3">
                                    <label class="form-label" for="Phone">Caller Phone No <span class="text-danger">*</span></label>
