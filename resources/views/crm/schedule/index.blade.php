        ...
        <div class="modal-body">
          @can('meetings', User::class)
            <div class="onboarding-content with-gradient d-none modal-item" id="createStaffMeetingModal">
              <form action="{{ route('user-meetings.store') }}" method="post" id="createStaffMeetingForm" class="row">
                @csrf
                <div class="col-md-6 col-12 mb-3">
                  <label for="StaffMeetingTitle" class="form-label">Title <span class="text-danger">*</span></label>
                  <input type="text" class="form-control" required id="StaffMeetingTitle" name="StaffMeetingTitle"
                    placeholder="Title">
                  <p id="StaffMeetingTitle_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <div class="col-md-6 col-12 mb-3">
                  <label for="StaffMeetingLocation" class="form-label">Location <span class="text-danger">*</span></label>
                  <select class="form-control" name="StaffMeetingLocation" required id="StaffMeetingLocation">
                  ...
                  <p id="StaffMeetingLocation_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <div class="col-md-6 col-12 mb-3">
                  <label class="form-label" for="StaffMeetingStart">Start <span class="text-danger">*</span></label>
                  ...
                  <p id="StaffMeetingStart_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <div class="col-md-6 col-12 mb-3">
                  <label class="form-label" for="StaffMeetingEnd">End <span class="text-danger">*</span></label>
                  <input type="text" class="form-control flatpickr-datetime " id="StaffMeetingEnd" name="StaffMeetingEnd"
                    placeholder="Select end..">
                  <p id="StaffMeetingEnd_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <div class="mb-3 col-12">
                  <label for="StaffMeetingUsers" class="form-label">Users & Teams </label>
                  <select class="form-control " name="StaffMeetingUsers[]" id="StaffMeetingUsers" required multiple>
                    <option value="{{ auth()->user()->UserID }}" selected>{{ auth()->user()->Name }}
                      - {{ auth()->user()->UserID }}</option>
                  </select>
                  <p id="StaffMeetingUsers_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <div class="mb-3 col-12">
                  <label class="form-label" for="StaffMeetingAgenda">Agenda <span class="text-danger">*</span></label>
                  <textarea name="StaffMeetingAgenda" id="StaffMeetingAgenda" rows="4" class="form-control" required
                    minlength="2"></textarea>
                  <p id="StaffMeetingAgenda_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                </div>
                <hr>
                <div class="mt-4">
