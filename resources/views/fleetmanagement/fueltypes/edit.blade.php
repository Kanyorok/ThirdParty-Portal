...
<div class="container mt-4">
    ...
    <form action="{{ route('fueltypes.update', $fuelType->Id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="FuelName" id="FuelName" class="form-control" value="{{ old('FuelName', $fuelType->FuelName) }}" required>
        </div>

        <div class="mb-3">
            <label for="Description" class="form-label">Description</label>
            <textarea name="Description" id="Description" class="form-control">{{ old('Description', $fuelType->Description) }}</textarea>
        </div>
