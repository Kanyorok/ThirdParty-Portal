                ...
                <form action="{{ route('drivermanagement.update', $driver->Id) }}" method="POST">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="date" class="form-control" name="LicenseExpiryDate"
                                   value="{{ old('LicenseExpiryDate', $driver->LicenseExpiryDate) }}" required>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <select class="form-control" name="EmploymentStatus" required>
                                ...
                                @foreach($employmentStatus as $status)
                                    <option
                                        value="{{ $status->ID }}" {{ old('EmploymentStatus', $driver->EmploymentStatus) == $status->ID ? 'selected' : '' }}>
                                        {{ $status->Description }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="Remarks"
                                   value="{{ old('Remarks', $driver->Remarks) }}">
                        </div>
                    </div>
