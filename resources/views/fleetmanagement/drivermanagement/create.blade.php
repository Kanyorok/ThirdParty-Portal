            ...
            <form action="{{ route('drivermanagement.store') }}" method="POST">
                ...
                <div class="form-row">
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id="full_name" name="DriverName" value="{{ old('DriverName') }}" required>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="date" class="form-control" id="expiry_date" name="LicenseExpiryDate" value="{{ old('LicenseExpiryDate') }}" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group  col-md-3">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    @foreach($employmentStatus as $status)
                        <option value="{{ $status->ID }}" {{ old('EmploymentStatus') == $status->ID ? 'selected' : '' }}>
                            {{ $status->Description }}
                        </option>
                    @endforeach
                    </select>
