    ...
    <table class="table table-bordered table-striped">
        ...
        @forelse($trainings as $training)
            <tr>
                ...
                <td>
                    <a href="{{ route('legal.setup.training_types.edit', $training->Id) }}" class="btn btn-sm btn-warning">✏️ Edit</a>
                    <form action="{{ route('legal.setup.training_types.destroy', $training->Id) }}" method="POST" style="display:inline;">
                        @csrf @method('DELETE')
