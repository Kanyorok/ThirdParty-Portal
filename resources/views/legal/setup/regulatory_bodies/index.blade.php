...
@section('content')
    <div class="card-header bg-light px-3 py-2 d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('legal.setup.regulatory_bodies.create') }}" class="btn btn-primary mb-3">➕ Add Regulatory
            Body</a>
    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            @forelse($bodies as $body)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('legal.setup.regulatory_bodies.edit', $body->Id) }}"
                           class="btn btn-sm btn-warning">✏️ Edit</a>
                        <form action="{{ route('legal.setup.regulatory_bodies.destroy', $body->Id) }}" method="POST"
