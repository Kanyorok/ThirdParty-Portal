...
@section('content')
    ...
    <div class="card-header bg-light px-3 py-2 d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('legal.setup.policy_categories.create') }}" class="btn btn-primary mb-3">➕ Add Policy
            Category</a>
    </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            @forelse($categories as $category)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('legal.setup.policy_categories.edit', $category->Id) }}"
                           class="btn btn-sm btn-warning">✏️ Edit</a>
                        <form action="{{ route('legal.setup.policy_categories.destroy', $category->Id) }}" method="POST"
