...
<h4 class="text-info mb-0"></h4>
  <a href="{{ route('legal.setup.control_types.create') }}" class="btn btn-primary mb-3">➕ Add Control Type</a>
    </div>
    ...
    @endif
        ...
        @forelse($controls as $control)
            <tr>
                ...
                <td>
                    <a href="{{ route('legal.setup.control_types.edit', $control->Id) }}" class="btn btn-sm btn-warning">✏️ Edit</a>
                    <form action="{{ route('legal.setup.control_types.destroy', $control->Id) }}" method="POST" style="display:inline;">
                        @csrf @method('DELETE')
