...
@section('content')
    <div class="card p-4 shadow rounded-4">
        <div class="card-header bg-light py-2 px-3 d-flex justify-content-between align-items-centre mb-3">
            ...
            <a href="{{ route('legal.clauses.create') }}" class="btn btn-info"><i class="fas fa-plus me-1"></i> Add
                Clause</a>
        </div>
        <div class="card-body">
            <p class="text-muted">Browse, manage, and update standard legal clauses and templates for quick inclusion in
                contracts and legal documents.</p>
                        ...
                        @foreach ($clauses as $clause)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('legal.clauses.show', $clause->Id) }}"
                                       class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('legal.clauses.edit', $clause->Id) }}"
