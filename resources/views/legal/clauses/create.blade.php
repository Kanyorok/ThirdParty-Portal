            ...
            <form action="{{ route('legal.clauses.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="Title" class="form-control" placeholder="e.g. Confidentiality Clause"
                               required>
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.0001" name="Version" class="form-control" placeholder="e.g. 1.0"
                           required>
                </div>
                ...
                <div class="d-flex justify-content-end gap-2 text-end mb-3">
                    <a href="{{ route('legal.clauses.index') }}" class="btn btn-outline-secondary"><i
                    ...
                    <button class="btn btn-info"
                        ...
                        <i class="fas fa-save"></i> Save Clause
                    </button>
                </div>
            </form>
        </div>
