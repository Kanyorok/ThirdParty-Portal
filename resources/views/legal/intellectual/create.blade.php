        ...
        <form method="POST" action="{{ route('legal.intellectual.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="IPType" id="IPType">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="RegistrationNumber" class="form-control" placeholder="Unique registration number">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" name="RegistrationDate" class="form-control" placeholder="Select registration date">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Expiry Date</label>
                    <input type="date" name="ExpiryDate" class="form-control" placeholder="Select expiry date">
                </div>
            </div>

            <div class="mb-3">
                <label class="form-label">Remarks</label>
                <textarea name="Remarks" class="form-control" rows="3" placeholder="Additional notes or details"></textarea>
            </div>
