        ...
        <form method="POST" action="{{ route('legal.intellectual.store') }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="Owner" class="form-control" placeholder="Name of the owner or organization" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Registration Number</label>
                    <input type="text" name="RegistrationNumber" class="form-control" placeholder="Unique registration number" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="date" name="RegistrationDate" class="form-control" placeholder="Select registration date" required>
                </div>
                <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <textarea name="Remarks" class="form-control" rows="3" placeholder="Additional notes or details" required></textarea>
            </div>
