...
@section('content')
    <div class="card shadow p-1 rounded-4">
        <div class="card-body">
            <p class="text-muted">
                Use this form to register new Intellectual Property (IP) details such as trademarks, patents, or
                copyrights.
            ...
            <form method="POST" action="{{ route('legal.intellectual.store') }}">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="Owner" class="form-control"
                               placeholder="Name of the owner or organization" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="d-flex justify-content-end gap-2 mb-3">
                    <a href="{{ route('legal.intellectual.index') }}" class="btn btn-outline-secondary"><i
