    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route('legal.intellectual.update', $record->Id) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="Owner" class="form-control" 
                        value="{{ $record->Owner }}" placeholder="Name of the owner or organization">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Registration Number</label>
                    <input type="text" name="RegistrationNumber" class="form-control" 
                        value="{{ $record->RegistrationNumber }}" placeholder="Unique registration number">
                </div>
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea name="Remarks" class="form-control" rows="3" placeholder="Additional notes or details">{{ $record->Remarks }}</textarea>
            </div>
