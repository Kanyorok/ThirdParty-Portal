                ...
                <form action="{{ route('legal.cases.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="CaseTitle" value="{{ old('CaseTitle', $case->CaseTitle ?? '') }}"
                                   class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Case Number</label>
                            <input type="text" name="CaseNumber"
                                   value="{{ old('CaseNumber', $case->CaseNumber ?? '') }}" class="form-control"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" name="FilingDate"
                                   value="{{ old('FilingDate', $case->FilingDate ?? '') }}" class="form-control"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="OpposingParty"
                                   value="{{ old('OpposingParty', $case->OpposingParty ?? '') }}" class="form-control"
                                   required>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="d-flex justify-content-end gap-2 mb-3">
                        <a href="{{ route('legal.cases.index') }}" class="btn btn-outline-secondary"><i
