    ...
    <div class="card shadow-sm border rounded-4 overflow-hidden">
        ...
        <div class="card-header bg-light d-flex justify-content-between align-items-center py-3">
            <h5 class="text-info mb-0">
                <i class="fas fa-user-edit"></i> Edit Counsel: <span class="fw-semibold">{{ $counsel->CounselName }}</span>
            </h5>
        ...
        <div class="card-body bg-white">
            ...
            <form method="POST" action="{{ route('legal.disputes.counsels.update', [$case->Id, $counsel->Id]) }}" class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="CounselName" value="{{ $counsel->CounselName }}" class="form-control shadow-sm" required>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="Phone" value="{{ $counsel->Phone }}" class="form-control shadow-sm" required>
                </div>
