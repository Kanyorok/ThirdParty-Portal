        ...
        <div class="card-body mb-0">
            ...
            <form method="POST" action="{{ route('legal.disputes.outcomes.update', [$case->Id, $outcome->Id]) }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="CourtDecision" class="form-control" rows="3"
                        required>{{ old('CourtDecision', $outcome->CourtDecision) }}</textarea>
                </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="Remarks" class="form-control" rows="3"
                            required>{{ old('Remarks', $outcome->Remarks) }}</textarea>
                    </div>
                </div>
