...
@section('content')
    <div class="card p-4 shadow rounded-4 border-0 mb-0">
        <div class="card-header bg-light px-3 py-2 d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('legal.cases.create') }}" class="btn btn-info"><i class="fas fa-plus me-1"></i> New Legal
                Case</a>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('legal.cases.evidence.index', $case->Id) }}"
                                       class="btn btn-sm btn-dark">📂 Evidence</a>
                                    <a href="{{ route('legal.cases.show', $case->Id) }}" class="btn btn-sm btn-info"><i
                                            class="fas fa-eye"></i></a>
                                    <a href="{{ route('legal.cases.edit', $case->Id) }}" class="btn btn-sm btn-primary"><i
