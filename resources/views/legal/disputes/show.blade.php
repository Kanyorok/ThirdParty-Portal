                            ...
                            <tr>
                                <td colspan="8" class="p-0">
                                    <div class="text-center p-4 border rounded-3 bg-light">
                                        ...
                                        <a href="{{ route('legal.disputes.counsels.create', $case->Id) }}"
                    ...
                    @if($outcomes->count())
                        @foreach ($outcomes as $item)
                            <tr>
                                ...
                                <td>{{ $item->Remarks }}</td>
                                <td>
                                    <a href="{{ route('legal.disputes.outcomes.show',[$case->Id, $item->Id]) }}"
                                       class="btn btn-sm btn-info" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('legal.disputes.outcomes.edit', [$case->Id, $item->Id]) }}"
                                       class="btn btn-sm btn-primary" title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <button type="button"
                        ...
                        <tr>
                            <td colspan="7" class="p-0">
                                <div class="text-centre p-4 border rounded-3 bg-light">
                                    ...
                                    <a href="{{ route('legal.disputes.outcomes.create', $case->Id) }}"
                                       class="btn btn-info px-4 py-2">
