                ...
                <form method="POST" action="{{ route('legal.cases.evidence.update', [$cases->Id, $evidence->Id]) }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="DMSDocumentID"
                                   value="{{ old('DMSDocumentID', $evidence->DMSDocumentID) }}" class="form-control">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">External File Link (optional)</label>
                            <input type="url" name="ExternalLink"
                                   value="{{ old('ExternalLink', $evidence->ExternalLink) }}" class="form-control"
