                ...
                <form action="{{ route('legal.templates.store') }}" method="POST" id="templateForm">
                    ...
                    <div class="card shadow rounded-4">
                        <div class="card-header bg-light py-2 px-3 d-flex align-items-center justify-content-between">
                            <h5 class="mb-0 text-info"><i class="fa-solid fa-file-signature me-2"></i> Add New Template
                            </h5>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="TemplateName" class="form-control"
                                           placeholder="e.g. Master Services Agreement" required>
                                </div>
                                <div class="col-md-3">
                                    <label class="form-label">Document Type</label>
                                    <input type="text" name="DocumentType" class="form-control"
                                           placeholder="e.g. Contract / NDA / Lease">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="Description" class="form-control" rows="2"
                                              placeholder="Short summary for internal reference..."></textarea>
                                </div>
                            </div>
                ...
                <div class="sticky-col">
                    ...
                    <div class="card shadow rounded-4 mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div class="input-group mb-2">
                                <input type="text" id="clause-search" class="form-control"
                                       placeholder="Search clauses (title/text/type)…">
                                <button class="btn btn-outline-secondary" id="clearSearch" type="button"><i
                                        class="fa-solid fa-xmark"></i></button>
                            </div>

                            <div id="libraryState" class="text-center small text-muted my-2">
                                Loaded {{ ($clauses ?? collect())->count() }} clauses.
                            </div>
                    ...
                    <div class="card shadow rounded-4">
                        <div class="card-header bg-light py-2 px-3 d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                <button class="btn btn-sm btn-outline-primary" id="insertAll"><i
                                        class="fa-solid fa-download me-1"></i> Insert All
                                </button>
                                <button class="btn btn-sm btn-outline-danger" id="clearSelected"><i
                                        class="fa-solid fa-trash-can me-1"></i> Clear
                                </button>
                            </div>
                        </div>
                        <div class="card-body">
...
@section('scripts')
    ...
    <script>
        ...
        function syncHidden() {
            hiddenIds.value = JSON.stringify(selected.map(x => x.id));
        }
