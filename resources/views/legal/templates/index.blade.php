...
<div class="card p-4 shadow rounded-4 border-0">
    <div class="card-header bg-light px-3 py-2 d-flex justify-content-between align-items-center mb-3">
        <h4 class="text-info mb-0"><i class="fas fa-file-alt"></i> Template Library</h4>
        <a href="{{ route('legal.templates.create') }}" class="btn btn-info"><i class="fas fa-plus me-1"></i> Add Template</a>
    </div>

    <div class="card-body px-4 py-4">
        <p class="text-muted"></p>
        <table class="table table-hover table-sm align-middle text-centre"
            xstyle="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;">
            <thead>
                <tr>
                    <th>Template Name</th>
                    <th>Document Type</th>
