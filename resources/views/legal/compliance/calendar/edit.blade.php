        ...
        <div class="row">
           ...
           <div class="col-md-3 mb-3">
                <div class="form-check mt-4">
                    <input type="checkbox" name="IsRecurring" class="form-check-input" value="1" {{ $entry->IsRecurring ? 'checked' : '' }}>
            ...
            <div class="col-md-3 mb-3">
                ...
                <select name="RecurrenceType" class="form-select">
                    <option value="">-- None --</option>
                    <option value="Monthly" {{ $entry->RecurrenceType == 'Monthly' ? 'selected' : '' }}>Monthly</option>
                    <option value="Quarterly" {{ $entry->RecurrenceType == 'Quarterly' ? 'selected' : '' }}>Quarterly</option>
                    <option value="Annually" {{ $entry->RecurrenceType == 'Annually' ? 'selected' : '' }}>Annually</option>
                </select>
            </div>
            ...
            <div class="col-12 mb-3">
                <div class="form-check">
                    <input type="checkbox" name="IsActive" class="form-check-input" value="1" {{ !$entry->DeletedOn ? 'checked' : '' }}>
