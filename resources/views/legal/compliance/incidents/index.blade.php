...
<div class="d-flex justify-content-between mb-3">
    ...
    <div>
        <a href="{{ route('legal.compliance.incidents.dashboard') }}" class="btn btn-sm btn-outline-primary me-2">📊 Dashboard</a>
        <a href="{{ route('legal.compliance.incidents.create') }}" class="btn btn-sm btn-primary">➕ Log Incident</a>
    </div>    
</div>
        ...
        <tbody>
            @forelse($incidents as $incident)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('legal.compliance.incidents.show',$incident->Id) }}" class="btn btn-sm btn-info">🔍</a>
                        <a href="{{ route('legal.compliance.incidents.edit',$incident->Id) }}" class="btn btn-sm btn-warning">✏️</a>
                    </td>
                </tr>
            @empty
