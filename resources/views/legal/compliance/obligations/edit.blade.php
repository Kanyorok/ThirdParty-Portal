    ...
    <form method="POST" action="{{ route('legal.compliance.obligations.update', $obligation->Id) }}">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="date" name="EffectiveDate" value="{{ $obligation->EffectiveDate }}" class="form-control">
            </div>
            ...
            <div class="col-12 mb-3">
                <div class="form-check">
                    <input type="checkbox" name="IsActive" class="form-check-input" value="1" {{ $obligation->IsActive ? 'checked' : '' }}>
