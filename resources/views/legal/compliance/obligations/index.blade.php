...
@section('content')
    <div class="card shadow rounded-4 p-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('legal.compliance.obligations.create') }}" class="btn btn-sm btn-primary">➕ Add
                Obligation</a>
        </div>
        ...
        <table class="table table-bordered table-striped">
            ...
            @forelse($obligations as $obligation)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('legal.compliance.obligations.show', $obligation->Id) }}"
                           class="btn btn-sm btn-info">🔍</a>
                        <a href="{{ route('legal.compliance.obligations.edit', $obligation->Id) }}"
