    ...
    <table class="table table-bordered table-striped">
        ...
        @forelse($controls as $control)
            <tr>
                ...
                <td>
                    <a href="{{ route('legal.compliance.controls.show',$control->Id) }}" class="btn btn-sm btn-info">🔍</a>
                    <a href="{{ route('legal.compliance.controls.edit',$control->Id) }}" class="btn btn-sm btn-warning">✏️</a>
                </td>
            </tr>
        @empty
            <tr><td colspan="6" class="text-center">No controls found</td></tr>
        @endforelse
        </tbody>
    </table>
</div>
