...
@section('content')
    <div class="card p-4 shadow rounded-4">
        <div class="card-header bg-light px-3 py-2 d-flex justify-content-between align-items-center mb-1">
            ...
            <a href="{{ route('legal.securities.create') }}" class="btn btn-info"><i class="fas fa-plus me-1"></i>
                Register Security</a>
        </div>
        <div class="card-body">
                        ...
                        @foreach ($securities as $sec)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('legal.securities.show', $sec->Id) }}"
                                       class="btn btn-sm btn-info"><i class="fas fa-eye"></i></a>
                                    <a href="{{ route('legal.securities.edit', $sec->Id) }}"
