...
@section('content')
    <div class="card p-0 shadow rounded-4 border-0">
        ...
        <div class="card-body">
            <p class="text-muted">Record a new legal obligation, including its details, deadlines, and responsible
                parties, to ensure proper monitoring and compliance.</p>
            @if(session('error'))
            ...
            <form action="{{ route('legal.obligations.store') }}" method="POST">
                ...
                <div class="d-flex justify-content-end gap-2 mb-3">
                    <a href="{{ route('legal.obligations.index') }}" class="btn btn-outline-secondary"><i
                    ...
                    <button type="submit" class="btn btn-info"
                        ...
                        <i class="fas fa-save"></i> Save Obligation
                    </button>
                </div>
            </form>
        </div>
