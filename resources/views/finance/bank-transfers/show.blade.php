...
<div class="card">
  <div class="card-body">
    <div class="row g-2">
      ...
      <div class="col-md-6"><strong>From:</strong> {{ optional($row->fromAccount->bank)->BankName }} — {{ $row->fromAccount?->AccountNumber }}</div>
      <div class="col-md-6"><strong>To:</strong> {{ optional($row->toAccount->bank)->BankName }} — {{ $row->toAccount?->AccountNumber }}</div>
