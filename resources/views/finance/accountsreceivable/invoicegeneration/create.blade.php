                        ...
                        <div id="creditPanel" class="alert alert-info" style="display: none;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <small class="text-muted">Check this to apply invoice against customer's credit limit</small>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="invoice-line mb-3">
                                        <div class="row g-2">
                                            <div class="col-md-4">
                                                ...
                                                <input type="text" class="form-control" name="lines[0][description]" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Quantity <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control quantity" name="lines[0][quantity]" 
                                                       min="0.01" step="0.01" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Unit Cost <span class="text-danger">*</span></label>
                                                <input type="number" class="form-control unit-cost" name="lines[0][unit_cost]" 
                                                       min="0" step="0.01" required>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">Total</label>
                                                <input type="number" class="form-control line-total" name="lines[0][total]" 
                                                       readonly>
                                            </div>
                                            <div class="col-md-2">
                                                <label class="form-label">&nbsp;</label>
                                                <button type="button" class="btn btn-outline-danger w-100 remove-line" disabled>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col text-end">
                                                <input type="number" class="form-control form-control-sm" 
                                                       id="TaxAmount" name="TaxAmount" value="0" min="0" step="0.01">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            <div class="col"><strong>Total:</strong></div>
                                            <div class="col text-end"><strong>KSh <span id="total">0.00</span></strong></div>
                                        </div>
