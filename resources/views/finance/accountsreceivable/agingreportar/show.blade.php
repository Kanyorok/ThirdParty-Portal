@extends('layouts.app')
@section('title', 'Receivable Aging Detail')
...
@section('content')
    <div class="container my-3">
        <div class="d-flex flex-wrap justify-content-between align-items-start gap-3 mb-4">
            <div>
                <h5 class="mb-1">
                    <i class="fas fa-user text-info me-2"></i> {{ $customer->ThirdPartyName }}
                </h5>
            ...
            <div class="d-flex flex-wrap gap-2">
                <a href="{{ route('agingreportar.index', ['from_date' => $filters['from_date'], 'to_date' => $filters['to_date'], 'customer_id' => $customer->Id]) }}"
            ...
            <div class="col-md-3 col-sm-6">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="small text-muted">Across buckets</div>
                    </div>
                </div>
            </div>
            <div class="col-md-3 col-sm-6">
                    ...
                    <table class="table table-striped align-middle">
                        ...
                        @forelse($invoices as $invoice)
                            <tr>
                                ...
                                <td class="text-end">KSh {{ number_format($invoice->TotalAmount ?? 0, 2) }}</td>
                                <td class="text-end">KSh {{ number_format($invoice->AmountPaid ?? 0, 2) }}</td>
                                <td class="text-end fw-semibold">KSh {{ number_format($invoice->OutstandingAmount ?? 0, 2) }}</td>
