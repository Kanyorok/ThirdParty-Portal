                                ...
                                <tr class="note-row" data-note-type="{{ $note->NoteType }}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('debitnote.show', $note->Id) }}" class="btn btn-sm btn-info me-1" title="View Note">
...
{{--                            </div>--}}
                            ...
                            <div class="mt-3">
                                ...
                                <textarea name="Description" rows="3" class="form-control" value="{{old('Description', $item->Description)}}" >{{ $item->Description}}</textarea>
                            </div>
                        </div>
                    </div>
