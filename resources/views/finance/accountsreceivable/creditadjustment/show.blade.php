    ...
    <div class="container my-3">
        ...
        <div id="printRoot" class="card shadow-sm rounded-4 border-0 p-3 p-md-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-start">
                <div>
                    <div class="h5 mb-0">Credit Adjustment — <span
                            class="fw-semibold">{{ $adjustment->customer->ThirdPartyName ?? '-' }}</span></div>
                    <div class="small text-muted">Adjustment #{{ $adjustment->Id }}
                        • {{ $adjustment->getAdjustmentTypeLabel() }}</div>
                </div>
                <div class="text-md-end mt-2 mt-md-0">
                    <div class="small text-muted">Status</div>
                    <div><span
                            class="badge {{ $adjustment->getStatusBadgeClass() }}">{{ ucfirst($adjustment->ApprovalStatus) }}</span>
                    </div>
                ...
                <div class="col-md-6">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td class="fw-medium">
                                KES {{ number_format($adjustment->creditProfile->CreditLimit, 2) }}</td>
                        </tr>
                        <tr>
                    ...
                    <form method="POST" action="{{ route('creditadjustment.approve', $adjustment->Id) }}">
                        ...
                        <div class="modal-content rounded-4 shadow">
                            ...
                            <div class="modal-body">
                                <p class="mb-3">Are you sure you want to approve this credit adjustment for
                                    <strong>{{ $adjustment->customer->ThirdPartyName }}</strong>?</p>
                                <div class="alert alert-info py-2">
                                    <strong>This will:</strong>
                                    <ul class="mb-0 mt-2">
                                        <li>Update the customer's credit limit to
                                            KES {{ number_format($adjustment->NewCreditLimit, 2) }}</li>
                ...
                <div class="modal-dialog">
                    <form method="POST" action="{{ route('creditadjustment.approve', $adjustment->Id) }}">
                        ...
                        <div class="modal-content rounded-4 shadow">
                            ...
                            <div class="modal-body">
                                <p class="mb-3">Are you sure you want to reject this credit adjustment for
                                    <strong>{{ $adjustment->customer->ThirdPartyName }}</strong>?</p>
                                <div class="mb-3">
