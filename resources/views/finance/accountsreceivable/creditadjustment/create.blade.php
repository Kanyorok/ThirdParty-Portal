    ...
    <div class="card shadow-sm rounded-3">
        ...
        <div class="card-body p-3">
            <form action="{{ route('creditadjustment.store') }}" method="POST" id="adjustmentForm">
                ...
                <div class="row mb-3">
                    <div class="col-md-12">
                        <label for="CreditID" class="form-label">Credit Profile <span class="text-danger">*</span></label>
                        <select class="form-select" disabled id="CreditID_display">
                            ...
                            @foreach($creditProfiles as $profile)
                                <option value="{{ $profile->Id }}"
                                    ...
                                    {{ $profile->customer->ThirdPartyName }} - Current: {{ number_format($profile->CreditLimit, 2) }}
                                </option>
                            @endforeach
                        </select>
...
{{--                            <span class="input-group-text">KES</span>--}}
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label for="ReferenceType" class="form-label">Reference Type <span class="text-danger">*</span></label>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary" onclick="if(this.form.checkValidity()){this.disabled=true; this.innerText='Saving...'; this.form.submit();}">
