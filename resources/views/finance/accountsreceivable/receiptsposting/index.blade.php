                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="small">
                                        ...
                                        <div class="text-muted">KSh {{ number_format($receipt->total_allocated, 2) }}
                                            applied
                                        </div>
                                        @if($receipt->UnappliedAmount > 0)
                                            <div class="text-warning small">
                                                +KSh {{ number_format($receipt->UnappliedAmount, 2) }} to wallet
                                            </div>
                                        @endif
                                    </div>
                                </td>
                                <td class="text-center">
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="{{ route('receiptsposting.show', $receipt->Id) }}"
                                        ...
                                        <button class="btn btn-sm btn-outline-secondary"
                                                onclick="window.open('{{ route('receiptsposting.show', $receipt->Id) }}', '_blank')"
                                                title="Print">
                ...
                <form method="POST" id="postReceiptForm">
                    ...
                    <div class="modal-content rounded-4 shadow">
                        ...
                        <div class="modal-body">
                            <p class="mb-3">Are you sure you want to post receipt <strong
                                    id="receiptNumberSpan"></strong>?</p>
