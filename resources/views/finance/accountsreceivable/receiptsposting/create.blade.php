...
@section('content')
    <div class="container my-3">
        <form action="{{ route('receiptsposting.store') }}" method="post" enctype="multipart/form-data"
              id="receiptForm">
            @csrf
                    ...
                    <div class="border rounded-3 p-3 mb-3">
                        <div class="row g-2 align-items-end">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="searchIdNumber" placeholder="e.g., 12345678"
                                       autocomplete="off">
                            ...
                            <div class="col-md-5 text-md-end">
                                <span id="searchHint"
                                      class="small text-muted">Enter the ID number, then click Find.</span>
                        ...
                        <div id="customerCard" class="row g-3 mt-3 d-none">
                                ...
                                <div class="card border-0 shadow-sm rounded-4">
                                    <div class="card-body">
                                        ...
                                        <div class="row small mt-2">
                                            ...
                                            <div class="col-md-4">Outstanding: <strong id="custOutstanding">—</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4">
                                <div class="alert alert-info mb-0">
                                    ...
                                    <div class="small">Tick one or more invoices and set allocation per invoice. You can
                                        auto‑allocate too.
                                    </div>
                                </div>
                            </div>
                    ...
                    <div id="invoicesBlock" class="border rounded-3 p-3 mb-3 d-none">
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-2">
                            ...
                            <div class="d-flex gap-2">
                                <button type="button" class="btn btn-sm btn-outline-secondary" id="btnSelectAll">Select
                                    All
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-secondary" id="btnClearAll">Clear
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-primary" id="btnAutoAllocate">
                                    Auto‑allocate
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-md-4">
                                            ...
                                            <input type="number" step="0.01" class="form-control" id="amountReceived"
                                                   name="AmountReceived" placeholder="0.00">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="referenceNo" name="ReferenceNo"
                                                   placeholder="e.g., TRX-883728 / M-Pesa Code">
                                        </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-4">
                                <div class="card-body">
                                    ...
                                    <div class="border rounded-3 p-2 small">
                                        ...
                                        <div>Unapplied / Overpay: <strong id="sumUnapplied">—</strong> <span
                                                id="appliedBadge" class="badge ms-1"></span></div>
                                    </div>
                                    ...
                                    <div class="small text-muted mt-2">
                                        We’ll attach this receipt to the selected invoices using the entered
                                        allocations.
                                    </div>
                                </div>
                            </div>
...
@section('scripts')
    <script>
        ...
        function balanceOf(inv) {
            return Math.max(0, (Number(inv.total) - Number(inv.paid || 0)));
        }
      ...
      <div class="toast-body">${message}</div>
        ...
        async function doSearch() {
            ...
            try {
                ...
                state.invoices = (data.invoices || []).map(x => ({
                    ...x,
                    balance: balanceOf(x),
                    allocate: 0,
                    selected: false
    ...
    `;
        ...
        document.getElementById('btnAutoAllocate').addEventListener('click', () => {
            ...
            if (received <= 0) {
                amountInput.focus();
                flash('Enter an Amount Received before auto‑allocating.', 'warning');
                return;
            }
        ...
        document.getElementById('receiptForm').addEventListener('submit', (e) => {
            ...
            if (received <= 0) {
                e.preventDefault();
                flash('Enter a valid Amount Received.', 'danger');
                return;
            }
            if (applied > received) {
                e.preventDefault();
                flash('Allocated amount exceeds Amount Received.', 'danger');
                return;
            }
