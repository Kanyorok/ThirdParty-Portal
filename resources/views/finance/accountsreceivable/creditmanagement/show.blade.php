        ...
        <div id="printRoot" class="card shadow-sm rounded-4 border-0 p-3 p-md-4">
            ...
            <div class="row g-3 mt-3">
                ...
                <div class="col-md-3">
                    <div class="border rounded-3 p-3 h-100">
                        ...
                        <div><span class="badge bg-warning text-dark">Medium</span> <span class="small text-muted">(Score 55)</span></div>
                    ...
                    <div class="border rounded-3 p-3 h-100">
                        ...
                        <div class="table-responsive">
                            <table class="table table-sm align-middle mb-0">
                                ...
                                <tr>
                                    <th>Bucket</th><th class="text-end">Amount</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr><td>0–30</td><td class="text-end">KSh 1,200,000.00</td></tr>
                                <tr><td>31–60</td><td class="text-end">KSh 1,100,000.00</td></tr>
                                <tr><td>61–90</td><td class="text-end">KSh 500,000.00</td></tr>
                                <tr class="table-light"><th>Total</th><th class="text-end">KSh 2,800,000.00</th></tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 mt-3">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-sm align-middle mb-0">
                            <thead class="table-light"><tr><th>Date</th><th>Event</th><th>User</th><th class="text-end">Delta</th></tr></thead>
                            <tbody>
                            <tr><td>2025-08-01</td><td>Profile reviewed, risk from Low→Medium</td><td>jane.nduta</td><td class="text-end">—</td></tr>
                            <tr><td>2025-05-10</td><td>Limit increased</td><td>daniel.m</td><td class="text-end">+ KSh 1,000,000.00</td></tr>
                            <tr><td>2025-02-02</td><td>Limit set</td><td>daniel.m</td><td class="text-end">KSh 4,000,000.00</td></tr>
                            </tbody>
                        </table>
                    </div>
                </div>
