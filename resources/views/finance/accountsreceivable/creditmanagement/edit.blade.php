        ...
        <div class="card-body p-3">
            <form action="{{ route('creditmanagement.update', $credit->Id) }}" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select class="form-select" name="PaymentTerms" id="PaymentTerms" required>
                            ...
                            @foreach($paymentTerms as $term)
                                <option value="{{ $term->Value }}" {{ $credit->PaymentTerms == $term->Value ? 'selected' : '' }}>
                                    {{ $term->Description }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="EffectiveFrom" id="EffectiveFrom" class="form-control"
                               value="{{ \Carbon\Carbon::parse($credit->EffectiveFrom)->format('Y-m-d') }}" required>
                    </div>
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-sm btn-primary" onclick="if(this.form.checkValidity()){this.disabled=true; this.innerText='Updating...'; this.form.submit();}">
