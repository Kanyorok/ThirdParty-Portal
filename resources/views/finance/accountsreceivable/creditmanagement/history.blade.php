                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="progress mt-1" style="height: 6px;">
                                <div class="progress-bar {{ ($util ?? 0) < 50 ? 'bg-success' : (($util ?? 0) < 80 ? 'bg-warning' : 'bg-danger') }}" 
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-md-2 text-end">
                                            @if(in_array($movement->MovementType, ['adjustment_increase', 'initial_approval', 'limit_set']))
                                                <span class="fw-medium text-success">+{{ number_format($movement->Amount, 2) }}</span>
                                            @elseif(in_array($movement->MovementType, ['adjustment_decrease', 'usage']))
                                                <span class="fw-medium text-danger">-{{ number_format($movement->Amount, 2) }}</span>
                                            @else
                                                <span class="fw-medium">{{ number_format($movement->Amount, 2) }}</span>
                                            @endif
                                        </div>
                                        <div class="col-md-3">
