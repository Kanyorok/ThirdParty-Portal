    ...
    <div class="card shadow-sm rounded-4 border-0">
        ...
        <div class="card-body">
            <p class="text-muted mb-4">
                Update the tax rule details below. Fields marked with <span class="text-danger">*</span> are required.
            </p>
            ...
            <form method="POST" action="{{ route('taxruleconfig.update', $taxRule->Id) }}">
                ...
                <div class="row g-3">
                    ...
                    <!-- Jurisdiction -->
                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Jurisdiction <span class="text-danger">*</span></label>
                    ...
                    <div id="dateError" class="alert alert-danger d-none alert-dismissible fade show py-2 px-3 small">
