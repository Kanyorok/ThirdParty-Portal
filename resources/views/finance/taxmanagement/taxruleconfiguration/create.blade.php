    ...
    <div class="container">
        <div class="card p-2 shadow rounded-4 mb-0">
            <div class="card-body mb-0">
                ...
                <p class="text-muted">
                    Use this form to set up a new tax rule. Ensure all fields are filled out correctly to avoid issues
                ...
                <form method="POST" action="{{ route('taxruleconfig.store') }}">
                        ...
                        <div class="col-md-6">
                            ...
                            <select name="JurisdictionId" class="form-select" required>
                                ...
                                @foreach ($jurisdictions as $jurisdiction)
                                    <option
                                        value="{{ $jurisdiction->Id }}">{{ $jurisdiction->JurisdictionName }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="Rate" class="form-control" value="0.00"
