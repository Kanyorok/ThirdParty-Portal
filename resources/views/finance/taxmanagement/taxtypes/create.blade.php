...
{{--        </div>--}}
        ...
        <div class="card-header mb-1">
            ...
            <p class="text-muted mt-0">
                Set up a new tax type for your organization.
            </p>
            <form method="POST" action="{{ route('taxtypes.store') }}">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="Description" class="form-control" placeholder="Brief description of the tax type" required></textarea>
                </div>
                ...
                <div class="d-flex justify-content-between align-content-center mt-4">
                    ...
                    <button type="submit" class="btn btn-success" onclick="if(this.form.checkValidity()){this.disabled=true; this.innerText='💾Saving...'; this.form.submit();}">💾Save Tax Type</button>
                </div>
            </form>
        </div>
    </div>
