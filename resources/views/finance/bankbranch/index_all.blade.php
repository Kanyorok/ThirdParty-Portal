...
<div class="container">
    <div class="d-flex align-items-center justify-content-between">
        <h1 class="mb-0">All Bank Branches</h1>
        <div>
            <a href="{{ route('finance.bankbranch.create') }}" class="btn btn-success">Add Branch</a>
            <a href="{{ route('finance.bank.index') }}" class="btn btn-outline-secondary">Banks</a>
        </div>
    </div>
