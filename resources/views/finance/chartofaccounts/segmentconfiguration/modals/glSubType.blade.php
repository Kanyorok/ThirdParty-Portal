                    ...
                    <div class="table-responsive">
                        <div class="row mb-3">
                            <div class="col-md-12 mb-4">
                                <label>GL Type</label>
                                <select name="GLAccountTypeID" id="accountType1" class="form-select" required>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select name="GLTypeGroupID" id="typeGroup1" class="form-select" required>
                            ...
                            <div class="col-md-12 mb-4">
                                ...
                                <select name="GLSubAccountTypeID" id="subType1" class="form-select" required>
