...
<div class="container mt-4">
    ...
    <form method="POST" action="{{ route('glpostingmap.update', $mapping->Id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="SourceDocType" class="form-control" value="{{ $mapping->SourceDocType }}" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <select name="TransactionTypeID" class="form-select" required>
                @foreach ($transactionTypes as $type)
                    <option value="{{ $type->Id }}" {{ $mapping->TransactionTypeID == $type->Id ? 'selected' : '' }}>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="PostingNarration" class="form-control" value="{{ $mapping->PostingNarration }}">
        </div>
