                ...
                @forelse($accounts as $acc)
                    <tr>
                        ...
                        <td class="text-nowrap">
                            <a href="{{ route('finance.bankaccountsetup.show', $acc->AccountID) }}" class="btn btn-sm btn-outline-info me-1" title="View"><i class="fas fa-eye"></i></a>
                            <a href="{{ route('finance.bankaccountsetup.edit', $acc->AccountID) }}" class="btn btn-sm btn-outline-primary me-1" title="Edit"><i class="fas fa-edit"></i></a>
                            <button type="button"
