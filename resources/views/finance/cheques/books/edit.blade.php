...
<form method="POST" action="{{ route('finance.chequebooks.update',$row->ChequeBookID) }}">
  ...
  <div class="row g-3">
    ...
    <div class="col-md-3">
      ...
      <input type="number" name="StartNumber" class="form-control" value="{{ old('StartNumber',$row->StartNumber) }}" required>
    </div>
    <div class="col-md-3">
      <label class="form-label">End Number <span class="text-danger">*</span></label>
      <input type="number" name="EndNumber" class="form-control" value="{{ old('EndNumber',$row->EndNumber) }}" required>
    </div>
    <div class="col-md-3">
      <label class="form-label">Next Leaf Number <span class="text-danger">*</span></label>
      <input type="number" name="NextLeafNumber" class="form-control" value="{{ old('NextLeafNumber',$row->NextLeafNumber) }}" required>
