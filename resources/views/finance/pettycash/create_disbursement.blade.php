...
@section('content')
    ...
    <form method="POST" action="{{ route('finance.pettycash.store') }}">@csrf
        ...
        <div class="row g-3">
            ...
            <div class="col-md-12">
                <hr>
                <strong>Lines</strong></div>
            <div id="lines">
                <div class="row g-2 mb-2 line">
                    <div class="col-md-5"><input name="lines[0][Description]" class="form-control"
                                                 placeholder="Description"></div>
                    <div class="col-md-3"><input name="lines[0][GLAccountID]" class="form-control"
                                                 placeholder="Expense GL ID"></div>
                    <div class="col-md-2"><input type="number" step="0.01" name="lines[0][Amount]" class="form-control"
                                                 placeholder="Amount"></div>
                    <div class="col-md-2">
                        <button type="button" class="btn btn-outline-danger w-100"
                                onclick="this.closest('.line').remove()">Remove
                        </button>
                    </div>
                </div>
            </div>
            <div class="col-md-12">
                <button type="button" class="btn btn-outline-secondary" onclick="addLine()">+ Add Line</button>
            </div>
            ...
            <div class="col-md-4"><label class="form-label">Reference</label><input name="Reference"
                                                                                    class="form-control"></div>
            <div class="col-md-4"><label class="form-label">Narration</label><input name="Narration"
                                                                                    class="form-control"></div>
        </div>
