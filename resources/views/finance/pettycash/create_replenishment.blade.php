...
<div class="row g-3">
  ...
  <div class="col-md-3"><label class="form-label">Doc Date</label><input type="date" name="DocDate" class="form-control" value="{{ now()->toDateString() }}" required></div>
  <div class="col-md-3">
  ...
  <div class="col-md-2"><label class="form-label">Rate</label><input type="number" step="0.000001" name="ExchangeRate" class="form-control" value="1"></div>
  ...
  <div class="col-md-2"><label class="form-label">Reference</label><input name="Reference" class="form-control"></div>
  <div class="col-md-2"><label class="form-label">Narration</label><input name="Narration" class="form-control"></div>
</div>
