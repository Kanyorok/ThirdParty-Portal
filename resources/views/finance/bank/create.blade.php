                    ...
                    <div class="card mb-3 border-0 shadow-sm rounded-3">
                        ...
                        <div class="card-body row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input name="ClearingCode" class="form-control" value="{{ old('ClearingCode') }}"
                                       required>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="CountryID" class="form-select select2-country" required>
                                    ...
                                    @foreach(\App\Models\Core\Country::active()->ordered()->get(['Id','Name']) as $c)
                                        <option
                                            value="{{ $c->Id }}" {{ old('CountryID') == $c->Id ? 'selected' : '' }}>{{ $c->Name }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Email</label>
                                <input type="email" name="EmailID" class="form-control" value="{{ old('EmailID') }}"
                                       required>
                            </div>
                            <div class="col-md-6">
