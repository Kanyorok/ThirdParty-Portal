...
<div class="row g-3">
  ...
  <div class="col-md-4">
    ...
    @else
      <div class="alert alert-info small mb-0">No mapped transaction types found. Add mappings in Finance GL Transactions Mapping.</div>
    @endif
  </div>
...
<div class="d-flex gap-2">
  ...
  <a href="{{ $isEdit ? route('finance.banktransactions.show',$row->BankTxnID) : route('finance.banktransactions.index') }}" class="btn btn-secondary">Cancel</a>
  @if($isEdit)
