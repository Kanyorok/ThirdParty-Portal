...
<div class="card shadow  rounded-4">
    ...
    <form>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <label>Invoice</label>
                <input class="form-control" type="text" id="InvoiceRef" name="InvoiceRef" placeholder="Based on the Selected voucher" readonly>
            </div>
            <div class="col-md-6">
                <label for="invoice amnt">Invoice Amount</label>
                <input class="form-control" type="text" id="InvoiceDesc" name="InvoiceAmount" placeholder="e.g. 10,000 of 89,000 paid" readonly>
            </div>
        </div>
        <div class="row mb-3">
            <div class="col-md-6">
