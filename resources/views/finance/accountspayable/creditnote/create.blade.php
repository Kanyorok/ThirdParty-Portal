        ...
        <div class="card-body">
            ...
            <form action="{{route('creditnote.store')}}" method="POST">
                ...
                <div class="d-flex justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-success" id="postBtn" onclick="if(this.form.checkValidity()){this.disabled=true; this.innerText='💾Saving...'; this.form.submit();}">💾Save Note</button>
                </div>
            </form>
        </div>
    </div>
