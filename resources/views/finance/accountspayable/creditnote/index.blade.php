                                ...
                                <tr class="note-row" data-note-type="{{ $note->NoteType }}">
                                    ...
                                    <td>
                                        <div class="d-flex gap-1">
                                            <a href="{{ route('creditnote.show', $note->Id) }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <select name="InvoiceRefNo" class="form-select" required>
                                        <option value="{{old('InvoiceRefNo', $item->InvoiceRefNo)}}" disabled selected>
                                            --Select Invoice--
                                        </option>
                                        @foreach($invoices as $invoice)
                                            <option
                                                value="{{ $invoice->Id }}" {{ $invoice->Id == $item->InvoiceRefNo ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="NoteDate" class="form-control"
                                           value="{{old('NoteDate', \Carbon\Carbon::parse($item->NoteDate)->format('Y-m-d'))}}"
                                           required>
                                </div>
