    ...
    <div class="container mt-0">
        <div class="card shadow rounded-4">
            <div class="card-header bg-light py-1 px-3">
                <h6 class="mb-0 text-muted"><i class="fab fa-wpforms text-info"></i> Edit {{ $journalEntry->RefNo }}</h6>
            </div>
            <div class="card-body">
                            ...
                            @foreach($journalEntry->journalLines as $i => $line)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="number" name="Amount[]" class="form-control amount-input" step="0.01" value="{{ number_format((float)$amount, 2, '.', '') }}" required>
                                    </td>
                                    <td>
                                        <input type="text" name="Narration[]" class="form-control" value="{{ $line->Narration }}" placeholder="Narration">
                                    </td>
...
@section('scripts')
    <script>
        ...
        document.getElementById('addRow').addEventListener('click', () => {
            ...
            // New line: clear hidden LineId so controller treats as create
