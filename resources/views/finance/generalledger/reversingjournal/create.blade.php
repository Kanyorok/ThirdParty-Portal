                ...
                <form method="POST" action="#">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="text" name="OriginalReferenceNumber" class="form-control" placeholder="e.g., JV20240601">
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="alert alert-warning">
                        ⚠️ This journal will automatically reverse the original entry lines.
                    </div>
