            ...
            <div class="card-body">
                <form method="POST" action="{{route('reversingjournal.store')}}">
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="OriginalJournalID" id="OriginalReferenceNumber" class="form-select" required>
                                ...
                                @foreach ($journalEntries as $entry)
                                    <option value="{{ $entry->Id }}">{{ $entry->RefNo }}
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button class="btn btn-danger" id="saveBtn" type="submit"
                                onclick="if(this.form.checkValidity()){ this.disabled=true; this.innerText='Reversing...'; this.form.submit();}">
                            Reverse Journal
                        </button>
                    </div>
                </form>
