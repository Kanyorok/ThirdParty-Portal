...
@section('styles')
    <style>
        ...
        .journal-container { max-width: 1200px; margin: 0 auto; background: #fff; }

        /* Header - minimalist */
        .journal-header { background: #fff; color: #343a40; padding: 1.25rem 1.5rem; margin-bottom: 1rem; border-bottom: 1px solid #dee2e6; position: relative; }
    ...
    <div class="journal-container">
        ...
        <div class="journal-header">
            <div class="d-flex justify-content-between align-items-start">
                <div>
                    <h1 class="journal-title">🔄 Reverse Journal Details</h1>
                ...
                <div class="row mb-3 g-3">
                    <div class="col-lg-6">
                        <div class="info-card h-100">
                            ...
                            <ul class="info-list">
                            <li><span class="label">Original Journal Ref</span><span>{{ $originalJournalRef }}</span></li>
                    ...
                    <table class="table table-sm table-hover align-middle table-bordered je-table">
                        ...
                        @foreach($journalEntry->journalLines as $index => $line)
                            ...
                            <tr class="{{ $rowClass }}">
                                ...
                                <td class="text-start">{{ number_format(abs($line->Amount), 2) }}</td>
