...
<div class="container mt-4">
    ...
    <form method="POST" action="#" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="file" name="statement_file" id="statement_file" class="form-control" accept=".csv,.txt" required>
            <div class="form-text">Accepted formats: CSV, TXT (e.g., MT940, BAI2)</div>
        </div>

        <div class="mb-3">
            <label for="notes" class="form-label">Notes (optional)</label>
            <textarea name="notes" id="notes" class="form-control" rows="3" placeholder="E.g. Upload for June 2025"></textarea>
        </div>
