...
@section('content')
    <div class="row">
            ...
            <div class="card mb-3">
                <form class="card-body row  px-2" id="searchForm">
                    ...
                    <div class="col-12 col-md-2"><input type="search" class="form-control w-100 search-form-item"
                                                        ...
                                                        id="member_no" placeholder="member no"></div>
                    <div class="col-12 col-md-3"><input type="search" class="form-control w-100 search-form-item"
        ...
        <div class="col-12">
            <div class="card mb-3">
                <div class="card-body">
                    <table id="clientsTable" class="table table-striped dataTable no-footer dtr-inline w-100 table-responsive">
                        <thead>
                        <tr>
                            <th style="width: 25px;">MemberNo</th>
                            <th>Name</th>
                            <th>ID / Reg No.</th>
                            <th>Type</th>
                            <th>Phone</th>
