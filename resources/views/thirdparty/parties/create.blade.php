                ...
                <form action="{{ route('thirdparty.parties.store') }}" method="POST">
                    ...
                    <div class="card-body p-5">
                        ...
                        <div class="bg-light p-5 mb-5 border rounded-3">
                            ...
                            <p class="text-muted mb-4">Provide the official and trading names, and registration details.</p>
                            <div class="row g-4">
                        ...
                        <div class="bg-light p-5 mb-5 border rounded-3">
                            ...
                            <p class="text-muted mb-4">Provide the company's contact information and physical address.</p>
                            <div class="row g-4">
                                <div class="col-md-6">
                        ...
                        <div class="bg-light p-5 border rounded-3">
                            ...
                            <p class="text-muted mb-4">Set the approval and operational status for this third party.</p>
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-4">
                                    <label for="ThirdPartyType" class="form-label">Third Party Type <span class="text-danger">*</span></label>
