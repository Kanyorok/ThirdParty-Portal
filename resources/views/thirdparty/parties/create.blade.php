                ...
                <div class="card border-0 rounded-0">
                    ...
                    <form action="{{ route('thirdparty.parties.store') }}" method="POST">
                        ...
                        <div class="bg-light p-5 mb-5 border rounded-3">
                            ...
                            <p class="text-muted mb-4">Choose whether this third party is an Individual or a
                                Corporate/Organisation. This controls which fields are shown.</p>
                        ...
                        <div class="bg-light p-5 mb-5 border rounded-3" id="individual-fields" style="display:none;">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-4">
                                    <label for="ThirdPartyName_ind" class="form-label">Full Name <span
                                                class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="ThirdPartyName_ind"
                                           name="ThirdPartyName" value="{{ old('ThirdPartyName') }}">
                                </div>
