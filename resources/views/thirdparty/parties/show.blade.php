...
@section('content')
            ...
            <div class="col-12 col-xl-11">
                <div class="card border-0 rounded-4">
                    ...
                    <div class="card-footer bg-light p-4 border-top d-flex justify-content-end gap-3">
                        <a href="{{ route('thirdparty.parties.edit', ['party' => $party->Id]) }}"
    ...
    <div class="modal fade" id="deleteConfirmationModal" tabindex="-1" aria-labelledby="deleteConfirmationModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <form method="POST" action="{{ route('thirdparty.parties.destroy', ['party' => $party->Id]) }}"
                  class="modal-content">
                @csrf
                @method('DELETE')
                ...
                <div class="modal-body">
                    Are you sure you want to delete <strong>{{ $party->ThirdPartyName ?? 'this third party' }}</strong>?
