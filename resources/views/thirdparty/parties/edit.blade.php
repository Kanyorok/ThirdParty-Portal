            ...
            <div class="card border-0 rounded-0">
                ...
                <form action="{{ route('thirdparty.parties.update', $thirdParty->Id) }}" method="POST">
                    ...
                    <div class="bg-light p-5 mb-5 border rounded-3">
                        ...
                        <p class="text-muted mb-4">Choose whether this third party is an Individual or Corporate/Organisation.</p>
                    ...
                    <div class="bg-light p-5 mb-5 border rounded-3" id="individual-fields" style="display:none;">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6 col-lg-4">
                                ...
                                <input type="text" class="form-control" id="ThirdPartyName_ind" name="ThirdPartyName"
                                       value="{{ old('ThirdPartyName', $thirdParty->ThirdPartyName) }}">
                            </div>
                    ...
                    <div class="bg-light p-5 mb-5 border rounded-3" id="contact-section">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="form-control" id="PhysicalAddress" name="PhysicalAddress" rows="3">{{ old('PhysicalAddress', $thirdParty->PhysicalAddress) }}</textarea>
                            </div>
                        </div>
                    </div>
