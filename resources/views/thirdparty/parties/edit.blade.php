        ...
        <div style="max-width: 100%; margin: 0 auto;">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('thirdparty.parties.show', ['party' => $party->Id]) }}"
                                ...
                                <div class="form-field">
                                    ...
                                    <select class="form-control @error('BusinessType') error @enderror"
                                        ...
                                        @foreach (\App\Enums\BusinessTypeEnum::cases() as $type)
                                            <option
                                                value="{{ $type->value }}" @selected(old('BusinessType', $party->BusinessType?->value) === $type->value)>
                                                {{ $type->label() }}
                                            </option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="section">
                            ...
                            <div class="form-grid cols-2">
                                ...
                                <div class="form-field col-span-2">
                                    ...
                                    <textarea
                                        class="form-control form-textarea @error('PhysicalAddress') error @enderror"
                                        id="PhysicalAddress"
                                ...
                                <div class="form-field">
                                    ...
                                    <select class="form-control @error('ApprovalStatus') error @enderror"
                                        ...
                                        @foreach (\App\Enums\ThirdPartyApprovalStatusEnum::cases() as $status)
                                            <option
                                                value="{{ $status->value }}" @selected(old('ApprovalStatus', $party->ApprovalStatus?->value) === $status->value)>
                                                {{ $status->label() }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-field">
                                    ...
                                    <select class="form-control @error('Status') error @enderror"
                                        ...
                                        @foreach (\App\Enums\ThirdPartyStatusEnum::cases() as $status)
                                            <option
                                                value="{{ $status->value }}" @selected(old('Status', $party->Status?->value) === $status->value)>
                                                {{ $status->label() }}
                                            </option>
                                        @endforeach
                                    </select>
