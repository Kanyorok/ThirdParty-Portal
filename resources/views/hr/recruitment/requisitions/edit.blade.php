...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">Edit Job Requisition</h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('hr.recruitment.requisitions.update', $requisition->Id) }}">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label">Code *</label>
                        <input type="text" name="Code" class="form-control" value="{{ old('Code', $requisition->Code) }}" required>
                    </div>
                    <div class="col-md-9">
                        ...
                        <select name="RoleID" id="RoleID" class="form-select">
                            ...
                            @foreach($roles as $role)
                                <option value="{{ $role->Id }}"
                                        ...
                                        @selected(old('RoleID', $requisition->RoleID) == $role->Id)>{{ $role->Name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" name="Vacancies" class="form-control" min="1" value="{{ old('Vacancies', $requisition->Vacancies) }}" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="Justification" class="form-control" rows="3">{{ old('Justification', $requisition->Justification) }}</textarea>
                    </div>
                </div>
