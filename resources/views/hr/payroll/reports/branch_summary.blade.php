...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">Branch Summary</h2>
        <div class="d-flex gap-2 d-print-none">
            <a class="btn btn-outline-primary" href="{{ route('hr.payroll.reports.branches.export', $run->Id) }}">Download Excel</a>
    ...
    @forelse($groups as $branch => $lines)
        <div class="card shadow-sm mb-3">
            <div class="card-header bg-white">{{ $branch }}</div>
