...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm border-0">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('hr.employees.update', $employee->EmployeeNo) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="Religion" class="form-select">
                            ...
                            @foreach($religions ?? [] as $religion)
                                <option value="{{ $religion->Name }}" @selected(old('Religion', $employee->Religion) == $religion->Name)>{{ $religion->Name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-3">
                        ...
                        <select name="EmploymentType" class="form-select">
                            ...
                            @foreach($employmentTypes ?? [] as $type)
                                <option value="{{ $type->Description }}"
                                        @selected(old('EmploymentType', $employee->EmploymentType) == $type->Description)>
                                    {{ $type->Description }}
                                </option>
                            @endforeach
                        </select>
                        ...
                        <select name="ContractType" class="form-select">
                            ...
                            @foreach($contractTypes ?? [] as $contractType)
                                <option value="{{ $contractType->Description }}"
                                        @selected(old('ContractType', $employee->ContractType) == $contractType->Description)>
