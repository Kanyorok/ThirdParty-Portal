...
@section('title', 'New NSSF Rate')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">Create NSSF Rate</h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('hr.statutory.nssf.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="form-label">Tier</label>
                        <input type="text" name="Tier" class="form-control" value="{{ old('Tier') }}" placeholder="e.g. Tier I">
                    </div>
                    <div class="col-md-4">
                        <label class="form-label">Income From *</label>
                        <input type="number" step="0.01" name="IncomeFrom" class="form-control" value="{{ old('IncomeFrom', 0) }}" required>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" step="0.01" name="EmployerRate" class="form-control" value="{{ old('EmployerRate', 0) }}" required>
                    </div>
                    <div class="col-md-4 d-flex align-items-center">
                        <div class="form-check mt-4">
                            <input type="checkbox" class="form-check-input" name="IsPercentage" value="1" id="IsPercentage" @checked(old('IsPercentage', true))>
