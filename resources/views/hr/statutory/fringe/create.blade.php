...
@section('title', 'New Fringe Benefit Rule')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">Create Fringe Benefit Rule</h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('hr.statutory.fringe.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="RateType" class="form-select" required>
                            <option value="Percentage" @selected(old('RateType')=='Percentage')>Percentage</option>
                            <option value="Fixed" @selected(old('RateType')=='Fixed')>Fixed Amount</option>
                        </select>
                    </div>
                    <div class="col-md-4">
