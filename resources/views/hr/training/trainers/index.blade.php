...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-primary" href="{{ route('hr.training.trainers.create') }}">+ New Trainer</a>
    </div>
                    ...
                    <tbody>
                        @forelse($trainers as $trainer)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-sm btn-outline-secondary" href="{{ route('hr.training.trainers.edit', $trainer->Id) }}">Edit</a>
                                    @if($trainer->IsActive)
                                        <form method="POST" action="{{ route('hr.training.trainers.destroy', $trainer->Id) }}" class="d-inline">
                                            @csrf
                                            @method('DELETE')
