...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-primary" href="{{ route('hr.training.sessions.create') }}">+ New Session</a>
    </div>
                        ...
                        @forelse($sessions as $session)
                            <tr>
                                ...
                                <td class="text-end">
                                    ...
                                    <a class="btn btn-sm btn-outline-secondary" href="{{ route('hr.training.sessions.edit', $session->Id) }}">Edit</a>
                                </td>
                            </tr>
                        @empty
