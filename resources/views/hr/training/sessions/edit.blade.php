...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a class="btn btn-outline-secondary" href="{{ route('hr.training.sessions.show', $session->Id) }}">Back</a>
    </div>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('hr.training.sessions.update', $session->Id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row g-3">
                    <div class="col-md-6">
    ...
    <div class="card shadow-sm mt-4">
        <div class="card-body">
            <h5 class="mb-3">Add Participants</h5>
            <form method="POST" action="{{ route('hr.training.sessions.participants', $session->Id) }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                ...
                <div class="mt-3">
                    <button class="btn btn-outline-primary" type="submit">Add Participants</button>
                </div>
            </form>
        </div>
    </div>
