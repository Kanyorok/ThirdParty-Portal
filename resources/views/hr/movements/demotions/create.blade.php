...
@section('title', 'New Demotion')

@section('content')
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">New Demotion Request</h2>
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <form method="POST" action="{{ route('hr.movements.demotions.store') }}">
                @csrf
                <div class="row g-3">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="FromGradeID" class="form-select">
                            ...
                            @foreach($grades as $grade)
                                <option value="{{ $grade->Id }}" @selected(old('FromGradeID') == $grade->Id)>{{ $grade->Name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                        ...
                        <select name="ToGradeID" class="form-select">
                            <option value="">Select</option>
                            @foreach($grades as $grade)
                                <option value="{{ $grade->Id }}" @selected(old('ToGradeID') == $grade->Id)>{{ $grade->Name }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="number" step="0.01" name="FromSalary" class="form-control" value="{{ old('FromSalary') }}">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label">To Salary</label>
                        <input type="number" step="0.01" name="ToSalary" class="form-control" value="{{ old('ToSalary') }}">
                    </div>
                    <div class="col-md-12">
