                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            <li class="pc-item pc-hasmenu"><a class="pc-link" href="#!"><span data-i18n="Supplier">
                                ...
                                <ul class="pc-submenu">
                                    <li class="pc-item"><a class="pc-link" href="{{ route('receipts.index') }}" data-i18n="Procurement List">Receipts</a></li>
                                </ul>
                            </li>
                            ...
                            <li class="pc-item pc-hasmenu"><a class="pc-link" href="#!"><span data-i18n="Supplier">
                                ...
                                <ul class="pc-submenu">
                                    <li class="pc-item"><a class="pc-link" href="{{ route('transactions.index') }}" data-i18n="Procurement List">Receipts</a></li>
                                </ul>
                            </li>
