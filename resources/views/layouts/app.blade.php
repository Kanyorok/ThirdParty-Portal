            ...
            <div class="navbar-content">
                ...
                <li class="pc-item pc-hasmenu">
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item pc-hasmenu"><a class="pc-link" href="#!"><span data-i18n="Supplier">
                                ...
                                <ul class="pc-submenu">
                                    <li class="pc-item"><a class="pc-link" href="{{ route('inventorydashboard.index') }}" data-i18n="Procurement List">Stock Dashboard</a></li>
                    ...
                    <li class="pc-item pc-hasmenu">
                        ...
                        <ul class="pc-submenu">
                          <li class="pc-item"><a class="pc-link" href="{{ route('periodmanagement.index') }}" data-i18n="Finance">Fiscal Year Setup</a></li>
                        </ul>
