...
<script>
    ...
    $(function () {
        ...
        @endif
        @if(session('fail')) nError('{!!  session('fail') !!}'); @endif
        $(document).on("click",".clear-balance",(function(){"**********"===$(this).html()?$(this).html($(this).data("bal")):$(this).html("**********")}));
        ...
        @if(config('app.debug')===false && !auth()->user()->can(\App\Enums\Core\PermissionEnum::UsersSessions)) setInterval(timerIncrement, 1000); // 1 second @endif
