...
@section('content')
    ...
    <div class="container mt-4">
        ...
        <ul class="nav nav-tabs" id="priceTabs" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#addPrice" type="button">➕ Add
                    Price
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#viewPrices" type="button">📄 View Price
                    List
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" data-bs-toggle="tab" data-bs-target="#uploadPrice" type="button">📁 Upload Price
                    List
                </button>
            </li>
        </ul>
