                            ...
                            <div class="col-md-4">
                                ...
                                <select name="ItemID" id="Item" class="form-select" required>
                                    ...
                                    @foreach($items as $itm)
                                        <option
                                            value="{{ $itm->Id }}" {{ old('ItemID', $item->ItemID) == $itm->Id ? 'selected' : '' }}>
                                            {{ $itm->ItemName }}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="Branch" id="Branch" class="form-select" required>
                                        ...
                                        @foreach($branches as $branch)
                                            <option
                                                value="{{ $branch->Id }}" {{ old('Branch', $item->Branch) == $branch->Id ? 'selected' : '' }}>
                                                {{ $branch->Name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="Store" id="Store" class="form-select">
                                        ...
                                        @foreach($stores as $store)
                                            <option
                                                value="{{ $store->Id }}" {{ old('Store', $item->Store) == $store->Id ? 'selected' : '' }}>
                                                {{ $store->StoreName }}
                                            </option>
                                        @endforeach
                                    </select>
