...
@section('content')
    ...
    <div class="container mt-5">
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        <button type="button" class="btn btn-sm btn-info"
                                           onclick="showTypeModal('{{ $type->Type }}', {{ $type->Status }})"
                                           title="View">
                                        ...
                                        <form id="delete-form-{{ $type->Id }}"
                                              action="{{ route('inventorytype.destroy', $type->Id) }}" method="POST"
                                              style="display:none;">
                                            @csrf
                                            @method('DELETE')
                                        </form>
        ...
        <!-- Show Modal -->
        <div class="modal fade" id="showTypeModal" tabindex="-1" aria-labelledby="showTypeModalLabel"
             aria-hidden="true">
        ...
        <script>
            $(document).ready(function () {
                $('#inventorytypesTable').DataTable({
                    ...
                    lengthChange: true,
                    language: {
                        emptyTable: "No inventory types found"
                    }
                });
            });
        </script>
