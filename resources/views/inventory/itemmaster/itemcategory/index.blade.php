        ...
        @foreach($categories as $key => $category)
          <tr>
            ...
            <td>
              ...
              <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ $category->Id }}')">Delete</a>
              <form id="delete-form-{{ $category->Id }}" action="{{ route('itemcategory.destroy', $category->Id) }}" method="POST" style="display:none;">
               @csrf
               @method('DELETE')
              </form>
            </td>
