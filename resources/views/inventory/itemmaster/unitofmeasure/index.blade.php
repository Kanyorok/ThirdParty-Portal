            ...
            @foreach($units as $key => $unit)
              <tr>
                ...
                <td>
                  ...
                  <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete('{{ $unit->Id }}')">Delete</a>
                  <form id="delete-form-{{ $unit->Id }}" action="{{ route('unitofmeasure.destroy', $unit->Id) }}" method="POST" style="display:none;">
                    @csrf
                    @method('DELETE')
                  </form>
                </td>
