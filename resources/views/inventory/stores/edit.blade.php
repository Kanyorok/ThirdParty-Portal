  ...
  <div class="card shadow rounded-4">
        ...
        <form action="{{ route('stores.update', $store->Id) }}" method="POST">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="StoreName" class="form-control" id="StoreName" value="{{ $store->StoreName }}" required>
                </div>
    ...
    <select name="BranchID" id="BranchID" class="form-select" required>
        ...
        @foreach($branches as $branch)
            <option value="{{ $branch->Id }}" {{ $store->BranchID == $branch->Id ? 'selected' : '' }}>
                {{ $branch->Name }}
            </option>
        @endforeach
    </select>
                ...
                <div class="col-md-6 d-flex align-items-center">
                    <div class="form-check mt-4">
                        ...
                        <input class="form-check-input" type="checkbox" name="Status" value="1" id="Status" {{ $store->Status ? 'checked' : '' }}>
            ...
            <div class="d-flex justify-content-end mt-4">
                <button type="submit" class="btn btn-warning px-4">Update Store</button>
