                ...
                <div class="col-md-6">
                    ...
                    <select name="IssuedToType" id="IssuedToType"
                        ...
                        @foreach ($types as $type)
                            <option
                                value="{{ $type->ID }}" {{ old('IssuedToType') == $type->ID ? 'selected' : '' }}>{{ $type->Description }}</option>
                        @endforeach
                    </select>
                    @error('IssuedToType')
                    <div class="invalid-feedback">{{ $message }}</div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select name="IssuedBy" id="IssuedBy" class="form-select @error('IssuedBy') is-invalid @enderror"
                        ...
                        @foreach($users as $user)
                            <option
                                value="{{ $user->Id }}" {{ old('IssuedBy') == $user->Id ? 'selected' : '' }}>{{ $user->Name }}</option>
                        @endforeach
                    </select>
                    @error('IssuedBy')
                    <div class="invalid-feedback">{{ $message }}</div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="date" name="IssuedOn" id="IssuedOn"
                           ...
                           value="{{ old('IssuedOn', now()->format('Y-m-d')) }}" required>
                    @error('IssuedOn')
                    <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
