                ...
                <form action="{{ route('uomconversion.update', $uomConversion->Id) }}" method="POST">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" id="base_uom_name" class="form-control"
                                   value="{{ $uomConversion->uom->Name ?? '' }}" readonly>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="AlternateUOM" class="form-select" required>
                                ...
                                @foreach($alternateUoms as $uom)
                                    <option
                                        value="{{ $uom->Id }}" {{ $uomConversion->AlternateUOM == $uom->Id ? 'selected' : '' }}>
                                        {{ $uom->Name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            ...
                            <input type="number" name="ConversionFactor" step="0.01" class="form-control"
                                   value="{{ $uomConversion->ConversionFactor }}" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">Remarks</label>
                            <input type="text" name="Remarks" class="form-control"
                                   value="{{ $uomConversion->Remarks }}">
                        </div>
