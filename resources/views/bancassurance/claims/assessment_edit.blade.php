            ...
            <div class="card shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="date" name="AssessmentDate" class="form-control"
                                   value="{{ old('AssessmentDate', \Carbon\Carbon::parse($assessment->AssessmentDate)->format('Y-m-d')) }}"
                                   required>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <textarea name="AssessmentComments" class="form-control"
                                      rows="3">{{ old('AssessmentComments', $assessment->AssessmentComments) }}</textarea>
                        </div>
                    </div>
