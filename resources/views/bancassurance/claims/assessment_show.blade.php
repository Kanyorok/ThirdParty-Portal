        ...
        <div class="card-body">
            <form>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" value="{{ $assessment->ClaimId ?? '-' }} _ {{$assessment->claim->policy->PolicyNumber ?? '-'}}" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control" value="{{ $assessment->assessedby->Name }}" readonly>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control"
                            value="{{ \Carbon\Carbon::parse($assessment->AssessmentDate)->format('d/m/Y') }}" readonly>
                    </div>
                </div>
