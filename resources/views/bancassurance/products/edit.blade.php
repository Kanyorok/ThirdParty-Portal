...
<div class="container mt-4">
    <form method="POST" action="{{ route('bancassurance.products.update', $product->Id) }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" value="{{ optional($providers->firstWhere('Id', $product->InsuranceProviderID))->Name ?? 'N/A' }}" readonly>
            <input type="hidden" name="InsuranceProviderID" value="{{ $product->InsuranceProviderID }}">
        </div>

        <div class="mb-3">
            <label class="form-label">Name <span class="text-danger">*</span></label>
            <input type="text" name="Name" class="form-control" required maxlength="150" value="{{ old('Name', $product->Name) }}">
        </div>

        <div class="mb-3">
            <label class="form-label">Type <span class="text-danger">*</span></label>
            <input type="text" name="Type" class="form-control" required maxlength="150" value="{{ old('Type', $product->Type) }}">
        </div>
