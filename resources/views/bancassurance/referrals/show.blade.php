            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light" value="{{ $referral->ClientName  ?? '-'}}"
                               readonly>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold text-muted">ID Number</label>
                        <input type="text" class="form-control bg-light" value="{{ $referral->ClientIDNumber ?? '-'}}"
                               readonly>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold text-muted">Phone</label>
                        <input type="text" class="form-control bg-light" value="{{ $referral->ClientPhone ?? '-'}}"
                               readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold text-muted">Email</label>
                        <input type="text" class="form-control bg-light" value="{{ $referral->ClientEmail ?? '-'}}"
                               readonly>
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light"
                               value="{{ $referral->preferredInsurer->Name ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label fw-semibold text-muted">Insurance Product</label>
                        <input type="text" class="form-control bg-light"
                               value="{{ $referral->insuranceProduct->Name ?? '-' }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold text-muted">Referral Date</label>
                        <input type="text" class="form-control bg-light"
                               value="{{ \Carbon\Carbon::parse($referral->ReferralDate)->format('d/m/Y') }}" readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold text-muted">Referred By</label>
                        <input type="text" class="form-control bg-light" value="{{ $referral->employee->Name  ?? '-'}}"
                               readonly>
                    </div>
                    <div class="col-md-4">
                        <label class="form-label fw-semibold text-muted">Assigned To</label>
                        <input type="text" class="form-control bg-light"
                               value="{{ $referral->assignedToUser->Name ?? $referral->assignedToUser->name ?? '-' }}"
                               readonly>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-9">
                        ...
                        <textarea class="form-control bg-light" rows="3"
                                  readonly>{{ $referral->Remarks ?? 'No remarks provided.' }}</textarea>
                    </div>
                </div>

                {{-- Actions --}}
                <div class="text-end mt-4">
                    <a href="{{ route('bancassurance.referrals.index') }}"
