    ...
    <form method="POST" action="{{ route('bancassurance.pricing.update', $rule->Id) }}">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="number" name="MinCoverage" class="form-control" step="0.01" value="{{ $rule->MinCoverage }}" required>
            </div>
            <div class="col-md-6 mb-3">
                <label class="form-label">Max Coverage</label>
                <input type="number" name="MaxCoverage" class="form-control" step="0.01" value="{{ $rule->MaxCoverage }}" required>
            </div>
        </div>
