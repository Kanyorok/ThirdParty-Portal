        ...
        <form method="POST" action="{{ route('bancassurance.pricing.update', $rule->Id) }}">
            ...
            <div class="mb-3">
                ...
                <select name="InsuranceProviderId" id="Provider-select" class="form-select" required>
                    ...
                    @foreach($providers as $provider)
                        <option
                            value="{{ $provider->Id }}" {{ $provider->Id == $rule->InsuranceProviderId ? 'selected' : '' }}>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="MinCoverage" class="form-control" step="0.01"
                           value="{{ $rule->CoverageAmountMin }}" required>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="MaxCoverage" class="form-control" step="0.01"
                           value="{{ $rule->CoverageAmountMax }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 form-check">
                <input class="form-check-input" type="checkbox" name="IsActive" value="1"
                       id="activeCheck" {{ $rule->IsActive ? 'checked' : '' }}>
