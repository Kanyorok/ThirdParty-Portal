        ...
        <div class="card-body p-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light" value="{{ $customer->genders->Description ?? '-' }}" readonly>
                </div>

                <div class="col-md-6">
                    <label class="form-label fw-semibold text-muted">Marital Status</label>
                    <input type="text" class="form-control bg-light" value="{{ $customer->maritalstatus->Description ?? '-' }}" readonly>
                </div>
                <div class="col-md-6">
                    <label class="form-label fw-semibold text-muted">Occupation</label>
                    <input type="text" class="form-control bg-light" value="{{ $customer->occupations->Description ?? '-' }}" readonly>
                </div>
