...
<div class="container mt-4">
    ...
    <form action="{{ route('bancassurance.commissions.tiers.store', $ruleId) }}" method="POST">
        ...
        <div class="row g-3">
            <div class="col-md-3">
                <input type="number" step="0.01" name="MinValue" class="form-control" placeholder="Min Value" required>
            </div>
            <div class="col-md-3">
                <input type="number" step="0.01" name="MaxValue" class="form-control" placeholder="Max Value (or leave blank)">
            </div>
            <div class="col-md-3">
                <input type="number" step="0.01" name="CommissionRate" class="form-control" placeholder="Rate (%)" required>
            </div>
            <div class="col-md-3">
