            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="alert alert-success" role="alert">
                        ...
                        <p>This page was loaded using HTMX partial navigation. The sidebar should remain static and
                            expanded.</p>
                        <hr>
                        <p class="mb-0">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="{{ route('budget.budgetlinecategories.index') }}"
                                       class="btn btn-secondary btn-sm">Budget Categories</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
