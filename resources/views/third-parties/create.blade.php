    ...
    <div class="col-12">
        <div class="card mb-4">
            <div class="card-header">
                <h4 class="mb-0">Create New Third Party</h4>
                <a href="{{ route('web.parties.index') }}" class="btn btn-outline-secondary d-flex align-items-center">
                    <i class="fas fa-arrow-left me-2"></i> Back to List
                </a>
            </div>
            <form action="{{ route('web.parties.store') }}" method="POST">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="ThirdPartyName" class="form-label">Company Name</label>
                            <input type="text" class="form-control @error('ThirdPartyName') is-invalid @enderror" id="ThirdPartyName" name="ThirdPartyName" value="{{ old('ThirdPartyName') }}" required>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('TradingName') is-invalid @enderror" id="TradingName" name="TradingName" value="{{ old('TradingName') }}">
                            @error('TradingName')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('BusinessType') is-invalid @enderror" id="BusinessType" name="BusinessType" required>
                                ...
                                <option value="{{ $type->value }}" {{ old('BusinessType') == $type->value ? 'selected' : '' }}>{{ $type->label() }}</option>
                                @endforeach
                            </select>
                            @error('BusinessType')
                            <div class="invalid-feedback">{{ $message }}</div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('RegistrationNumber') is-invalid @enderror" id="RegistrationNumber" name="RegistrationNumber" value="{{ old('RegistrationNumber') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('TaxPIN') is-invalid @enderror" id="TaxPIN" name="TaxPIN" value="{{ old('TaxPIN') }}">
                            @error('TaxPIN')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('VATNumber') is-invalid @enderror" id="VATNumber" name="VATNumber" value="{{ old('VATNumber') }}">
                            @error('VATNumber')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control @error('PhysicalAddress') is-invalid @enderror" id="PhysicalAddress" name="PhysicalAddress" rows="3">{{ old('PhysicalAddress') }}</textarea>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('ThirdPartyType') is-invalid @enderror" id="ThirdPartyType" name="ThirdPartyType" required>
                                ...
                                <option value="{{ $type->value }}" {{ old('ThirdPartyType') == $type->value ? 'selected' : '' }}>{{ $type->label() }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-select @error('Status') is-invalid @enderror" id="Status" name="Status" required>
                                ...
                                @foreach (\App\Enums\ThirdPartyStatusEnum::cases() as $status) {{-- Assuming ThirdPartyStatusEnum exists --}}
                ...
                <div class="card-footer d-flex justify-content-end gap-2">
                    <a href="{{ route('web.parties.index') }}" class="btn btn-secondary">Cancel</a>
                    <button type="submit" class="btn btn-primary d-flex align-items-center">
                        <i class="fas fa-save me-2"></i> Save Third Party
                    </button>
                </div>
            </form>
        </div>
