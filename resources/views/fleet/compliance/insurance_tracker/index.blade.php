        ...
        <tbody>
            @forelse($records as $record)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('fleet.insurance_tracker.show', $record->Id) }}" class="btn btn-sm btn-info">View</a>
                        <a href="{{ route('fleet.insurance_tracker.edit', $record->Id) }}" class="btn btn-sm btn-warning">Edit</a>
                        <form action="{{ route('fleet.insurance_tracker.destroy', $record->Id) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure?')">
                            @csrf @method('DELETE')
