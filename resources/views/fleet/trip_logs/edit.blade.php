        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <input type="date" name="TripStartDate" id="TripStartDate" class="form-control"
                       value="{{ old('TripStartDate', $parentTrip->TripStartDate ? \Carbon\Carbon::parse($parentTrip->TripStartDate)->format('Y-m-d') : '') }}" required>
            </div>
            ...
            <div class="col-md-12">
                ...
                <textarea name="Notes" id="Notes" class="form-control" rows="3">{{ old('Notes', $parentTrip->Notes) }}</textarea>
            </div>
        </div>
                    ...
                    <div class="child-trip-row p-3 mb-3 border rounded">
                        ...
                        <div class="row g-3">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="childTrips[{{ $child->Id }}][StartLocation]" class="form-control"
                                       value="{{ old("childTrips.{$child->Id}.StartLocation", $child->StartLocation) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">End Location</label>
                                <input type="text" name="childTrips[{{ $child->Id }}][EndLocation]" class="form-control"
                                       value="{{ old("childTrips.{$child->Id}.EndLocation", $child->EndLocation) }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Trip Start Date</label>
                                <input type="date" name="childTrips[{{ $child->Id }}][TripStartDate]" class="form-control"
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="date" name="childTrips[{{ $child->Id }}][TripEndDate]" class="form-control"
                                       value="{{ old("childTrips.{$child->Id}.TripEndDate", $child->TripEndDate ? \Carbon\Carbon::parse($child->TripEndDate)->format('Y-m-d') : '') }}">
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Start Time</label>
                                <input type="time" name="childTrips[{{ $child->Id }}][StartTime]" class="form-control"
                            ...
                            <div class="col-md-8">
                                ...
                                <textarea name="childTrips[{{ $child->Id }}][Notes]" class="form-control">{{ old("childTrips.{$child->Id}.Notes", $child->Notes) }}</textarea>
                            </div>
                        </div>
