        ...
        <div class="card shadow rounded-4 p-4" style="min-width: 300px; max-width: 350px;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item"><strong>Trip
                        Type:</strong> {{ $parentTrip->parentTripType->Description ?? 'N/A' }}</li>
                <li class="list-group-item"><strong>Trip Code:</strong> {{ $parentTrip->TripCode ?? 'N/A' }}</li>
                <li class="list-group-item"><strong>Vehicle
                        Type:</strong> {{ $parentTrip->parentVehicleType->Description ?? 'N/A' }}</li>
                <li class="list-group-item"><strong>Load
                        Type:</strong> {{ $parentTrip->parentLoadType->Description ?? 'N/A' }}</li>
                <li class="list-group-item"><strong>Start
                        Date:</strong> {{ \Carbon\Carbon::parse($parentTrip->TripStartDate)->format('d/m/Y') }}</li>
                <li class="list-group-item"><strong>End
                        Date:</strong> {{ \Carbon\Carbon::parse($parentTrip->TripEndDate)->format('d/m/Y') }}</li>
                <li class="list-group-item"><strong>Start
                        Time:</strong> {{ \Carbon\Carbon::parse($parentTrip->StartTime)->format('H:i A') }}</li>
                <li class="list-group-item"><strong>End
                        Time:</strong> {{ \Carbon\Carbon::parse($parentTrip->EndTime)->format('H:i A') }}</li>
                ...
                <li class="list-group-item"><strong>Distance Covered:</strong> {{ $parentTrip->DistanceCovered }} km
                </li>
