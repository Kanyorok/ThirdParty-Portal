                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="VehicleID" class="form-select">
                                    @foreach($vehicles as $vehicle)
                                        <option
                                            value="{{ $vehicle->Id }}" {{ $tripLogs->Id == $vehicle->Id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="DriverType" class="form-select">
                                    @foreach($driverTypes as $type)
                                        <option
                                            value="{{ $type->ID }}" {{ $tripLogs->DriverType == $type->Description ? 'selected' : '' }}>
                                            {{ $type->Description }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <select name="DriverID" class="form-select">
                                    @foreach($drivers as $driver)
                                        <option
                                            value="{{ $driver->Id }}" {{ $tripLogs->ID == $driver->Id ? 'selected' : '' }}>
                                            {{ $driver->FullName }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.01" name="DistanceCovered" class="form-control"
                                       value="{{ $tripLogs->DistanceCovered }}">
                            </div>
                            <div class="col-md-3">
