        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card h-100 p-3 shadow rounded-4">
                    ...
                    <div class="mb-2"><strong>Chassis No:</strong> <span
                            class="text-muted">{{ $vehicle->ChassisNo }}</span></div>
                    <div class="mb-2"><strong>Engine No:</strong> <span
                            class="text-muted">{{ $vehicle->EngineNo }}</span></div>
                    <div class="mb-2"><strong>Capacity:</strong> <span
                            class="text-muted">{{ $vehicle->Capacity }}</span></div>
            ...
            <div class="col-md-8">
                <div class="card h-100 p-3 shadow rounded-4">
                    ...
                    <ul class="nav nav-tabs mb-3" id="vehicleTabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#trips" role="tab">🗺️
                                Trips</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#drivers" role="tab">👤
                                Drivers</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#insurance" role="tab">🛡️
                                Insurance</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#inspection" role="tab">🔍
                                Inspection</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#maintenance" role="tab">🔧
                                Maintenance</a></li>
                        <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#repairs" role="tab">🛠️
                                Repairs</a></li>
                    </ul>
