            ...
            <tbody>
                @forelse ($schedules as $schedule)
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('fleet.maintenance_schedule.show', $schedule->Id) }}" class="btn btn-sm btn-secondary">Details</a>
                            ...
                            @if ($schedule->Status)
                                <form action="{{ route('fleet.maintenance_schedule.cancel', $schedule->Id) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('PUT')
                                    <button class="btn btn-sm btn-danger" onclick="return confirm('Cancel this schedule?')">
                                        Cancel
                                    </button>
                                </form>
                            @else
