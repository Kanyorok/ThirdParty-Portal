    ...
    <form action="{{ route('fleet.telematics.store') }}" method="POST">
        ...
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="DeviceID" id="DeviceID" class="form-control" required placeholder="e.g. GPS123456789">
            </div>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="text" name="ProviderName" id="ProviderName" class="form-control" required placeholder="e.g. TrackMe Ltd.">
            </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="Notes" id="Notes" rows="3" class="form-control" placeholder="Any relevant details e.g. install position, SIM card etc."></textarea>
        </div>
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                ...
                <input type="url" name="TrackingURL" id="TrackingURL" class="form-control" placeholder="e.g. https://api.provider.com/track">
            </div>
