                ...
                <div class="mb-4 border rounded p-3">
                    ...
                    <ul>
                        @foreach([
                            ...
                            <li>{{ $label }}: <strong>{{ $inspection->$field ? '✅ Available' : '❌ Missing' }}</strong>
                            </li>
                        @endforeach
                    </ul>
                    ...
                    <div class="mt-2">
                        <a href="{{ route('fleet.vehicle_inspection.edit', $inspection->Id) }}"
                    ...
                    <div class="mb-4 border rounded p-3">
                        ...
                        <ul>
                            @foreach([
                                ...
                                <li>{{ $label }}:
                                    <strong>{{ $inspection->$field ? '✅ Available' : '❌ Missing' }}</strong></li>
                            @endforeach
                        </ul>
                        <div class="card-footer bg-light">
                            <h6 class="fw-bold mb-2">📄 Documents</h6>
                        ...
                        <div class="mt-2">
                            <a href="{{ route('fleet.vehicle_inspection.edit', $postTrip->Id) }}"
                               class="btn btn-sm btn-warning">Edit</a>
