@extends('layouts.app')
@section('title', 'Assign Contracted Driver to Vehicle')
...
@section('content')
  ...
  @if ($errors->any())
    ...
    <div class="card p-4 shadow rounded-4">
        <h4 class="mb-4">👨‍✈️ Assign Contracted Driver to Vehicle</h4>

        <form action="{{ route('fleet.contracted_driver_assignments.store') }}" method="POST">
            @csrf
            ...
            <div class="row g-3 mt-2">
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="Purpose" class="form-control" placeholder="e.g. Route coverage">
                </div>
