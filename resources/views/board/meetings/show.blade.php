            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">  {{ $meeting->Title }}
                        <button class="btn btn-primary float-end mx-2" type="button" id="triggerUpdateMeetingBtn"><i class="fas fa-edit"></i></button>
                        <button class="btn btn-danger float-end  mx-2" type="button" id="triggerCancelMeetingBtn"><i class="fas fa-trash-alt"></i></button>
                    </h5>
                    <p><b>Venue </b> : {{ (new \App\Services\MeetingService($meeting))->getVenue(true) }} &nbsp;|&nbsp;<b>Start </b>: {{ $meeting->StartOn->format('M d, Y h:i A') }} &nbsp;|&nbsp;<b>End </b>: {{ $meeting->EndOn->format('M d, Y h:i A') }}</p>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="onboarding-content with-gradient d-none modal-item" id="updateBoardMeetingModal">
                            <form action="{{ route('board-meetings.update',[$meeting->MeetingID]) }}" method="post"
                                ...
                                <div class="mb-3">@method('PUT')
                                    ...
                                    <input type="text" class="form-control" required id="BoardMeetingTitle" name="BoardMeetingTitle" placeholder="Title" value="{{ $meeting->Title }}">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-datetime" id="BoardMeetingStart"
                                           name="BoardMeetingStart" placeholder="Select start.." value="{{ $meeting->StartOn->format('Y-m-d H:i') }}">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <input type="text" class="form-control flatpickr-datetime " id="BoardMeetingEnd"
                                           name="BoardMeetingEnd" placeholder="Select end.." value="{{ $meeting->EndOn->format('Y-m-d H:i') }}">
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <select class="form-control" name="BoardMeetingLocation" required
                                        ...
                                        @if(!$meeting->room instanceof \App\Models\MeetingRoom )
                                            <option selected value="{{ (new \App\Services\MeetingService($meeting))->getVenue(true) }}">{{ (new \App\Services\MeetingService($meeting))->getVenue(true) }}</option>
                                        @endif
                                        @foreach($rooms as $room)
                                            <option value="{{ $room->RoomID }}"
                                            {{ ($meeting->room instanceof \App\Models\MeetingRoom && $room->Id === $meeting->room->Id)?'selected':''}}
                                ...
                                <div class="col-md-6 col-12 mb-3">
                                    ...
                                    <p id="BoardMeetingUpdate_error" class="invalid-feedback d-none error col-12" role="alert"></p>
                                </div>
                    ...
                    <div class="onboarding-content text-center with-gradient d-none modal-item" id="cancelBoardMeetingModal">
                        <p class="text-danger">
                        ...
                        <hr>
                        <form id="cancelBoardMeetingForm" action="{{ route('board-meetings.destroy',[$meeting->MeetingID])  }}"
                              method="post"> @csrf
