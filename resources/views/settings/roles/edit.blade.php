<div>
    <form action="{{ route('roles.update',[$role->id]) }}" method="post" id="updateRoleForm"> @csrf
        ...
        <div class="mt-4">
            ...
            <button class="btn btn-primary float-end" id="updateRoleBtn" type="submit"><i class="fas fa-save"></i> update role</button>
        </div>
    </form>
</div>
<script>
        ...
        $search.on('input', function(){
            ...
            $('.module-card').each(function(){
                ...
                $mod.find('.section-card').each(function(){
                    ...
                    // Show section if module matches or section matches explicitly
