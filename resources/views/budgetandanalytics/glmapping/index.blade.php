...
@section('content')
    <div class="card mb-4">
        ...
        <div class="card-body">
            <p class="text-muted">Below is a list of General Ledger accounts synced from Core Banking System (CBS). You
                can monitor mapping status to budget lines and products.</p>
