@extends('layouts.app')
@section('title', 'Create Budget Activity')

@section('content')
<div class="card p-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h5>📝 Create Budget Activity</h5>
    </div>
    ...
    <form action="{{ route('activitymaster.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="ActivityName" id="ActivityName" class="form-control" value="{{ old('ActivityName') }}" required>
        </div>
        ...
        <div class="d-flex justify-content-between align-items-center">
            <button type="submit" class="btn btn-success" onclick="this.disabled=true; this.innerText='Saving...'; this.form.submit();">💾 Save Activity</button>
