...
<div class="card p-4">
    ...
    <form action="{{ route('periodtypes.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="PeriodType" id="PeriodType" class="form-control" placeholder="e.g., Annually" value="{{ old('PeriodType') }}" required>
        </div>

        <div class="mb-3">
            <label for="Code" class="form-label">Code</label>
            <input type="text" name="Code" id="Code" class="form-control" placeholder="e.g., ANL" value="{{ old('Code') }}" required>
        </div>
