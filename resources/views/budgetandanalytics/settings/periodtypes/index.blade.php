            ...
            @forelse($types as $index => $type)
                <tr>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <form action="{{route('periodtypes.destroy', $type->Id)}}" method="POST" style="display: inline-flexbox" onsubmit="return confirm('Are you sure you want to delete this Period Type?');">
                            @method('DELETE')
                            @csrf
