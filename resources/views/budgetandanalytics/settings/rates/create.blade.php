...
<div class="card p-4">
    ...
    <form method="POST" action="{{ route('rates.store') }}">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="RateTypeCode" id="RateTypeCode" class="form-control" placeholder="e.g., RATE-001" required>
        </div>

        <div class="mb-3">
            <label for="RateTypeName" class="form-label">Rate Type Name</label>
            <input type="text" name="RateTypeName" id="RateTypeName" class="form-control" placeholder="e.g., Interest Rate" required>
        </div>

        <div class="mb-3">
            <label for="Description" class="form-label">Description</label>
            <textarea name="Description" id="Description" rows="3" class="form-control" placeholder="Optional notes or usage..."></textarea>
        </div>
