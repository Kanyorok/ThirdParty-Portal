...
<div class="card p-4">
    ...
    <p class="text-muted mb-3">
        Manage your budget line categories here. You can create, edit, and delete categories to organize your budget lines effectively.
        ...
        <table class="table table-bordered table-striped">
            ...
            @else
              <div class="alert alert-info">
                No budget line categories found. <a href="{{ route('budgetlinecategories.create') }}">Create one now</a>.
            @endif
        </table>
    </div>
</div>
