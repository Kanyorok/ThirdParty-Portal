...
<div class="card p-4">
  ...
  <p class="text-muted">Inspect all submitted budget lines from the selected branch and scenario. You can approve or return for revision.</p>
  ...
  <div class="mb-3">
    ...
    <textarea class="form-control" id="reviewComment" rows="3" placeholder="Add remarks or conditions here..."></textarea>
  </div>
