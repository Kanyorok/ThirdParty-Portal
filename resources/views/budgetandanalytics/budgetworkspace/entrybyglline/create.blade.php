...
<div class="card mt-4">
  ...
  <form action="{{ route('entrybyglline.store') }}" method="POST">
    ...
    <p class="text-muted">
      Use this form to add a new budget line entry. This is a manual entry not associated with budget activities or projections.
    </p>
    ...
    <div class="manual-entry">
      <div class="mb-3">
        ...
        <input type="number" step="0.01" min="0.00" id="totalAmount" name="Amount" class="form-control" placeholder="e.g. 500000" required>
      </div>
    </div>
