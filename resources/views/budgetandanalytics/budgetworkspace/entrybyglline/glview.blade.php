    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            <div style="overflow-x: auto;">
                <p class="text-muted">
                    This page displays budget entries grouped by budget lines, branches, and amounts. You can edit, or
                            ...
                            <tr>
                                ...
                                <td style="width: 200px; white-space: nowrap;">
                                    <a href="#" class="btn btn-sm btn-info" data-bs-toggle="modal"
                                       data-bs-target="#allocModal{{ $item->Id }}">View Allocations</a>
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="allocModalLabel{{ $item->Id }}">Monthly
                                                        Allocations for {{ $item->budgetline->LineName }}</h5>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    @else
                                                        <div class="alert alert-info">No allocations found for this
                                                            entry.
                                                        </div>
                                                    @endif
                                                    <div>
