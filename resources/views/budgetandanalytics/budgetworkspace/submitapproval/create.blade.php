...
@section('content')
    <div class="card p-4">
        <h5>📤 Submit Budget</h5>
        <p class="text-muted">Submit your completed budget for review. Once submitted, it will be locked and routed for
            approval.</p>
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="remarks" rows="3"
                      placeholder="Any notes or comments to the approver..."></textarea>
        </div>
