            ...
            <tbody>
                @foreach ($projections as $projection)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('budgetprojections.show',$projection->Id)}}" class="btn btn-sm btn-outline-info">👁</a>
                            <form action="#" method="POST" class="d-inline">
                                @csrf @method('DELETE')
                                <button class="btn btn-sm btn-outline-danger" onclick="return confirm('Delete this entry?')">🗑</button>
                            </form>
 
                            <a href="{{route('budgetprojections.edit',$projection->Id)}}" class="btn btn-sm btn-outline-info">🖉 </a>
                            <a href="{{route('monthly.create', $projection->Id)}}" class="btn btn-sm btn-outline-info">Monthly</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
