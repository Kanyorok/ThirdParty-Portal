...
<div class="card p-4">
  ...
  <p class="text-muted">Define budgeting scenarios and select the planning method (top-down, bottom-up, or hybrid).</p>

  <div class="mb-3">
    <label for="scenarioName" class="form-label">Scenario Name</label>
    <input type="text" class="form-control" id="scenarioName" placeholder="e.g., Base Case, Best Case, Worst Case">
  </div>

  <div class="mb-3">
    <label for="description" class="form-label">Description</label>
    <textarea class="form-control" id="description" rows="3" placeholder="Describe the scenario purpose or assumptions..."></textarea>
  </div>
