...
<div class="card p-4">
  ...
  <p class="text-muted">View top contributors to loans and deposits, segmented by account type and contributor size.</p>
  ...
  <div class="row g-4">
    <div class="col-md-4">
      <div class="card shadow-sm p-3 text-center h-100">
        ...
        <a href="{{ route('toploans.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍 View Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3 text-center h-100">
        ...
        <a href="{{ route('topcurrentaccounts.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍 View Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3 text-center h-100">
        ...
        <a href="{{ route('topsavingaccounts.index') }}"  class="btn btn-outline-primary btn-sm mt-2 w-100">🔍 View Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-6">
      <div class="card shadow-sm p-3 text-center h-100">
        ...
        <a href="{{ route('topdepositors.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍 View Drilldown</a>
      </div>
    </div>
  </div>
</div>
