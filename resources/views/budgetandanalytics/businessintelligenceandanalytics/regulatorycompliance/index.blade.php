  ...
  <div class="row g-4">
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('capitaladequacyratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('liquidityratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('loantodepositratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('costtoincomeratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('returnonassetsratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
    ...
    <div class="col-md-4">
      <div class="card shadow-sm p-3">
        ...
        <a href="{{ route('returnonequityratio.index') }}" class="btn btn-outline-secondary btn-sm">🔍 Drilldown</a>
      </div>
    </div>
  </div>
</div>
