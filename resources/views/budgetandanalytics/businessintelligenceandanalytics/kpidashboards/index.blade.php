        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card p-3 shadow-sm text-center h-100">
                    ...
                    <a href="{{ route('loanbooktrends.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍
                        Drilldown</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card p-3 shadow-sm text-center h-100">
                    ...
                    <a href="{{ route('depositbooktrends.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍
                        Drilldown</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card p-3 shadow-sm text-center h-100">
                    ...
                    <a href="{{ route('dormantcasa.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍
                        Drilldown</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card p-3 shadow-sm text-center h-100">
                    ...
                    <a href="{{ route('nplrisk.index') }}" class="btn btn-outline-primary btn-sm mt-2 w-100">🔍
                        Drilldown</a>
                </div>
            </div>
