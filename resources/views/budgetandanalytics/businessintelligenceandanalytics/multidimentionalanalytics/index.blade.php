...
@section('content')
    ...
    <div class="card p-4">
        ...
        <p class="text-muted">Interactively explore financial and operational data across branches, officers, products,
            and more.</p>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('incomebybranch.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍 Drill
                        Down</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('expensebygl.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍 Drill
                        Down</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('npltrendbyproduct.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍 Drill
                        Down</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('depositgrowthbyofficer.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍
                        Drill Down</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('budgetvsactualbybranch.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍
                        Drill Down</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card shadow-sm text-center p-3">
                    ...
                    <a href="{{ route('loanyieldbybranch.index') }}" class="btn btn-sm btn-outline-primary mt-2">🔍 Drill
                        Down</a>
                </div>
            </div>
        </div>
