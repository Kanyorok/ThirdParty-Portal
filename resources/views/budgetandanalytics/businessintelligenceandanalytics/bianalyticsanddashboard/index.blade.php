...
@section('content')
    <div class="card p-4">
        ...
        <p class="text-muted">Quickly view key insights. Use filters to refresh the summaries. Click a tile to explore
            more details.</p>
        ...
        <div class="row g-4">
            <div class="col-md-4">
                <div class="card shadow-sm p-3 text-center h-100">
                    ...
                    <a href="{{ route('kpidashboards.index') }}" class="btn btn-outline-primary w-100">🔍 View
                        Dashboard</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-3 text-center h-100">
                    ...
                    <a href="{{ route('trendsdashboards.index') }}" class="btn btn-outline-success w-100">📊 Explore
                        Trends</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-3 text-center h-100">
                    ...
                    <a href="{{ route('regulatoryratios.index') }}" class="btn btn-outline-danger w-100">🧾 View
                        Compliance</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-3 text-center h-100">
                    ...
                    <a href="{{ route('topcontributors.index') }}" class="btn btn-outline-warning w-100">💼 Show
                        Reports</a>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card shadow-sm p-3 text-center h-100">
                    ...
                    <a href="{{ route('multidimensional.index') }}" class="btn btn-outline-secondary w-100">🔬 Open Cube
                        View</a>
                </div>
            </div>
