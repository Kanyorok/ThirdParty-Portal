                    ...
                    <div class="card p-4 border-0">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="FiscalYear{{ $item->Id }}" min="2020" name="FiscalYear" value="{{ $item->FiscalYear }}" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="From{{ $item->Id }}" class="form-label">From (Date)</label>
                                <input type="date" class="form-control" id="From{{ $item->Id }}" name="From" value="{{ $item->From }}" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="To{{ $item->Id }}" class="form-label">To (Date)</label>
                                <input type="date" class="form-control" id="To{{ $item->Id }}" name="To" value="{{ $item->To }}" required>
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="Notes{{ $item->Id }}" class="form-label">Notes</label>
                            <textarea class="form-control" id="Notes{{ $item->Id }}" name="Notes" rows="3" required>{{ $item->Notes }}</textarea>
                        </div>
