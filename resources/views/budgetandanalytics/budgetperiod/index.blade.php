...
@section('content')
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <a href="{{ route('budgetperiod.create') }}" class="btn btn-success btn-sm" data-bs-toggle="modal"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2 justify-content-center">
                                <a href="{{ route('budgetperiod.edit', $budget->Id) }}"
                                   class="btn btn-sm btn-info">✏️</a>

                                <form action="{{ route('budgetperiod.destroy', $budget->Id) }}" method="POST"
                        ...
                        <div class="card p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="FiscalYear" min="2020"
                                           name="FiscalYear" placeholder="e.g., 2025" required>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-3">
