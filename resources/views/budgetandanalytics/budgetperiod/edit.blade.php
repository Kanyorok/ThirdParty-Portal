...
<form method="POST" action="{{ route('budgetperiod.update', $periods->Id) }}">
    ...
    <div class="card p-4">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="notes" name="notes" rows="3">{{ old('notes', $periods->notes) }}</textarea>
        </div>

        <div class="mb-3">
            <button type="submit" class="btn btn-primary" onclick="this.disabled=true; this.innerText='editing...'; this.form.submit();">💾 Update</button>
