...
@section('content')
    <div class="container-lg mt-2">
        ...
        <div class="fs-6 text-secondary mb-1">
            This form allows you to add new GL to the budget specified.
        </div>
        @if(session('error'))
        ...
        <form method="post" action="{{ route('budgetperiod.attachGL') }}">
            @csrf
            @method('POST')
            ...
            <div class="card p-4 shadow-sm border-0 rounded-3">
                ...
                <h5 class="mt-2 mb-3 fw-bold text-primary">Select General Ledger Accounts</h5>
                <div class="row g-3">
                ...
                <div class="modal-footer border-0 pt-4">
                    ...
                    <button type="submit" class="btn btn-primary rounded-3"
                        ...
                        <i class="bi bi-save me-1"></i>Attach GL(s)
                    </button>
                </div>
            </div>
        </form>
