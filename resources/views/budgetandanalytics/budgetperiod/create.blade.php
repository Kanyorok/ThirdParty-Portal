        ...
        <div class="card p-4 shadow-sm border-0 rounded-3">
            <div class="row g-3">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control rounded-3" id="Name" name="Name" placeholder="Enter the Budget Name" required>
                </div>
                <div class="col-md-6 mb-3">
                    <label for="FiscalYear" class="form-label fw-medium">Fiscal Year</label>
                    <input type="number" class="form-control rounded-3" id="FiscalYear" min="2020" name="FiscalYear" placeholder="e.g., 2025" required>
                </div>
            </div>
            <div class="row g-3">
                <div class="col-md-6 mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control rounded-3" id="notes" name="Notes" rows="3" placeholder="Add any additional notes"></textarea>
            </div>
