...
<div class="card mb-4">
  ...
  <div class="card-body">
    <p class="text-muted">
      Use this form to create a new Budget Line. A Budget Line defines a specific category under your budget, which can be linked to CBS GL accounts and optionally to product types if it's projection-driven. 
      You can select multiple GL accounts and, if applicable, associate relevant product types to help guide future projections and allocations under this line.
    </p>
