...
@section('content')
    ...
    <div class="mb-2 d-flex justify-content-between">
        <a href="{{ route('budgetlinemapping.create') }}" class="btn btn-success btn-sm" data-bs-toggle="modal1"
...
{{--        <div class="card-header bg-secondary text-white">📄 Budget Lines List</div>--}}
        <div class="card-body">
            <p class="text-muted">
                ...
                mapped CBS GL accounts, and product type mappings (if projection-driven).
            </p>
                            ...
                            <td>
                                @if($item->IsProductDriven)
                                    <a href="{{ route('budgetlinemapping.show', $item->Id) }}" class="badge bg-primary"
                                       title="View Product Types">Yes</a>
                                @else
