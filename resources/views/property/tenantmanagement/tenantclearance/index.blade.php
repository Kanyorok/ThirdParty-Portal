...
@section('styles')
    ...
    <style>
        ...
        /* Optional: tighten DataTable look */
        table.dataTable th,
        table.dataTable td {
                    ...
                    <table id="tenantclearance"
                        ...
                        @foreach($clearancetenants as $clearancetenant)
                            <tr>
                                ...
                                <td>
                                    {{ $clearancetenant->lease->tenant->thirdParty->TradingName ?? '-' }}
                                </td>

                                <td>
                                    {{ $clearancetenant->ExitDate
                                        ? Carbon::parse($clearancetenant->ExitDate)->format('d M Y')
                                        : '-' }}
                                </td>
                                ...
                                <td>
                                    {{ $clearancetenant->code->Description ?? '-' }}
                                </td>
