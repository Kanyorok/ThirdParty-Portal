        ...
        <div class="card shadow-sm border-0 rounded-3">
            <div class="card-body">
                ...
                <div class="row g-3 text-dark">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->LeaseNumber ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Tenant</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->tenant->TenantName ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Property</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->property->PropertyName ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Block</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->block->BlockName ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Floor</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->floor->FloorLabel ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Unit</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->unit->UnitCode ?? '-' }}" readonly>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->code->Description ?? '-' }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Due Day</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ $newlease->DueDay ?? '-' }}" readonly>
                    </div>
                </div>
                <br>
                ...
                <div class="row g-3 text-dark">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ number_format($newlease->MonthlyRent, 2) }}" readonly>
                    </div>

                    <div class="col-md-6">
                        <label class="form-label fw-semibold">Deposit (KES)</label>
                        <input type="text" class="form-control bg-light text-dark"
                               value="{{ number_format($newlease->Deposit, 2) }}" readonly>
                    </div>
                ...
                <div class="mb-3">
                    <textarea class="form-control bg-light text-dark" rows="3"
                              readonly>{{ $newlease->SpecialTerms ?? '—' }}</textarea>
                </div>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center py-2 bg-light small text-dark">
                <div>
                    ...
                    on
                    <strong>{{ $newlease->CreatedOn ? Carbon::parse($newlease->CreatedOn)->format('d/m/Y') : '-' }}</strong>
                    | Modified by <strong>{{ $newlease->modifiedByUser->Name ?? '-' }}</strong>
                    on
                    <strong>{{ $newlease->ModifiedOn ? Carbon::parse($newlease->ModifiedOn)->format('d/m/Y') : '-' }}</strong>
                </div>
                <div>
