        ...
        <div class="card shadow-sm border-0 rounded-3">
            ...
            <div class="card-footer d-flex justify-content-between align-items-center py-2 bg-light small text-dark">
                <div>
                    ...
                    on
                    <strong>{{ $leaseschedule->CreatedOn ? Carbon::parse($leaseschedule->CreatedOn)->format('d/m/Y') : '-' }}</strong>
                    | Modified by <strong>{{ $leaseschedule->modifiedByUser->Name ?? '-' }}</strong>
                    on
                    <strong>{{ $leaseschedule->ModifiedOn ? Carbon::parse($leaseschedule->ModifiedOn)->format('d/m/Y') : '-' }}</strong>
                </div>
                <div>
