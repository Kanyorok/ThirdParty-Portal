      ...
      <div class="card-body">
        <div class="row g-3 mb-3">
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="{{ $leaseschedules->lease->property->PropertyName ?? '' }}" readonly>
          ...
          <div class="col-md-6">
            ...
            <input type="text" class="form-control" value="{{ $leaseschedules->lease->code->Description ?? '' }}" readonly>
            <input type="hidden" name="PaymentFrequency" value="{{ $leaseschedules->lease->PaymentFrequency ?? '' }}">
          </div>
        </div>
