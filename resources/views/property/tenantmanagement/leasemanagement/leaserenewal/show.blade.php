        ...
        <div class="card-body">
            ...
            <div class="row g-3 text-dark">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light text-dark"
                           value="{{ $leaserenewal->NewMonthlyRent ? number_format($leaserenewal->NewMonthlyRent, 2) : '-' }}"
                           readonly>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light text-dark"
                           value="{{ $leaserenewal->ServiceCharge ? number_format($leaserenewal->ServiceCharge, 2) : '-' }}"
                           readonly>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light text-dark"
                           value="{{ $leaserenewal->ParkingFee ? number_format($leaserenewal->ParkingFee, 2) : '-' }}"
                           readonly>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control bg-light text-dark"
                           value="{{ $leaserenewal->OtherCharges ? number_format($leaserenewal->OtherCharges, 2) : '-' }}"
                           readonly>
                </div>
            </div>
            ...
            <div class="card-footer d-flex justify-content-between align-items-center py-2 bg-light small text-dark">
                <div>
                    ...
                    on
                    <strong>{{ $leaserenewal->CreatedOn ? Carbon::parse($leaserenewal->CreatedOn)->format('d/m/Y') : '-' }}</strong>
                    | Modified by <strong>{{ $leaserenewal->modifiedByUser->Name ?? '-' }}</strong>
                    on
                    <strong>{{ $leaserenewal->ModifiedOn ? Carbon::parse($leaserenewal->ModifiedOn)->format('d/m/Y') : '-' }}</strong>
                </div>
                <div>
