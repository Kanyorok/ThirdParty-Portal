...
<div class="container mt-4">
    ...
    <form action="{{ route('addtenant.update', $tenants->Id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <p><small>This screen is used in editing the tenant creation. (Tenant Profile is edited from the Third Party Portal) </small></p>
        ...
        <div class="card shadow">
            ...
            <div class="card-footer text-end py-2">
                ...
                <button type="submit" class="btn btn-success"
                        onclick="this.disabled=true; this.innerText='Updating...'; this.form.submit();">Update Tenant
                </button>
            </div>
        </div>
    </form>
