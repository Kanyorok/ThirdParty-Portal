      ...
      <div class="card-body">
        ...
        <div class="row g-3 mb-3">
            ...
            <select id="invoice-select" class="form-select" disabled>
              ...
              @foreach ($invoices as $invoice)
                <option value="{{ $invoice->Id }}"
                  ...
                  data-invoicedate-name="{{ $invoice->InvoiceDate }}"
                  data-invoicedate-id="{{ $invoice->InvoiceDate }}"
                  data-rentamount-name="{{ $invoice->RentAmount }}"
                  data-rentamount-id="{{ $invoice->RentAmount }}"
                  data-servicescharge-name="{{ $invoice->ServicesCharge }}"
                  data-servicescharge-id="{{ $invoice->ServicesCharge }}"
                  data-parkingfee-name="{{ $invoice->ParkingFee }}"
                  data-parkingfee-id="{{ $invoice->ParkingFee }}"
          ...
          <div class="col-md-6">
            ...
            <input type="text" id="invoice-display" class="form-control" readonly value="{{ optional($receipts->invoice)->InvoiceNumber }}">
          </div>
        </div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-6">
            ...
            <input type="text" id="tenantid-display" class="form-control" readonly value="{{ optional($receipts->invoice)->TenantName }}">
          </div>

          <div class="col-md-6">
            <label class="form-label">Billing Month</label>
            <input type="text" id="billingmonth-display" class="form-control" readonly value="{{ $receipts->BillingMonth }}">
            <input type="hidden" name="BillingMonth" id="billingmonth-id" value="{{ $receipts->BillingMonth }}">
          </div>

          <div class="col-md-6">
            <label class="form-label">Invoice Date</label>
            <input type="date" id="invoicedate-display" class="form-control" readonly value="{{ $receipts->InvoiceDate }}">
            <input type="hidden" name="InvoiceDate" id="invoicedate-id" value="{{ $receipts->InvoiceDate }}">
          </div>

          <div class="col-md-6">
            <label class="form-label">Rent Amount</label>
            <input type="number" id="rentamount-display" class="form-control" readonly value="{{ $receipts->RentAmount }}">
            <input type="hidden" name="RentAmount" id="rentamount-id" value="{{ $receipts->RentAmount }}">
          </div>

          <div class="col-md-6">
            <label class="form-label">Services Charge</label>
            <input type="number" id="servicescharge-display" class="form-control" readonly value="{{ $receipts->ServicesCharge }}">
          ...
          <div class="col-md-6">
            ...
            <input type="number" id="parkingfee-display" class="form-control" readonly value="{{ $receipts->ParkingFee }}">
            <input type="hidden" name="ParkingFee" id="parkingfee-id" value="{{ $receipts->ParkingFee }}">
          </div>

          <div class="col-md-6">
            <label class="form-label">Other Charges</label>
            <input type="number" id="othercharges-display" class="form-control" readonly value="{{ $receipts->OtherCharges }}">
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-3">
            ...
            <input type="number" class="form-control" name="TotalDue" id="totaldue" readonly step="0.01" value="{{ $receipts->TotalDue }}">
          </div>
          <div class="col-md-3">
            <label class="form-label">Amount Paid So Far</label>
            <input type="number" name="AmountPaidSoFar" id="amount_paid_so_far" class="form-control" readonly value="{{ $receipts->AmountPaidSoFar }}">
          </div>
          <div class="col-md-3">
            <label class="form-label">Balance</label>
            <input type="number" class="form-control" name="Balance" id="balance" readonly step="0.01" value="{{ $receipts->Balance }}">
          </div>
          <div class="col-md-3">
            <label class="form-label">Payment Date</label>
            <input type="date" class="form-control" name="PaymentDate" required value="{{ $receipts->PaymentDate }}">
          </div>
        </div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-md-4">
            ...
            <input type="number" class="form-control" name="AmountPaidNow" id="amount_paid_now" required min="1" value="{{ $receipts->AmountPaidNow }}">
          </div>
          ...
          <div class="col-md-4">
            ...
            <input type="text" class="form-control" name="ReferenceNo" placeholder="e.g. MPESA12345" required maxlength="100" value="{{ $receipts->ReferenceNo }}">
          </div>
        </div>
