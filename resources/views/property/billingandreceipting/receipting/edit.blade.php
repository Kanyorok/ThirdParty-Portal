                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" name="AmountPaidSoFar" id="amount_paid_so_far" class="form-control"
                                   readonly
                    ...
                    <div class="row g-3 mb-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-select" name="PaymentMethod" required>
                                ...
                                @foreach ($receipts->code ? [$receipts] : [] as $receipt)
                                    <option value="{{ $receipt->PaymentMethod }}"
                                            selected>{{ $receipt->code->Description }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control" name="ReferenceNo" placeholder="e.g. MPESA12345"
                                   required
