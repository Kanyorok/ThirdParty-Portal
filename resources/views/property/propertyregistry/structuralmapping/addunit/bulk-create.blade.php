@extends('layouts.app')
@section('title', 'Bulk Upload Property Units')
...
<div class="bulk-upload-section py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-cloud-upload-alt"></i> Bulk Upload Property Units
        </h2>
        <a href="{{ route('addunit.index') }}" class="btn btn-outline-secondary btn-sm">
    ...
    <div class="form-section">
        <form action="{{ route('addunit.bulkStore') }}" method="POST" enctype="multipart/form-data" id="bulkUploadForm">
            @csrf
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('addunit.bulkTemplate') }}" class="btn btn-outline-info" target="_blank">
                    <i class="fas fa-download"></i> Download Template
                </a>
                <a href="{{ route('addunit.index') }}" class="btn btn-outline-secondary">
                    Cancel
                </a>
            </div>
        </form>
