            ...
            <div class="row g-2 mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="IsRentable" required>
                        <option value="1" {{ old('IsRentable', $unit->IsRentable) == '1' ? 'selected' : '' }}>Yes
                        </option>
                        <option value="0" {{ old('IsRentable', $unit->IsRentable) == '0' ? 'selected' : '' }}>No
                        </option>
                    </select>
            </div>
                <div class="col-md-6">
                    ...
                    <select class="form-select" name="CurrentStatus">
                        <option value="1" {{ old('CurrentStatus', $unit->CurrentStatus) == '1' ? 'selected' : '' }}>
                            Vacant
                        </option>
