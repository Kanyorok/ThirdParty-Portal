@extends('layouts.app')
@section('title', 'Bulk Upload Property Blocks')
...
<div class="bulk-upload-section py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-cloud-upload-alt"></i> Bulk Upload Property Blocks
        </h2>
        <a href="{{ route('addblock.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-md-6">
            <div class="upload-info-box">
                ...
                <ul>
                    ...
                    <li><strong>BlockName</strong> - Block name</li>
        ...
        <div class="col-md-6">
            <div class="upload-info-box">
                ...
                <ul>
                    ...
                    <li>PropertyID must exist in system</li>
                    <li>BlockName must be unique per property</li>
    ...
    <div class="form-section">
        <form action="{{ route('addblock.bulkStore') }}" method="POST" enctype="multipart/form-data" id="bulkUploadForm">
            @csrf
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('addblock.bulkTemplate') }}" class="btn btn-outline-info" target="_blank">
                    <i class="fas fa-download"></i> Download Template
                </a>
                <a href="{{ route('addblock.index') }}" class="btn btn-outline-secondary">
                    Cancel
                </a>
            </div>
        </form>
