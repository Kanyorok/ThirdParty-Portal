            ...
            <form action="{{ route('addblock.update', $block->Id) }}" method="POST">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="BlockName" id="BlockName" 
                            ...
                            value="{{ old('BlockName', $block->BlockName) }}" placeholder="e.g. Block A, Tower 1" required>
                        @error('BlockName')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="Description" id="Description" 
                        class="form-control" rows="3" placeholder="Optional description">{{ old('Description', $block->Description) }}</textarea>
                </div>
