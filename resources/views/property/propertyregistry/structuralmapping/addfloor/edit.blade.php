    ...
    <form action="{{ route('addfloor.update', $floor->Id) }}" method="POST">
        ...
        <div class="card shadow border-0 rounded-3">
            ...
            <div class="card-body">
                ...
                {{-- Floor Label --}}
                <div class="mb-3">
                    <label for="FloorLabel" class="form-label fw-bold">Floor Label <span class="text-danger">*</span></label>
                    <input type="text" name="FloorLabel" id="FloorLabel"
                           class="form-control @error('FloorLabel') is-invalid @enderror"
                           value="{{ old('FloorLabel', $floor->FloorLabel) }}" placeholder="e.g. Ground Floor, 1st Floor" required>
                    @error('FloorLabel')
