        ...
        <div class="card shadow-sm rounded-3">
                ...
                <form>
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" value="{{ $property->PropertyName ?? '-' }}"
                                   readonly>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Property Code</label>
                            <input type="text" class="form-control" value="{{ $property->PropertyCode ?? '-' }}"
                                   readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                   value="{{ $property->type->PropertyTypeName ?? '-' }}" readonly>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Property Category</label>
                            <input type="text" class="form-control"
                                   value="{{ $property->propertyCategory->Name ?? '-' }}" readonly>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control"
                                   value="{{ $property->propertyLocality->Name ?? '-' }}" readonly>
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">Area/Locality</label>
                            <input type="text" class="form-control" value="{{ $property->AreaLocality ?? '-' }}"
                                   readonly>
                        </div>
                        ...
                        <div class="col-12">
                            ...
                            <textarea class="form-control" rows="3"
                                      readonly>{{ $property->PropertyDescription ?? '-' }}</textarea>
                        </div>
            ...
            <div class="card-footer small bg-light text-muted">
                <div class="row g-2">
                    ...
                    <div class="col-md-3">
                        <strong>Created
                            On:</strong> {{ $property->CreatedOn ? \Carbon\Carbon::parse($property->CreatedOn)->format('d/m/Y') : '-' }}
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <strong>Modified
                            On:</strong> {{ $property->ModifiedOn ? \Carbon\Carbon::parse($property->ModifiedOn)->format('d/m/Y') : '-' }}
                    </div>
                </div>
