...
<div class="bulk-upload-section py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="mb-0">
            <i class="fas fa-cloud-upload-alt"></i> Bulk Upload Properties
        </h2>
        <a href="{{ route('PropertyRegistry.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-md-6">
            <div class="upload-info-box">
                ...
                <ul>
                    ...
                    <li><strong>PropertyCode</strong> - Unique code (e.g., PROP-001)</li>
                    <li><strong>PropertyType</strong> - Type ID</li>
                    <li><strong>Category</strong> - Category ID</li>
                    <li><strong>Owner</strong> - Property owner name</li>
                    <li><strong>AcquisitionDate</strong> - Format: YYYY-MM-DD</li>
                    <li><strong>CountryId</strong> - Country ID</li>
                    <li><strong>LocationId</strong> - Location ID</li>
        ...
        <div class="col-md-6">
            <div class="upload-info-box">
                ...
                <ul>
                    ...
                    <li>PropertyCode must be unique</li>
                    <li>PropertyDescription is optional</li>
                    <li>Use consistent date format</li>
                    <li>Download template to see example format</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="form-section">
        <form action="{{ route('PropertyRegistry.bulkStore') }}" method="POST" enctype="multipart/form-data" id="bulkUploadForm">
            @csrf
            ...
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('PropertyRegistry.bulkTemplate') }}" class="btn btn-outline-info" target="_blank">
                    <i class="fas fa-download"></i> Download Template
                </a>
                <a href="{{ route('PropertyRegistry.index') }}" class="btn btn-outline-secondary">
                    Cancel
                </a>
            </div>
        </form>
