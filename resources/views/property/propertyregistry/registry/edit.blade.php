        ...
        <div class="card shadow">
            ...
            <div class="card-body">
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="date" name="AcquisitionDate" class="form-control"
                               value="{{ old('AcquisitionDate', $property->AcquisitionDate ? \Carbon\Carbon::parse($property->AcquisitionDate)->format('Y-m-d') : '') }}" required>
                    </div>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" rows="3" name="PropertyDescription">{{ old('PropertyDescription', $property->PropertyDescription) }}</textarea>
                </div>
