  ...
  <div class="row g-3 mb-4">
    ...
    <div class="col-md-3">
        <select name="status" class="form-select">
            ...
            <option
                value="{{ \App\Enums\Core\PostingEnum::Pending }}" {{ request('status') == \App\Enums\Core\PostingEnum::Pending ? 'selected' : '' }}>
                Pending
            </option>
            <option
                value="{{ \App\Enums\Core\PostingEnum::Completed }}" {{ request('status') == \App\Enums\Core\PostingEnum::Completed ? 'selected' : '' }}>
                Completed
            </option>
      </select>
    </div>
