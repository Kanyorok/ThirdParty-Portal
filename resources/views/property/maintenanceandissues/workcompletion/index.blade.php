...
<div class="container mt-4" style="max-width: 1200px;">
    ...
    <div class="card shadow-sm border-0">
      <div class="card-body">
        <div class="table-responsive">
          <table id="WorkCompletionTable" class="table table-bordered table-striped table-hover align-middle mb-0">
  ...
  @else
    <div class="alert alert-info mt-3">
      <i class="bi bi-info-circle me-2"></i> No maintenance work completion records found.
    </div>
  @endif
</div>
@endsection
