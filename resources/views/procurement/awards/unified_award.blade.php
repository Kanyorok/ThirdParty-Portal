...
@section('content')
    ...
    <div class="container mt-4">
                                ...
                                <select id="itemSelector" class="form-select form-select-sm" onchange="switchItem()">
                                    @if($type === 'tender')
                                        @foreach($availableItems['tender'] ?? [] as $item)
                                            <option
                                                value="{{ $item['id'] }}" {{ $item['id'] == $tender->Id ? 'selected' : '' }}>
                                                {{ $item['number'] }}
                                                @if($item['has_award'])
                                                    ✅
                                                @endif
        ...
        <div class="card shadow-sm">
            <div
                class="card-header {{ $type === 'rfq' ? 'bg-success' : 'bg-primary' }} text-white d-flex justify-content-between align-items-center">
                <h5 class="mb-0">
                    @if($type === 'rfq')
                    ...
                    <form action="{{ route('procawards.store') }}" method="POST" id="awardForm">
                        ...
                        @if(!$existingAward)
                            ...
                            <div class="border-top pt-4 mt-4">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Award Justification <span
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="awarded_amount" class="form-control" step="0.01"
                                                   placeholder="Final contract amount"
                                                   value="{{ old('awarded_amount') }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="notify">
                                                ...
                                                unsuccessful {{ $type === 'rfq' ? 'suppliers' : 'bidders' }}
                                            </label>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        ...
                                        <button type="submit"
                                                class="btn {{ $type === 'rfq' ? 'btn-success' : 'btn-primary' }}">
