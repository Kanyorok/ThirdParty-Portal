        ...
        <form method="GET" class="row g-3 mb-3">
            <div class="col-md-3">
                <select name="status_filter" class="form-select">
                    ...
                    <option value="Pending" {{ ($filters['status_filter'] ?? '') === 'Pending' ? 'selected' : '' }}>
                        Pending
                    </option>
                    <option value="Awarded" {{ ($filters['status_filter'] ?? '') === 'Awarded' ? 'selected' : '' }}>
                        Awarded
                    </option>
                </select>
            </div>
            <div class="col-md-6">
                <input type="text" name="search" class="form-control" placeholder="Search Ref / Title / Supplier"
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        @else
                                            <span class="btn btn-sm btn-outline-secondary disabled"
                                                  title="Missing reference id">View</span>
                                        @endif
