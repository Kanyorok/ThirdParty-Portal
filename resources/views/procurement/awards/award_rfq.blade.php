    ...
    <div class="container mt-4">
        @if($existingAward)
            <div class="alert alert-info">
                ...
                This RFQ has already been awarded to <strong>{{ $existingAward->winningSupplier->SupplierName }}</strong> 
                    ...
                    <form action="{{ route('procawards.store') }}" method="POST">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" value="{{ $tender->createdBy->Name ?? 'N/A' }}" readonly>
                            </div>
                            <div class="col-md-4">
                                <label class="form-label">Submission Deadline</label>
                                <input type="text" class="form-control" value="{{ $tender->SubmissionDeadline->format('Y-m-d') }}" readonly>
                            </div>
                            <div class="col-md-4">
                        ...
                        @if(!$existingAward)
                            ...
                            <div class="form-check mb-4">
                                <input class="form-check-input" type="checkbox" name="notify_unsuccessful" id="notifyUnsuccessful" value="1"
