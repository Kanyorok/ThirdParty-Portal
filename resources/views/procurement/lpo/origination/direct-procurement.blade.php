            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Create Local Purchase Orders from approved procurement plan items designated for direct procurement</p>
                    </div>
                    <div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="small">
                                                    ...
                                                    @if($totalItems > 3)
                                                        <div class="text-muted small">
                                                            <i class="fas fa-ellipsis-h"></i> and {{ $totalItems - 3 }} more items
                                                        </div>
                                                    @endif
                                                </div>
                                            </td>
                                                ...
                                                <div class="btn-group" role="group">
                                                    @if($plan->Status === 'Approved' && $plan->planLineItems->count() > 0)
                                                        <a href="{{ route('lpo.create.direct-procurement', $plan->PlanID) }}" 
                                                           class="btn btn-sm btn-info text-white" title="Create LPO from Direct Procurement Plan">
                                                            <i class="fas fa-plus-circle"></i> Create LPO
                                                        </a>
                                                    @else
                                                        <span class="btn btn-sm btn-outline-secondary disabled" title="Plan not ready for LPO creation">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="{{ route('procurement-plan-consolidation.show', $plan->PlanID) }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="6" class="text-center py-5">
                                                ...
                                                <p class="text-muted">No approved procurement plans with direct procurement items are available at this time.</p>
                                                <div class="mt-3">
                                                    <a href="{{ route('procurement-plan-consolidation.index') }}" class="btn btn-primary me-2">
                        ...
                        <div class="card border-success">
                            ...
                            <div class="card-body">
                                ...
                                <div class="small text-muted">
                                    ...
                                    <strong>Tip:</strong> Direct procurement is most efficient for routine, low-value items with pre-approved budgets.
                                </div>
                            </div>
                        </div>
                    </div>
