                                            ...
                                            @if($award->tender)
                                                <div>
                                                    ...
                                                    <div class="text-muted small">
                                                        ...
                                                        {{ $award->tender->TenderType }}
                                                        • {{ $award->tender->TenderCategory }}
                                                    </div>
                                                </div>
                                            @else
                                            ...
                                            <div class="btn-group" role="group">
                                                @if($award->is_approved)
                                                    <a href="{{ route('lpo.create.award', $award->Id) }}"
                                                       ...
                                                       title="Create LPO from Award">
                                                        <i class="fas fa-plus-circle"></i> Create LPO
                                                    </a>
                                                @else
                                                    <span class="btn btn-sm btn-outline-secondary disabled"
                                                          title="Award not yet approved">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    @if($award->tender)
                                                        <li>
                                                            <a class="dropdown-item"
                                                               href="{{ route('tender.show', $award->tender->Id) }}">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center py-5">
                                            ...
                                            <p class="text-muted">No approved awards that don't require contracts are
                        ...
                        <div class="card border-info">
                            ...
                            <div class="card-body">
                                ...
                                <div class="small text-muted">
                                    ...
                                    <strong>Tip:</strong> Award-based LPOs are ideal for smaller, immediate procurements
