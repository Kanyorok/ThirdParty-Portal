            ...
            <div class="card-body">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <p><strong>Priority:</strong> <span class="badge badge-danger">{{ $purchaseOrder->priority }}</span></p>
                ...
                <div class="row mt-4">
                    <div class="col-md-12">
                        ...
                        <a href="{{ route('purchase-orders.print', $purchaseOrder->id) }}" class="btn btn-info btn-lg ml-2">
