            ...
            @forelse ($rfqEvaluations as $index => $evaluation)
                ...
                @foreach ($grouped as $supplierId => $evalGroup)
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#viewModal-{{ $evaluation->Id }}">
                                View
                            </button>
                        </td>
                    </tr>
...
<div class="modal fade" id="viewModal-{{ $evaluation->Id }}" tabindex="-1" aria-labelledby="viewModalLabel-{{ $evaluation->Id }}" aria-hidden="true">
