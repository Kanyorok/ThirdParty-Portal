            ...
            <div class="card-body">
                <form>
                    ...
                    <div class="mb-3 d-none" id="scopeDiv">
                        ...
                        <textarea class="form-control" id="scopeDetails" rows="3"
                                  placeholder="Describe scope changes..."></textarea>
                    </div>
                    ...
                    <div class="mb-3 d-none" id="otherDiv">
                        ...
                        <textarea class="form-control" id="otherDetails" rows="3"
                                  placeholder="Explain the amendment..."></textarea>
                    </div>
