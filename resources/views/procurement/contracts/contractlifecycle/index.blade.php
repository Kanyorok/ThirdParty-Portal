                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="d-flex gap-1 justify-content-center flex-wrap">
                                <a href="{{ route('contracts.contracts.view', 1) }}" class="btn btn-sm btn-outline-secondary">View</a>
                                <a href="{{ route('contracts.contracts.execution', 1) }}" class="btn btn-sm btn-outline-primary">Monitor</a>
                                <a href="{{ route('contracts.contracts.amend', 1) }}" class="btn btn-sm btn-outline-danger">Amend/Terminate</a>
                            </td>
                        </tr>
                        <!-- More contracts -->
                    </tbody>
