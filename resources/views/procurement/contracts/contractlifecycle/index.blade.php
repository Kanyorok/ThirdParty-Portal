        ...
        <!-- Filters -->
            ...
            <div class="col-md-3">
                ...
                <select name="status_filter" class="form-select">
                    ...
                    <option value="Approved" {{ request('status_filter') === 'Approved' ? 'selected' : '' }}>Approved
                    </option>
                    <option value="Executed" {{ request('status_filter') === 'Executed' ? 'selected' : '' }}>
                        Active/Executed
                    </option>
                    <option value="Terminated" {{ request('status_filter') === 'Terminated' ? 'selected' : '' }}>
                        Terminated
                    </option>
                </select>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="8" class="text-center py-5">
                                    ...
                                    <p class="text-muted">No contracts in approved or executed status for lifecycle
                                        management.</p>
