                    ...
                    <tbody>
                        @forelse($legalRequests as $index => $request)
                            <tr>
                                <td>{{ $index + 1 }}</td>
                                <td>
                                    <strong class="text-primary">{{ $request->ContractRequestRef ?? 'Pending' }}</strong>
                                </td>
                                <td>{{ $request->tender->TenderNo ?? 'N/A' }}</td>
                                <td>{{ $request->tender->Title ?? 'N/A' }}</td>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="avatar-circle bg-secondary text-white me-2" style="width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 12px;">
                                ...
                                <td class="text-center">
                                    <div class="btn-group" role="group">
                                        ...
                                        <button type="button" class="btn btn-sm btn-outline-primary" 
                                                onclick="followUpLegal('{{ $request->ContractRequestRef }}')" title="Follow Up">
