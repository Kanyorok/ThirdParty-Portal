                                            ...
                                            <div class="row g-3 align-items-end">
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="status" class="form-select form-select-sm">
                                                        ...
                                                        <option
                                                            value="draft" {{ request('status') == 'draft' ? 'selected' : '' }}>
                                                            Draft
                                                        </option>
                                                        <option
                                                            value="posted" {{ request('status') == 'posted' ? 'selected' : '' }}>
                                                            Posted
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="processing_status" class="form-select form-select-sm">
                                                        ...
                                                        <option
                                                            value="pending" {{ request('processing_status') == 'pending' ? 'selected' : '' }}>
                                                            Pending
                                                        </option>
                                                        <option
                                                            value="processed" {{ request('processing_status') == 'processed' ? 'selected' : '' }}>
                                                            Processed
                                                        </option>
                                                        <option
                                                            value="error" {{ request('processing_status') == 'error' ? 'selected' : '' }}>
                                                            Error
                                                        </option>
                                                    </select>
                                                </div>
                                                <div class="col-md-2">
                                                    ...
                                                    <select name="item_type" class="form-select form-select-sm">
                                                        ...
                                                        <option
                                                            value="stock" {{ request('item_type') == 'stock' ? 'selected' : '' }}>
                                                            Stock
                                                        </option>
                                                        <option
                                                            value="asset" {{ request('item_type') == 'asset' ? 'selected' : '' }}>
                                                            Asset
                                                        </option>
                                                        <option
                                                            value="service" {{ request('item_type') == 'service' ? 'selected' : '' }}>
                                                            Service
                                                        </option>
                                                    </select>
                                                </div>
                                ...
                                @forelse($goodsReceipts as $receipt)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small
                                                class="text-muted">by {{ $receipt->receiver->name ?? 'System' }}</small>
                                        </td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center py-4">
                                            ...
                                            <br>
                                            <a href="{{ route('goods-receipt.create') }}"
