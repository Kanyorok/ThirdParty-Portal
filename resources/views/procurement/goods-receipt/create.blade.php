                        ...
                        <form action="{{ route('goods-receipt.store') }}" method="POST" id="grnCreateForm">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group mb-3">
                                                <label for="grn_id" class="form-label">GRN Number <span
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-3">
                                                <label for="store_id" class="form-label">Store <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" id="store_id" name="store_id" required>
                                                    <option value="">Select Store</option>
                                                    <option
                                                        value="STORE-001" {{ old('store_id') == 'STORE-001' ? 'selected' : '' }}>
                                                        Main Store
                                                    </option>
                                                    <option
                                                        value="STORE-002" {{ old('store_id') == 'STORE-002' ? 'selected' : '' }}>
                                                        Warehouse A
                                                    </option>
                                                    <option
                                                        value="STORE-003" {{ old('store_id') == 'STORE-003' ? 'selected' : '' }}>
                                                        Warehouse B
                                                    </option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group mb-3">
                                                <label for="delivery_note_ref" class="form-label">Delivery Note
                                                    Reference</label>
                            ...
                            <div class="card mb-4">
                                <div class="card-header bg-success text-white">
                                    <h6 class="mb-0"><i class="fas fa-file-invoice"></i> Step 2: Select Purchase Order
                                    </h6>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group mb-3">
                                                <label for="po_select" class="form-label">Purchase Order <span
                                                        class="text-danger">*</span></label>
                                                <select class="form-select" id="po_select" name="po_id" required>
                                                    <option value="">Select Purchase Order</option>
                                                    @foreach($availablePOs as $po)
                                                        <option
                                                            value="{{ $po->Id }}" {{ old('po_id') == $po->Id ? 'selected' : '' }}>
                                                            {{ $po->OrderNo }}
                                                            - {{ $po->supplier->thirdParty->TradingName ?? 'Unknown Supplier' }}
