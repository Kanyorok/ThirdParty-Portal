                ...
                <div class="card-body">
                        ...
                        <div class="col-md-4">
                            <div class="card bg-dark text-white">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between">
                                        <div>
                                            <h3 class="mb-0">KES {{ number_format($stats['total_value_pending'], 2) }}</h3>
                                                ...
                                                @forelse($recentGRNs as $grn)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <br><small class="text-muted">Qty: {{ $grn->ReceivedQTY }}</small>
                                                        </td>
                                                        <td>
                                                            <span class="badge bg-{{ $grn->ItemType == 'stock' ? 'success' : ($grn->ItemType == 'asset' ? 'warning' : 'info') }}">
                                                                {{ $grn->item_type_display }}
                                                            </span>
                                                        </td>
                                                        <td>{{ $grn->supplier->thirdParty->TradingName ?? 'N/A' }}</td>
                                                        <td><strong>KES {{ number_format($grn->TotalValue ?? 0, 2) }}</strong></td>
                                                        <td>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-header bg-danger text-white">
                                    <h6 class="mb-0"><i class="fas fa-exclamation-triangle"></i> Processing Errors</h6>
                                </div>
                                <div class="card-body">
                                    @forelse($processingErrors as $error)
                                        <div class="alert alert-danger alert-dismissible fade show mb-2" role="alert">
                                            <h6 class="alert-heading mb-1">{{ $error->GRNID }}</h6>
                                            <p class="mb-1"><strong>Item:</strong> {{ $error->item->ItemName ?? 'Unknown' }}</p>
                                            <p class="mb-1 small">{{ $error->ProcessingErrors }}</p>
                                            <hr class="my-2">
                                            <div class="d-flex justify-content-between align-items-center">
                                                <small class="text-muted">{{ $error->ModifiedOn ? $error->ModifiedOn->format('d M Y H:i') : 'N/A' }}</small>
                                                <div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-4">
                                            <div class="d-grid">
                                                <button type="button" class="btn btn-primary" onclick="processAllPending()">
                                        ...
                                        <div class="col-md-4">
                                            <div class="d-grid">
                                                <button type="button" class="btn btn-success" onclick="bulkQualityPass()">
                    ...
                    <div class="row mt-4">
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="mb-0"><i class="fas fa-chart-pie"></i> Item Type Distribution (Last 30 Days)</h6>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-header">
                                    <h6 class="mb-0"><i class="fas fa-chart-line"></i> Processing Trend (Last 7 Days)</h6>
                                </div>
                                <div class="card-body">
