        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <form action="{{ route('proc.supplier-cat.update', ['supplier_cat' => $category]) }}" method="POST">
                    ...
                    <div class="mb-3">
                        <label for="item_category_ids" class="form-label">Top-level Item Categories
                            (multi-select)</label>
                        <select id="item_category_ids" name="item_category_ids[]" class="form-control" multiple
                                size="6">
                        ...
                        <small class="text-muted">Hold Ctrl / Cmd to select multiple. Only parent categories (no
                            ParentId) listed.</small>
                    </div>
