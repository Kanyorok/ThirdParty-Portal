                    ...
                    <div class="table-responsive">
                        <table id="applicationsTable" class="table table-striped table-hover align-middle w-100">
                            ...
                            @foreach ($applications as $application)
                                <tr>
                                    <td><span class="fw-semibold text-dark">APP-{{ $application->ApplicationID }}</span>
                                    </td>
                                    ...
                                    <td>
                                        @if($application->category)
                                            <span
                                                class="badge bg-secondary">{{ $application->category->CategoryName }}</span>
                                        @else
                                ...
                                <span class="badge bg-{{ $application->Status->getColor() }} px-3 py-2">
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            ...
                                            <form
                                                action="{{ route('prequalification.applications.destroy', $application->ApplicationID) }}"
