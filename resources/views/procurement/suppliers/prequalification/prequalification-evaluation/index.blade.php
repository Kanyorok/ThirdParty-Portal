    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <form method="POST" id="bulkPrequalifyForm" class="d-flex align-items-center gap-2">
                ...
                <button type="submit" class="btn btn-sm btn-success"><i class="fas fa-check-double me-1"></i> Bulk
                    Prequalify (Passed)
                </button>
            </form>
        </div>
        <div class="card-body">
            <ul class="nav nav-pills mb-3" role="tablist">
                <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#tab-passed" role="tab">Passed</a>
                </li>
                <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-under-review" role="tab">Under
                        Review (Failed)</a></li>
            </ul>
