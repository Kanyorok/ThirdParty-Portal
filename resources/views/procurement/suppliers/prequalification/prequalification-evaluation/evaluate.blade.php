    ...
    <div class="card shadow-sm">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            <h4 class="mb-0 text-primary">
                @if($isReadonly)
                    <i class="fas fa-lock me-2 text-warning"></i>View Evaluation
                    Results: {{ $application->applicationNo }}
                @else
        ...
        <div class="card-body">
            ...
            @if($isReadonly)
                <div class="alert alert-warning d-flex align-items-center" role="alert">
                    ...
                    <div>
                        <strong>Read-only Mode:</strong> This evaluation has already been completed and cannot be
                        modified.
                        @if($result)
            ...
            <form action="{{ route('prequalification.prequalification-evaluation.submit', $application->ApplicationID) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <textarea name="general_comments" id="general_comments" class="form-control" rows="4"
                              @if($isReadonly) readonly @endif>{{ old('general_comments', $application->GeneralComments ?? '') }}</textarea>
                </div>
