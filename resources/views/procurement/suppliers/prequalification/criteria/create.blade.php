...
<div class="card">
  <div class="card-header bg-info text-white">
    🎯 Setup Criteria for <strong>Technical Evaluation</strong> — Round: <strong>2025 General Suppliers Prequalification</strong>
  </div>
  ...
  <div class="card-body">
    <form method="POST" action="#">
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          <tr>
            <td><input type="checkbox" name="criteria_ids[]" value="1" class="form-check-input" checked></td>
