            ...
            <form method="post" action="#">
                ...
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="{{ route('preqcriteria.create', ['section_id' => 1]) }}"
                               class="btn btn-sm btn-outline-primary">⚙️ Setup Criteria</a></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="sections[]" value="2" class="form-check-input"></td>
                        <td>Financial Evaluation</td>
                        <td><a href="{{ route('preqcriteria.create', ['section_id' => 2]) }}"
                               class="btn btn-sm btn-outline-primary">⚙️ Setup Criteria</a></td>
                    </tr>
                    <tr>
                        <td><input type="checkbox" name="sections[]" value="3" class="form-check-input"></td>
                        <td>Legal & Compliance</td>
                        <td><a href="{{ route('preqcriteria.create', ['section_id' => 3]) }}"
                               class="btn btn-sm btn-outline-primary">⚙️ Setup Criteria</a></td>
                    </tr>
                    </tbody>
                </table>
