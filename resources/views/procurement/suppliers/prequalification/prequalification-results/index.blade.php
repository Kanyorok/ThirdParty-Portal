                        ...
                        @forelse ($evaluations as $evaluation)
                            <tr>
                                ...
                                <td>
                                    @if ($evaluation->application->result)
                                        <span
                                            class="badge {{ $evaluation->application->result->Decision === 'Passed' ? 'bg-success' : 'bg-danger' }}">
                                ...
                                <td>
                                    ...
                                    @else
                                        <a href="{{ route('prequalification.prequalification-evaluation.show', $evaluation->ApplicationID) }}"
