        ...
        <div class="card-body">
            <form method="POST" action="{{ route('suppliers.store') }}" enctype="multipart/form-data">
                ...
                <ul class="nav nav-tabs" id="supplierTabs" role="tablist">
                    <li class="nav-item"><a class="nav-link active" data-bs-toggle="tab" href="#basic">1. Basic Info</a>
                    </li>
                    ...
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#category">4. Categories</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#docs">5. Documents</a></li>
                    <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#declaration">6. Declaration</a>
                    </li>
                </ul>
                ...
                <div class="tab-content p-3 border border-top-0">
                    ...
                    <div class="tab-pane fade" id="declaration">
                        <div class="form-check mb-3">
                            ...
                            <label class="form-check-label">I declare that the above information is true and
                                correct.</label>
                        </div>
