        ...
        <form method="POST" action="{{ route('tender.approve') }}">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="approveModalLabel">Approve Tender <i class="text-success fa fa-check-circle"></i></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">
                    <p>Are you sure you want to <strong>approve</strong> this tender? <strong>On approval it will also be published</strong></p>
                    <div class="mb-3">
