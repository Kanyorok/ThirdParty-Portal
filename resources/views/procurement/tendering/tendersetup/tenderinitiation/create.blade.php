        ...
        <form>
            ...
            <div class="mb-3">
                ...
                <div>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="tenderType" id="restrictedTender"
                               value="Restricted">
                        <label class="form-check-label" for="restrictedTender">Restricted Tender (Selected vendors
                            only)</label>
                    </div>
                </div>
            </div>
            ...
            <div class="tab-content p-3 border border-top-0" id="itemEntryTabsContent">
                ...
                <div class="tab-pane fade" id="manualEntry" role="tabpanel">
                    ...
                    <button type="button" class="btn btn-sm btn-primary" onclick="addManualItemRow()">➕ Add Item
                    </button>
                </div>
            </div>
