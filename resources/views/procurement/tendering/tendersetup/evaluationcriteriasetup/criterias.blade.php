            ...
            <form action="#" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  ...
                  <div class="mb-3">
                        ...
                        <textarea class="form-control" rows="2" placeholder="Describe the purpose of this criteria"></textarea>
                  </div>
                </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Technical</td>
                                <td><input type="number" class="form-control weight-input" name="weights[]" value="60.00" step="0.01"></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="sections[]" value="Financial" checked></td>
                                <td>Financial</td>
                                <td><input type="number" class="form-control weight-input" name="weights[]" value="30.00" step="0.01"></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="sections[]" value="Legal"></td>
                                <td>Legal</td>
                                <td><input type="number" class="form-control weight-input" name="weights[]" value="0.00" step="0.01" disabled></td>
                            </tr>
                            <tr>
                                <td><input type="checkbox" name="sections[]" value="Legal"></td>
                                <td>Legal</td>
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>Technical</td>
                    <td>100</td>
                    <td>3 <button class="btn btn-bd-primary"> <i class="fa fa-eye"></i></button></td>
                    <td>30</td>
                    <td>
                        <a href="/evaluation-criteria/view/1" class="btn btn-sm btn-outline-primary">View</a>
                        <a href="/evaluation-criteria/edit/1" class="btn btn-sm btn-outline-success">Edit</a>
