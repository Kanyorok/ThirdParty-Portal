                ...
                <tr>
                    ...
                    <td>
                        <select name="criteria[{{ $i }}][IsActive]" class="form-select">
                            <option value="1" {{ old("criteria.$i.IsActive", $criteria->IsActive) == 1 ? 'selected' : '' }}>Active</option>
                            <option value="0" {{ old("criteria.$i.IsActive", $criteria->IsActive) == 0 ? 'selected' : '' }}>Inactive</option>
                        </select>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger btn-sm remove-existing" data-id="{{ $criteria->Id }}">X</button>
                    </td>
                </tr>
                @endforeach
            </tbody>
