                    ...
                    <tbody>
                        @forelse($tenders as $tender)
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-{{ $tender->Status === 'Published' ? 'success' : ($tender->Status === 'Draft' ? 'secondary' : 'primary') }}">
                                        {{ ucfirst($tender->Status) }}
                                    </span>
                                </td>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        ...
                                        @if($sectionsCount > 0)
                                            <form method="POST" action="{{ route('tender-sections.destroy', $tender->Id) }}" 
                                    ...
                                    @if($section->criteria->count() > 0)
                                        <div class="mt-1">
                                            @foreach($section->criteria->take(3) as $criteria)
                                                <span class="badge bg-light text-dark">{{ $criteria->CriteriaName }}</span>
                                            @endforeach
