        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('tenders.show', $tender->Id) }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <p><strong>Current Status:</strong> 
                                    <span class="badge badge-{{ $tender->ApprovalStatusBadge }}">
                                        {{ $tender->ApprovalStatus?->label ?? 'N/A' }}
                                    </span>
                                </p>
                                @if($currentStage)
                                    <p><strong>Current Stage:</strong> 
                                        <span class="badge badge-info">
                                         {{ $currentStage['name'] ?? 'Stage ' . ($currentStage['order'] ?? 'Unknown') }}
                                        </span>
                                    </p>
                                @endif
                            </div>
