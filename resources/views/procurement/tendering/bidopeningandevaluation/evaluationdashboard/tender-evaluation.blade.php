    ...
    <div class="container mt-4">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <dl class="row">
                            ...
                            <dd class="col-sm-8">
                            <span
                                class="badge {{ $tender->Status ? $tender->Status->badgeClass() : 'bg-light text-dark' }}">
        ...
        @else
            <div class="alert alert-warning">
                ...
                This tender does not have evaluation sections set up. Please contact the administrator to configure
                evaluation sections and criteria before proceeding.
            </div>
        @endif
            ...
            <div class="card-body">
                @if($responsiveBids->isEmpty())
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted">There are currently no responsive bids available for evaluation in this
                            tender.</p>
                    </div>
                @else
                            ...
                            @foreach($responsiveBids as $bid)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small">
                                            <div>
                                                <strong>Source:</strong> {{ ucfirst($bid->SubmissionSource ?? 'manual') }}
                                            </div>
                                            @if($bid->ReceivedAt)
                                                <div>
                                                    <strong>Received:</strong> {{ \Carbon\Carbon::parse($bid->ReceivedAt)->format('d M Y H:i') }}
                                                </div>
                                            @endif
