...
<div class="container mt-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        @if(isset($needsCommitteeSetup) && $needsCommitteeSetup || isset($needsCriteriaSetup) && $needsCriteriaSetup)
            <div class="text-end">
                <div class="text-danger fw-bold">IMPORTANT: You must appoint the Tender Committee and set up Tender
                    Criteria before performing evaluations.
                    <br>
                    @if(isset($needsCommitteeSetup) && $needsCommitteeSetup)
                        <a href="/procurement/tendercommittee" class="btn btn-sm btn-outline-primary mt-2 me-2">Appoint
                            Tender Committee</a>
                    @endif
                    @if(isset($needsCriteriaSetup) && $needsCriteriaSetup)
                        <a href="/procurement/tenderevaluations" class="btn btn-sm btn-outline-danger mt-2">Go to Tender
                            Criteria Setup</a>
                    @endif
                </div>
            </div>
    ...
    <div class="w-100 mb-3">
        <div class="alert alert-danger fw-bold mb-0" role="alert">
            ...
            <div class="mt-2">
                <a href="/procurement/tendercommittee" class="btn btn-sm btn-outline-light me-2">Appoint Tender
                    Committee</a>
                                ...
                                <div class="card bg-light">
                                    <div class="card-body">
                                        ...
                                        <div class="d-grid gap-2">
                                            <a href="{{ route('memberresponse.index') }}"
                                               class="btn btn-sm btn-outline-primary">
                                                <i class="fas fa-reply"></i> Member Response
                                            </a>
                                            <a href="{{ route('tendercommittee.index') }}"
                    ...
                    <tr class="table-light">
                        ...
                        <td colspan="4">
                            <small class="text-muted">
                                ...
                                Range: {{ $bid['currency'] }} {{ number_format($tenderBids->min('bid_amount'), 2) }}
                                - {{ number_format($tenderBids->max('bid_amount'), 2) }}
                            </small>
                        </td>
                        <td class="text-center">
                            <small class="text-muted">
                                {{ $tenderBids->where('has_evaluated', true)->count() }}/{{ $tenderBids->count() }}
                                evaluated
                            </small>
                        </td>
                        <td></td>
