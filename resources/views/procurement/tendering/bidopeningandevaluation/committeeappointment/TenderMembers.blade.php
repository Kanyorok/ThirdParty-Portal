...
<div class="container mt-4">
    <h4 class="mb-3">📄 Members with Roles ({{$tenderTitle}})</h4>
     <a href="{{ route('assignrole.create') }}" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#addRoleModal">
        Assign Role</a>
            ...
            <form action="{{route('tendercommittee.save')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="tenderTitle" class="form-control" id="tenderRef" value="{{$tenderTitle}}" readonly>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select class="form-select" name="memberRole[]">
                                                    <option disabled {{ $item->Role == null ? 'selected' : '' }}>-- Select Role --</option>
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center py-4"> 
                                                ...
                                                No Members Yet. <a href="#" data-bs-toggle="modal" data-bs-target="#addRoleModal">Create a new one?</a>
                                            </td>
                                        </tr>
