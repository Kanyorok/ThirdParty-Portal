                        ...
                        <form action="{{ route('bidresponsiveness.update', $bid) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control"
                                           value="{{ $tenderSupplier->tender->TenderNo ?? 'N/A' }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select class="form-select" name="IsEligible" required>
                                        <option value="" disabled>-- Select --</option>
                                        <option
                                            value="1" {{ old('IsEligible', $bid->IsEligible) == 1 ? 'selected' : '' }}>
                                            Yes
                                        </option>
                                        <option
                                            value="0" {{ old('IsEligible', $bid->IsEligible) == 0 ? 'selected' : '' }}>
                                            No
                                        </option>
                                    </select>
                                </div>
                            ...
                            <div class="mt-3">
                                ...
                                <textarea class="form-control" name="Remarks" rows="3"
                                          placeholder="E.g. Missing tax clearance certificate">{{ old('Remarks', $bid->Remarks) }}</textarea>
                            </div>
