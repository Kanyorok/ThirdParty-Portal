    ...
    <div class="container mt-4">
        ...
        <form action="{{ route('bidresponsiveness.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ $tenderSupplier->supplier->SupplierName ?? 'N/A' }}"
                       readonly>
            </div>
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="SubmittedTimely" required>
                        <option value=""
                                disabled {{ old('SubmittedTimely', $bid->SubmittedTimely ?? '') === '' ? 'selected' : '' }}>
                            -- Select --
                        </option>
                        <option
                            value="1" {{ old('SubmittedTimely', $bid->SubmittedTimely ?? '') == 1 ? 'selected' : '' }}>
                            Yes
                        </option>
                        <option
                            value="0" {{ old('SubmittedTimely', $bid->SubmittedTimely ?? '') == 0 ? 'selected' : '' }}>
                            No
                        </option>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="HasMandatoryDocuments" required>
                        <option value=""
                                disabled {{ old('HasMandatoryDocuments', $bid->HasMandatoryDocuments ?? '') === '' ? 'selected' : '' }}>
                            -- Select --
                        </option>
                        <option
                            value="1" {{ old('HasMandatoryDocuments', $bid->HasMandatoryDocuments ?? '') == 1 ? 'selected' : '' }}>
                            Yes
                        </option>
                        <option
                            value="0" {{ old('HasMandatoryDocuments', $bid->HasMandatoryDocuments ?? '') == 0 ? 'selected' : '' }}>
                            No
                        </option>
                    </select>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" name="IsEligible" required>
                        <option value=""
                                disabled {{ old('IsEligible', $bid->IsEligible ?? '') === '' ? 'selected' : '' }}>--
                            Select --
                        </option>
                        <option value="1" {{ old('IsEligible', $bid->IsEligible ?? '') == 1 ? 'selected' : '' }}>Yes
                        </option>
                        <option value="0" {{ old('IsEligible', $bid->IsEligible ?? '') == 0 ? 'selected' : '' }}>No
                        </option>
                    </select>
                </div>
            </div>
