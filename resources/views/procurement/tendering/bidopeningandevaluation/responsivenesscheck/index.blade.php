        ...
        <form method="GET" class="row g-3 mb-3">
            <div class="col-md-3">
                <select name="tender_filter" class="form-select">
                    ...
                    @foreach($tenders as $tender)
                        <option
                            value="{{ $tender }}" {{ ($filters['tender_filter'] ?? '') === $tender ? 'selected' : '' }}>
                            {{ $tender }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="col-md-3">
                <select name="responsiveness_filter" class="form-select">
                    ...
                    <option value="1" {{ ($filters['responsiveness_filter'] ?? '') === '1' ? 'selected' : '' }}>
                        Responsive
                    </option>
                    <option value="0" {{ ($filters['responsiveness_filter'] ?? '') === '0' ? 'selected' : '' }}>
                        Non-Responsive
                    </option>
                </select>
            </div>
