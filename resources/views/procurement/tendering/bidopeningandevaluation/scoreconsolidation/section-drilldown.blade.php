                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div>
                                <span
                                    class="badge bg-info">{{ count($sectionData['evaluator_scores']) }} Evaluators</span>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex flex-wrap gap-2">
                            <a href="{{ route('bidscores.evaluator-drilldown', $tender->Id) }}"
