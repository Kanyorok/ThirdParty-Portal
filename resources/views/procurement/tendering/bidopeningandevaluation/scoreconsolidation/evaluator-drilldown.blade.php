                    ...
                    <div class="card h-100">
                        <div class="card-header">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="text-end">
                                    <div class="h5 mb-0 text-primary">{{ $evaluator['total_weighted_score'] }}%</div>
                            ...
                            @else
                                    ...
                                    @foreach($evaluator['section_scores'] as $sectionScore)
                                        <div class="mb-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <small class="text-muted">{{ $sectionScore['section_weight'] }}%</small>
                                            </div>
                                ...
                                <div class="mt-3 p-2 bg-light rounded">
                                    <div class="row text-center">
                                        <div class="col-4">
                                            <div class="small fw-bold text-primary">{{ number_format($avgPercentage, 1) }}%</div>
                                        ...
                                        <div class="col-4">
                                            <div class="small fw-bold text-info">{{ number_format($consistency, 0) }}%</div>
                            ...
                            <tr>
                                ...
                                @if(!empty($evaluatorDetails))
                                    @foreach($evaluatorDetails[0]['section_scores'] as $section)
                                        <th class="text-center">{{ $section['section_name'] }} ({{ $section['section_weight'] }}%)</th>
                                    @endforeach
                                @endif
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        <a href="{{ route('bidscores.section-drilldown', $tender->Id) }}" class="btn btn-outline-primary btn-sm">
                            <i class="fas fa-chart-bar"></i> Section-wise Analysis
                        </a>
                        <a href="{{ route('bidscores.index', ['tender_id' => $tender->Id]) }}" class="btn btn-outline-info btn-sm">
