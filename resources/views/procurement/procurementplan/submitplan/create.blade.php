...
<div class="container mt-4">
    ...
    @php
        ...
        // Calculate how many are fully completed
        $completed = $plan->lineItems->filter(function ($item) {
    ...
    <div class="row text-center mb-4">
        ...
        <div class="col-md-3">
            <div class="border p-3 rounded bg-white">
                <h6>Budget Linked</h6>
                <h4 class="text-warning">{{ $budgetLinked }} / {{ $total }}</h4>
            </div>
        </div>
        <div class="col-md-3">
            <div class="border p-3 rounded bg-white">
                <h6>Method Assigned</h6>
                <h4 class="text-warning">{{ $methodAssigned }} / {{ $total }}</h4>
            </div>
        </div>
        <div class="col-md-3">
            <div class="border p-3 rounded bg-white">
                <h6>Scheduled</h6>
                <h4 class="text-warning">{{ $scheduled }} / {{ $total }}</h4>
            </div>
        </div>
    </div>
