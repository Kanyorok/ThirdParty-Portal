...
use App\Models\Legal\LoanSecurity;use App\Models\Settings\WorkFlowLimit;
...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Gate::policy(UOMConversion::class, UOMConversionPolicy::class);        Gate::policy(WorkFlowLimit::class, WorkFlowLimitPolicy::class);
