...
class CBSService
{
     ...
     * }
     */
    public function createClient(Branch $branch, GenderEnum $gender, User $actor, Carbon $dob, string $first_name, string $surname, string $memberClassId,
                                 string $govtId, string $taxID, string $phoneNumber, string $email, string $address1, string $address2, string $countyId, string $occupation): ?object
    {
        $data = collect([
