...
class PropertyMaintenanceAssignService
{
    ...
    public static function create(
        ...
        Employee $internalTechnician = null,
        Supplier $prequalifiedVendor = null,
        ...
        $assignment = PropertyMaintenanceAssign::create([
            ...
            'Floor' => $floor,
            'Unit' => $unit,
            'AssignmentDate' => $assignmentDate->format('Y-m-d'),
            'AssignmentType' => $assignmentType->Id,
            'InternalTechnician' => $internalTechnician?->Id ?? null,
            'PrequalifiedVendor' => $prequalifiedVendor?->Id ?? null,
            'ExpectedStartDate' => $expectedStartDate->format('Y-m-d'),
            'ExpectedCompletion' => $expectedCompletion->format('Y-m-d'),
