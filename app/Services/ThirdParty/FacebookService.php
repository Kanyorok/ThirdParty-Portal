...
class FacebookService extends SocialService
{
    private const PAGE_POST_FIELDS = [
        PagePostFields::ID, PagePostFields::ADMIN_CREATOR, PagePostFields::IS_HIDDEN, PagePostFields::IS_ELIGIBLE_FOR_PROMOTION, PagePostFields::CREATED_TIME, PagePostFields::UPDATED_TIME,
        PagePostFields::MESSAGE, PagePostFields::PICTURE, PagePostFields::FULL_PICTURE, PagePostFields::IS_PUBLISHED, PagePostFields::SCHEDULED_PUBLISH_TIME, PagePostFields::SHARES,
        "likes.limit(0).summary(true)", "comments.limit(0).summary(true)", "reactions.summary(true)"
    ];
    private const PAGE_FIELDS = [
        PageFields::ID, PageFields::NAME, PageFields::NEW_LIKE_COUNT, PageFields::BIO, PageFields::WEBSITE, PageFields::WHATSAPP_NUMBER, PageFields::CONTACT_ADDRESS,
        PageFields::ABOUT, PageFields::CONNECTED_INSTAGRAM_ACCOUNT, PageFields::COVER, PageFields::WHATSAPP_NUMBER, PageFields::PAGE_TOKEN
    ];

    private const COMMENT_FIELDS = [
        CommentFields::ID, CommentFields::CAN_COMMENT, CommentFields::CAN_HIDE, CommentFields::CAN_LIKE, CommentFields::CREATED_TIME, CommentFields::LIKE_COUNT, CommentFields::COMMENT_COUNT,
        CommentFields::MESSAGE, CommentFields::FROM, CommentFields::ATTACHMENT, CommentFields::CAN_REMOVE,/* CommentFields::PARENT,*/
        CommentFields::IS_HIDDEN
    ];

    public const PAGE_PERMISSIONS = [
        'read_insights', 'publish_video', 'pages_manage_cta', 'pages_manage_instant_articles', 'pages_show_list', 'read_page_mailboxes',
        ...
        'page_events', 'pages_read_engagement', 'pages_manage_metadata', 'pages_read_user_content', 'pages_manage_ads', 'pages_manage_posts', 'pages_manage_engagement',
        'whatsapp_business_management', 'whatsapp_business_messaging',
        'leads_retrieval', 'business_management', 'ads_management', 'ads_read', 'catalog_management', 'manage_fundraisers', 'manage_app_solution', 'public_profile'
    ];
    ...
    {
        try {
            return json_decode(json_encode((new Page(id: $this->PageID, api: $this->api))
    ...
    protected function _uploadMedia(CRMImage $image): string
    {
        try {/*file_get_contents($imagePath), basename($imagePath)*/
            $response = Http::attach(
                'source', base64_decode($image->Image), ($image->Name) ?? 'filename', ['Content-Type' => $image->MIMEType]
