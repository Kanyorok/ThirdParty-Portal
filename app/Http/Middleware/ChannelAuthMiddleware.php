...
class ChannelAuthMiddleware
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($request->header('x-source') !== SystemIntegrationEnum::Channels->value) {
        ...
        try {
            $ApiCred = APICredential::query()->where('Integration', IntegrationsEnum::Channels->value)->latest('Id')->first();
    ...
    {
        SystemHelper::notifyAdmin('Channel Endpoints Authentication Failure : ' . $reason);
