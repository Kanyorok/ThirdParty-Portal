...
class IntegrationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
                'Integration'           => [
                                            'required',
                                            Rule::enum(IntegrationsEnum::class),
                                           ],

            #email
                'Incoming_Server'       => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Email->value,
                                            'required',
                                            'string',
                                            new isDomain(),
                                           ],
                ...
                'Incoming_Encryption'   => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Email->value,
                                            'required',
                                            Rule::enum(EmailEncryptionEnum::class),
                                           ],
                'Incoming_Username'     => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Email->value,
                                            'required',
            ...
            #sms
                'SMS_Priority'          => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::SMS->value,
                                            'required',
                                            'string',
                                            'max:100',
                                           ],
            ...
            #Facebook
                'FB_Page_Id'            => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Facebook->value,
                                            'required',
                                            'numeric',
                                           ],
                'FB_App_Id'             => [
            ...
            #Twitter X
                'X_Access_Token'        => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Twitter->value,
                                            'required',
                                            'string',
                                            'max:200',
                                           ],
            ...
            #Channels
                'Channel_Callback'      => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::Channels->value,
                                            'required',
                                            'string',
                                            'url:http,https',
                                            'active_url',
            ...
            #Artificial Intelligence
                'LLM_API_Key'           => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::LLM->value,
                                            'required',
                                            'string',
                                           ],
                'LLM_Provider'          => [
            ...
            #Core Banking
                'CBS_Host'              => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::CoreBanking->value,
                                            'required',
                                            'string',
                                            'url:http,https',
                                            'max:200',
            ...
            #InfoBip
                'InfoBip_Host'          => [
                                            'exclude_unless:Integration,' . IntegrationsEnum::InfoBip->value,
                                            'required',
                                            'string',
                                            'max:200',
                                           ],
