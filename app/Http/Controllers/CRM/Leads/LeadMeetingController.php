...
class LeadMeetingController extends Controller
{
    ...
    {
        return $this->meetings($lead->meetings());
    }
     ...
     */
    public function store(StartMeetingRequest $request, Lead $lead): JsonResponse
    {
        ...
        return $this->succeeded('entering meeting.', route('leads.show', $lead->LeadID) . "?meet=" . $meeting->MeetingID);
    }
    ...
    public function update(Request $request, Lead $lead, $meeting_id): JsonResponse
    {
        ...
        return $this->succeeded('meeting ended successful', route('leads.show', [$lead->LeadID]));
    }
}
