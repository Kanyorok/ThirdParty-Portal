...
class EmailConversationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('emails.conversations.index');
    }
    ...
    public function show($conversation_id)
    {
        ...
        return view('emails.conversations.show', compact('conversation'))
    ...
    public function summary($conversation_id)
    {
        ...
        return view('emails.conversations.summary', compact('conversation'));
    }
