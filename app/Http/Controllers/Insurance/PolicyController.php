...
class PolicyController extends Controller
{
    ...
    {
        $this->authorize(PermissionEnum::BancassuranceUnderwritingCreate->value, BancassurancePolicy::class);
        $validated = $request->validated();
    ...
    {
        $this->authorize(PermissionEnum::BancassuranceUnderwritingView->value, BancassurancePolicy::class);
    ...
    {
        $this->authorize(PermissionEnum::BancassurancePolicyView->value, BancassurancePolicy::class);
