...
use App\Models\Assets\Master\{Asset, AssetBookValue, AssetComponent, AssetMeter, AssetAttachment, AssetHistory, AssetCalibrationEvent};
use App\Models\Assets\Settings\{FixedAssetClass, AssetBook, AssetLocation, AssetServiceProvider};
...
class AssetController extends Controller
{
    ...
    public function show(int $id)
    {
        ...
        return view('assets.master.register.show', compact(
            'asset','classes','locations','books','bookValues','components','meters','attachments','history','calibrations','providers'
        ));
    }
