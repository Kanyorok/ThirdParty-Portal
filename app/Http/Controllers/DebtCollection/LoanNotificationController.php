...
class LoanNotificationController extends Controller
{
    ...
    public function index(Request $request): View|JsonResponse
    {
        ...
        return view('debt-collection.notifications.index');
    }
    ...
    public function create(LoanQueryRequest $request): View|JsonResponse
    {
        ...
        return view('debt-collection.notifications.create')
            ->with('dated', $dated)
    ...
    public function show($bulkNotificationID): RedirectResponse|View
    {
        ...
        return view('debt-collection.notifications.show', compact('bulkNotification'))
