...
/** GET /api/procurement/rfq-documents/{rfqId}
 *  → GET /api/v1/supplier/rfqs/{rfq}/documents */
export async function GET(
    ...
    const targetUrl = `${API_BASE.replace(/\/+$/, "")}/api/v1/supplier/rfqs/${encodeURIComponent(rfqId)}/documents`
