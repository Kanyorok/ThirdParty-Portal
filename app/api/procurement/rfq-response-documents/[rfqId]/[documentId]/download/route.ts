...
/** GET /api/procurement/rfq-response-documents/{rfqId}/{documentId}/download
 *  → GET /api/v1/supplier/rfqs/{rfq}/response-documents/{document}/download */
export async function GET(
    ...
    const targetUrl = `${API_BASE.replace(/\/+$/, "")}/api/v1/supplier/rfqs/${encodeURIComponent(rfqId)}/response-documents/${encodeURIComponent(documentId)}/download`
