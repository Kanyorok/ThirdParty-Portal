...
export default function TenantDocumentsPage() {
  ...
  const fetchDocs = useCallback(async () => {
    ...
    try {
      ...
      url.searchParams.set('my', '1') // Assuming tenant sees their "my" documents or we might need a specific filter
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-gray-50">
      <div className="container mx-auto px-4 py-8 md:py-12">
        <div className="mb-8 text-sm text-gray-500 dark:text-gray-400">Dashboard / <span className="font-semibold">Tenant Documents</span></div>
