...
class ThirdParties extends Model
{
    ...
    protected $fillable = [
        'ThirdPartyName', 'TradingName', 'BusinessType', 'RegistrationNumber', 'TaxPIN', 'VATNumber', 'CountryId', 'PhysicalAddress', 'Email', 'Phone',
        'Website', 'Status', 'Extra', 'CreatedBy', 'ModifiedBy', 'DeletedBy',
    ];
