    ...
    >
      <div className="flex items-center justify-between mb-2">
        <div className="space-y-1">
          <h2 className="text-2xl font-black uppercase tracking-tight">Edit Business Profile</h2>
          <p className="text-xs text-muted-foreground font-medium uppercase tracking-widest">
            Update your primary corporate information
          </p>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <motion.div variants={itemVariants} className="p-4 border rounded-lg bg-card">
            <div className="flex items-center gap-2 mb-4 pb-2 border-b">
              ...
              <h3 className="text-sm font-semibold">Core Business Details</h3>
            </div>
