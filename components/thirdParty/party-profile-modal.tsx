        ...
        <SheetContent className="w-full sm:max-w-xl flex flex-col">
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 overflow-y-auto pr-4 flex-grow">
                    ...
                    <FormField control={form.control} name="phone" render={({ field }) => <FormItem><FormLabel>Phone</FormLabel><FormControl><Input {...field} value={field.value ?? ""} placeholder="+254..." /></FormControl><FormMessage /></FormItem>} />
