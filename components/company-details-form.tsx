...
// import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/common/select'; // Adjusted import path
...
//     { value: BusinessTypeEnum.Technology, label: 'Technology' },
//     { value: BusinessTypeEnum.Manufacturing, label: 'Manufacturing' },
//     { value: BusinessTypeEnum.Construction, label: 'Construction' },
//     { value: BusinessTypeEnum.Consulting, label: 'Consulting' },
//     { value: BusinessTypeEnum.Retail, label: 'Retail' },
//     { value: BusinessTypeEnum.Government, label: 'Government' },
//     { value: BusinessTypeEnum.Other, label: 'Other' },
// ];
...
//                             </div>
//                             <div className="space-y-1">
//                                 <p className="font-medium text-gray-900">Third Party Type</p>
