...
export async function getProfile(): Promise<ProfileResponse> {
  const response = await api.get<ProfileResponse>("/api/v1/portal/auth/profile");
...
export async function updateProfile(
  ...
  const response = await api.put<ProfileResponse>("/api/v1/portal/auth/profile", profileData);
  return response.data;
}

export async function getCurrentUser(): Promise<ProfileResponse> {
  const response = await api.get<ProfileResponse>("/api/v1/portal/auth/me");
  return response.data;
}

// Available Profiles API
export async function getAvailableProfiles(): Promise<AvailableProfilesResponse> {
  const response = await api.get<AvailableProfilesResponse>("/api/v1/portal/auth/profile/available");
  return response.data;
}

// Supplier Profile API
export async function getSupplierProfile(): Promise<SupplierProfileResponse> {
  const response = await api.get<SupplierProfileResponse>("/api/v1/portal/auth/profile/supplier");
  return response.data;
}
...
export async function updateSupplierProfile(
  ...
  const response = await api.put<SupplierProfileResponse>("/api/v1/portal/auth/profile/supplier", data);
  return response.data;
}

// Tenant Profile API
export async function getTenantProfile(): Promise<TenantProfileResponse> {
  const response = await api.get<TenantProfileResponse>("/api/v1/portal/auth/profile/tenant");
  return response.data;
}
...
export async function updateTenantProfile(
  ...
  const response = await api.put<TenantProfileResponse>("/api/v1/portal/auth/profile/tenant", data);
  return response.data;
}

// Customer Profile API
export async function getCustomerProfile(): Promise<CustomerProfileResponse> {
  const response = await api.get<CustomerProfileResponse>("/api/v1/portal/auth/profile/customer");
  return response.data;
}
...
export async function updateCustomerProfile(
  ...
  const response = await api.put<CustomerProfileResponse>("/api/v1/portal/auth/profile/customer", data);
  return response.data;
}
