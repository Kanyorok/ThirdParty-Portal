/*! Select2 4.0.5 | https://github.com/select2/select2/blob/master/LICENSE.md */!(function (a) { typeof define === 'function' && define.amd ? define(['jquery'], a) : typeof module === 'object' && module.exports ? module.exports = function (b, c) { return void 0 === c && (c = typeof window !== 'undefined' ? require('jquery') : require('jquery')(b)), a(c), c; } : a(jQuery); }((a) => {
  const b = (function () {
    if (a && a.fn && a.fn.select2 && a.fn.select2.amd) var b = a.fn.select2.amd; var b; return (function () {
      ...
      }, D.prototype.set = function (b, c) { const d = a.camelCase(b); const e = {}; e[d] = c; const f = j._convertData(e); a.extend(this.defaults, f); }, new D();
    ...
    }), b.define('select2/compat/utils', ['jquery'], (a) => { function b(b, c, d) { let e; let f; const g = []; e = a.trim(b.attr('class')), e && (e = `${e}`, a(e.split(/\s+/)).each(function () { this.indexOf('select2-') === 0 && g.push(this); })), e = a.trim(c.attr('class')), e && (e = `${e}`, a(e.split(/\s+/)).each(function () { this.indexOf('select2-') !== 0 && (f = d(this)) != null && g.push(f); })), b.attr('class', g.join(' ')); } return { syncCssClasses: b }; }), b.define('select2/compat/containerCss', ['jquery', './utils'], (a, b) => { function c(a) { return null; } function d() {} return d.prototype.render = function (d) { const e = d.call(this); let f = this.options.get('containerCssClass') || ''; a.isFunction(f) && (f = f(this.$element)); let g = this.options.get('adaptContainerCssClass'); if (g = g || c, f.indexOf(':all:') !== -1) { f = f.replace(':all:', ''); const h = g; g = function (a) { const b = h(a); return b != null ? `${b} ${a}` : a; }; } let i = this.options.get('containerCss') || {}; return a.isFunction(i) && (i = i(this.$element)), b.syncCssClasses(e, this.$element, g), e.css(i), e.addClass(f), e; }, d; }), b.define('select2/compat/dropdownCss', ['jquery', './utils'], (a, b) => { function c(a) { return null; } function d() {} return d.prototype.render = function (d) { const e = d.call(this); let f = this.options.get('dropdownCssClass') || ''; a.isFunction(f) && (f = f(this.$element)); let g = this.options.get('adaptDropdownCssClass'); if (g = g || c, f.indexOf(':all:') !== -1) { f = f.replace(':all:', ''); const h = g; g = function (a) { const b = h(a); return b != null ? `${b} ${a}` : a; }; } let i = this.options.get('dropdownCss') || {}; return a.isFunction(i) && (i = i(this.$element)), b.syncCssClasses(e, this.$element, g), e.css(i), e.addClass(f), e; }, d; }), b.define('select2/compat/initSelection', ['jquery'], (a) => { function b(a, b, c) { c.get('debug') && window.console && console.warn && console.warn('Select2: The `initSelection` option has been deprecated in favor of a custom data adapter that overrides the `current` method. This method is now called multiple times instead of a single time when the instance is initialized. Support will be removed for the `initSelection` option in future versions of Select2'), this.initSelection = c.get('initSelection'), this._isInitialized = !1, a.call(this, b, c); } return b.prototype.current = function (b, c) { const d = this; if (this._isInitialized) return void b.call(this, c); this.initSelection.call(null, this.$element, (b) => { d._isInitialized = !0, a.isArray(b) || (b = [b]), c(b); }); }, b; }), b.define('select2/compat/inputData', ['jquery'], (a) => { function b(a, b, c) { this._currentData = [], this._valueSeparator = c.get('valueSeparator') || ',', b.prop('type') === 'hidden' && c.get('debug') && console && console.warn && console.warn('Select2: Using a hidden input with Select2 is no longer supported and may stop working in the future. It is recommended to use a `<select>` element instead.'), a.call(this, b, c); } return b.prototype.current = function (b, c) { function d(b, c) { const e = []; return b.selected || a.inArray(b.id, c) !== -1 ? (b.selected = !0, e.push(b)) : b.selected = !1, b.children && e.push.apply(e, d(b.children, c)), e; } for (var e = [], f = 0; f < this._currentData.length; f++) { const g = this._currentData[f]; e.push.apply(e, d(g, this.$element.val().split(this._valueSeparator))); }c(e); }, b.prototype.select = function (b, c) { if (this.options.get('multiple')) { let d = this.$element.val(); d += this._valueSeparator + c.id, this.$element.val(d), this.$element.trigger('change'); } else this.current((b) => { a.map(b, (a) => { a.selected = !1; }); }), this.$element.val(c.id), this.$element.trigger('change'); }, b.prototype.unselect = function (a, b) { const c = this; b.selected = !1, this.current((a) => { for (var d = [], e = 0; e < a.length; e++) { const f = a[e]; b.id != f.id && d.push(f.id); }c.$element.val(d.join(c._valueSeparator)), c.$element.trigger('change'); }); }, b.prototype.query = function (a, b, c) { for (var d = [], e = 0; e < this._currentData.length; e++) { const f = this._currentData[e]; const g = this.matches(b, f); g !== null && d.push(g); }c({ results: d }); }, b.prototype.addOptions = function (b, c) { const d = a.map(c, (b) => a.data(b[0], 'data')); this._currentData.push.apply(this._currentData, d); }, b; }), b.define('select2/compat/matcher', ['jquery'], (a) => { function b(b) { function c(c, d) { const e = a.extend(!0, {}, d); if (c.term == null || a.trim(c.term) === '') return e; if (d.children) { for (let f = d.children.length - 1; f >= 0; f--) { const g = d.children[f]; b(c.term, g.text, g) || e.children.splice(f, 1); } if (e.children.length > 0) return e; } return b(c.term, d.text, d) ? e : null; } return c; } return b; }), b.define('select2/compat/query', [], () => { function a(a, b, c) { c.get('debug') && window.console && console.warn && console.warn('Select2: The `query` option has been deprecated in favor of a custom data adapter that overrides the `query` method. Support will be removed for the `query` option in future versions of Select2.'), a.call(this, b, c); } return a.prototype.query = function (a, b, c) { b.callback = c, this.options.get('query').call(null, b); }, a; }), b.define('select2/dropdown/attachContainer', [], () => { function a(a, b, c) { a.call(this, b, c); } return a.prototype.position = function (a, b, c) { c.find('.dropdown-wrapper').append(b), b.addClass('select2-dropdown--below'), c.addClass('select2-container--below'); }, a; }), b.define('select2/dropdown/stopPropagation', [], () => { function a() {} return a.prototype.bind = function (a, b, c) { a.call(this, b, c); const d = ['blur', 'change', 'click', 'dblclick', 'focus', 'focusin', 'focusout', 'input', 'keydown', 'keyup', 'keypress', 'mousedown', 'mouseenter', 'mouseleave', 'mousemove', 'mouseover', 'mouseup', 'search', 'touchend', 'touchstart']; this.$dropdown.on(d.join(' '), (a) => { a.stopPropagation(); }); }, a; }), b.define('select2/selection/stopPropagation', [], () => { function a() {} return a.prototype.bind = function (a, b, c) { a.call(this, b, c); const d = ['blur', 'change', 'click', 'dblclick', 'focus', 'focusin', 'focusout', 'input', 'keydown', 'keyup', 'keypress', 'mousedown', 'mouseenter', 'mouseleave', 'mousemove', 'mouseover', 'mouseup', 'search', 'touchend', 'touchstart']; this.$selection.on(d.join(' '), (a) => { a.stopPropagation(); }); }, a; }), (function (c) { typeof b.define === 'function' && b.define.amd ? b.define('jquery-mousewheel', ['jquery'], c) : typeof exports === 'object' ? module.exports = c : c(a); }((a) => {
      function b(b) { const g = b || window.event; const h = i.call(arguments, 1); let j = 0; let l = 0; let m = 0; let n = 0; let o = 0; let p = 0; if (b = a.event.fix(g), b.type = 'mousewheel', 'detail' in g && (m = -1 * g.detail), 'wheelDelta' in g && (m = g.wheelDelta), 'wheelDeltaY' in g && (m = g.wheelDeltaY), 'wheelDeltaX' in g && (l = -1 * g.wheelDeltaX), 'axis' in g && g.axis === g.HORIZONTAL_AXIS && (l = -1 * m, m = 0), j = m === 0 ? l : m, 'deltaY' in g && (m = -1 * g.deltaY, j = m), 'deltaX' in g && (l = g.deltaX, m === 0 && (j = -1 * l)), m !== 0 || l !== 0) { if (g.deltaMode === 1) { const q = a.data(this, 'mousewheel-line-height'); j *= q, m *= q, l *= q; } else if (g.deltaMode === 2) { const r = a.data(this, 'mousewheel-page-height'); j *= r, m *= r, l *= r; } if (n = Math.max(Math.abs(m), Math.abs(l)), (!f || n < f) && (f = n, d(g, n) && (f /= 40)), d(g, n) && (j /= 40, l /= 40, m /= 40), j = Math[j >= 1 ? 'floor' : 'ceil'](j / f), l = Math[l >= 1 ? 'floor' : 'ceil'](l / f), m = Math[m >= 1 ? 'floor' : 'ceil'](m / f), k.settings.normalizeOffset && this.getBoundingClientRect) { const s = this.getBoundingClientRect(); o = b.clientX - s.left, p = b.clientY - s.top; } return b.deltaX = l, b.deltaY = m, b.deltaFactor = f, b.offsetX = o, b.offsetY = p, b.deltaMode = 0, h.unshift(b, j, l, m), e && clearTimeout(e), e = setTimeout(c, 200), (a.event.dispatch || a.event.handle).apply(this, h); } } function c() { f = null; } function d(a, b) { return k.settings.adjustOldDeltas && a.type === 'mousewheel' && b % 120 == 0; } let e; let f; const g = ['wheel', 'mousewheel', 'DOMMouseScroll', 'MozMousePixelScroll']; const h = 'onwheel' in document || document.documentMode >= 9 ? ['wheel'] : ['mousewheel', 'DomMouseScroll', 'MozMousePixelScroll']; var i = Array.prototype.slice; if (a.event.fixHooks) for (let j = g.length; j;)a.event.fixHooks[g[--j]] = a.event.mouseHooks; var k = a.event.special.mousewheel = {
        version: '3.1.12', setup() { if (this.addEventListener) for (let c = h.length; c;) this.addEventListener(h[--c], b, !1); else this.onmousewheel = b; a.data(this, 'mousewheel-line-height', k.getLineHeight(this)), a.data(this, 'mousewheel-page-height', k.getPageHeight(this)); }, teardown() { if (this.removeEventListener) for (let c = h.length; c;) this.removeEventListener(h[--c], b, !1); else this.onmousewheel = null; a.removeData(this, 'mousewheel-line-height'), a.removeData(this, 'mousewheel-page-height'); }, getLineHeight(b) { const c = a(b); let d = c['offsetParent' in a.fn ? 'offsetParent' : 'parent'](); return d.length || (d = a('body')), parseInt(d.css('fontSize'), 10) || parseInt(c.css('fontSize'), 10) || 16; }, getPageHeight(b) { return a(b).height(); }, settings: { adjustOldDeltas: !0, normalizeOffset: !0 },
