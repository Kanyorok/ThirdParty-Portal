...
*/
    ...
    */
    ...
    function summernote_bs3_typeof(o) {
      ...
      return summernote_bs3_typeof = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? function (o) {
        return typeof o;
      } : function (o) {
        return o && typeof Symbol === 'function' && o.constructor === Symbol && o !== Symbol.prototype ? 'symbol' : typeof o;
    ...
    const dropdown = renderer.create('<ul class="note-dropdown-menu dropdown-menu"></ul>', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
        const option = summernote_bs3_typeof(item) === 'object' ? item.option : undefined;
    ...
    const dropdownCheck = renderer.create('<ul class="note-dropdown-menu dropdown-menu note-check"></ul>', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
    ...
    const popover = renderer.create(['<div class="note-popover popover in">', '<div class="arrow"></div>', '<div class="popover-content note-children-container"></div>', '</div>'].join(''), ($node, options) => {
    ...
    const summernote_bs3_checkbox = renderer.create('<div class="checkbox"></div>', ($node, options) => {
    ...
    const ui = function ui(editorOptions) {
      return {
        ...
        button: function button($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1"></button>', ($node, options) => {
