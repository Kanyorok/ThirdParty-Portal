...
*/
    ...
    */
    ...
    function summernote_bs4_typeof(o) {
      ...
      return summernote_bs4_typeof = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? function (o) {
        return typeof o;
      } : function (o) {
        return o && typeof Symbol === 'function' && o.constructor === Symbol && o !== Symbol.prototype ? 'symbol' : typeof o;
    ...
    const dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" role="list"></div>', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
        const option = summernote_bs4_typeof(item) === 'object' ? item.option : undefined;
    ...
    const dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list"></div>', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
    ...
    const summernote_bs4_checkbox = renderer.create('<div class="form-check"></div>', ($node, options) => {
    ...
    const ui = function ui(editorOptions) {
      return {
        ...
        button: function button($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-light btn-sm" tabindex="-1"></button>', ($node, options) => {
