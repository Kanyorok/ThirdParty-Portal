...
*/
    ...
    */
    ...
    function summernote_bs5_typeof(o) {
      ...
      return summernote_bs5_typeof = typeof Symbol === 'function' && typeof Symbol.iterator === 'symbol' ? function (o) {
        return typeof o;
      } : function (o) {
        return o && typeof Symbol === 'function' && o.constructor === Symbol && o !== Symbol.prototype ? 'symbol' : typeof o;
      }, summernote_bs5_typeof(o);
    }
    ...
    const dropdown = renderer.create('<div class="note-dropdown-menu dropdown-menu" role="list">', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
        const option = summernote_bs5_typeof(item) === 'object' ? item.option : undefined;
    ...
    const dropdownCheck = renderer.create('<div class="note-dropdown-menu dropdown-menu note-check" role="list">', ($node, options) => {
      const markup = Array.isArray(options.items) ? options.items.map((item) => {
        const value = typeof item === 'string' ? item : item.value || '';
        const content = options.template ? options.template(item) : item;
    ...
    const dialog = renderer.create('<div class="modal note-modal" aria-hidden="false" tabindex="-1" role="dialog"></div>', ($node, options) => {
      if (options.fade) {
        $node.addClass('fade');
      }
      $node.attr({
    ...
    const popover = renderer.create(['<div class="note-popover popover bs-popover-auto show">', '<div class="popover-arrow"></div>', '<div class="popover-body note-popover-content note-children-container"></div>', '</div>'].join(''), ($node, options) => {
    ...
    const summernote_bs5_checkbox = renderer.create('<div class="form-check"></div>', ($node, options) => {
    ...
    const ui = function ui(editorOptions) {
      return {
        ...
        palette: function palette($node, options) {
          return renderer.create('<div class="note-color-palette"></div>', ($node, options) => {
            const contents = [];
        ...
        button: function button($node, options) {
          return renderer.create('<button type="button" class="note-btn btn btn-outline-secondary btn-sm" tabindex="-1">', ($node, options) => {
