(function (global, factory) {
  ...
  function rangePlugin(config) {
    ...
    return function (fp) {
      ...
      let _prevDates;
      const createSecondInput = function () {
        if (config.input) {
      ...
      var plugin = {
        ...
        onValueUpdate(selDates) {
          ...
          _a = fp.selectedDates.map((d) => fp.formatDate(d, dateFormat)), _b = _a[0], fp._input.value = _b === void 0 ? '' : _b, _c = _a[1], secondInput.value = _c === void 0 ? '' : _c;
        },
      };
      return plugin;
    };
