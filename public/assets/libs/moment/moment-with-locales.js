(function (global, factory) {
  ...
  hooks.defineLocale('ar-sa', {
    ...
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$1[match]).replace(/,/g, '،');
    },
    week: {
      dow: 0, // Sunday is the first day of the week.
      doy: 6, // The week that contains Jan 1st is the first week of the year.
  ...
  hooks.defineLocale('ar', {
    ...
    preparse(string) {
      return string.replace(/[١٢٣٤٥٦٧٨٩٠]/g, (match) => numberMap$1[match]).replace(/،/g, ',');
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$2[match]).replace(/,/g, '،');
    },
    week: {
      dow: 6, // Saturday is the first day of the week.
      doy: 12, // The week that contains Jan 1st is the first week of the year.
  ...
  hooks.defineLocale('bn', {
    ...
    preparse(string) {
      return string.replace(/[১২৩৪৫৬৭৮৯০]/g, (match) => numberMap$2[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$3[match]);
    },
  ...
  hooks.defineLocale('bo', {
    ...
    preparse(string) {
      return string.replace(/[༡༢༣༤༥༦༧༨༩༠]/g, (match) => numberMap$3[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$4[match]);
    },
  ...
  const months$3 = 'leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec'.split('_');
  ...
  hooks.defineLocale('el', {
    ...
    months(momentToFormat, format) {
      ...
      } if (typeof format === 'string' && /D/.test(format.substring(0, format.indexOf('MMMM')))) { // if there is a day number before 'MMMM'
  ...
  const monthsShortDot$1 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_');
  ...
  const monthsShortDot$2 = 'ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.'.split('_');
  const monthsShort$3 = 'ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic'.split('_');

  const monthsParse$1 = [/^ene/i, /^feb/i, /^mar/i, /^abr/i, /^may/i, /^jun/i, /^jul/i, /^ago/i, /^sep/i, /^oct/i, /^nov/i, /^dic/i];
  const monthsRegex$2 = /^(enero|febrero|marzo|abril|mayo|junio|julio|agosto|septiembre|octubre|noviembre|diciembre|ene\.?|feb\.?|mar\.?|abr\.?|may\.?|jun\.?|jul\.?|ago\.?|sep\.?|oct\.?|nov\.?|dic\.?)/i;
  ...
  hooks.defineLocale('fa', {
    ...
    preparse(string) {
      return string.replace(/[۰-۹]/g, (match) => numberMap$4[match]).replace(/،/g, ',');
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$5[match]).replace(/,/g, '،');
    },
  ...
  const monthsShort$4 = ['Faoi', 'Gear', 'Màrt', 'Gibl', 'Cèit', 'Ògmh', 'Iuch', 'Lùn', 'Sult', 'Dàmh', 'Samh', 'Dùbh'];

  const weekdays$1 = ['Didòmhnaich', 'Diluain', 'Dimàirt', 'Diciadain', 'Diardaoin', 'Dihaoine', 'Disathairne'];
  ...
  hooks.defineLocale('gu', {
    ...
    preparse(string) {
      return string.replace(/[૧૨૩૪૫૬૭૮૯૦]/g, (match) => numberMap$5[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$6[match]);
    },
  ...
  hooks.defineLocale('hi', {
    ...
    preparse(string) {
      return string.replace(/[१२३४५६७८९०]/g, (match) => numberMap$6[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$7[match]);
    },
  ...
  hooks.defineLocale('km', {
    ...
    ordinal: 'ទី%d',
    preparse(string) {
      return string.replace(/[១២៣៤៥៦៧៨៩០]/g, (match) => numberMap$7[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$8[match]);
    },
    week: {
      dow: 1, // Monday is the first day of the week.
      doy: 4, // The week that contains Jan 4th is the first week of the year.
  ...
  hooks.defineLocale('kn', {
    ...
    preparse(string) {
      return string.replace(/[೧೨೩೪೫೬೭೮೯೦]/g, (match) => numberMap$8[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$9[match]);
    },
  ...
  function eifelerRegelAppliesToNumber(number) {
    ...
    if (number < 0) {
      ...
      // 2 digits
      const lastDigit = number % 10; const
  ...
  hooks.defineLocale('mr', {
    ...
    preparse(string) {
      return string.replace(/[१२३४५६७८९०]/g, (match) => numberMap$9[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$a[match]);
    },
  ...
  hooks.defineLocale('my', {
    ...
    preparse(string) {
      return string.replace(/[၁၂၃၄၅၆၇၈၉၀]/g, (match) => numberMap$a[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$b[match]);
    },
    week: {
      dow: 1, // Monday is the first day of the week.
      doy: 4, // The week that contains Jan 1st is the first week of the year.
  ...
  hooks.defineLocale('ne', {
    ...
    preparse(string) {
      return string.replace(/[१२३४५६७८९०]/g, (match) => numberMap$b[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$c[match]);
    },
  ...
  const monthsShortWithDots$1 = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split('_');
  const monthsShortWithoutDots$1 = 'jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec'.split('_');

  const monthsParse$2 = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i];
  ...
  const monthsShortWithDots$2 = 'jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.'.split('_');
  const monthsShortWithoutDots$2 = 'jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec'.split('_');

  const monthsParse$3 = [/^jan/i, /^feb/i, /^maart|mrt.?$/i, /^apr/i, /^mei$/i, /^jun[i.]?$/i, /^jul[i.]?$/i, /^aug/i, /^sep/i, /^okt/i, /^nov/i, /^dec/i];
  const monthsRegex$4 = /^(januari|februari|maart|april|mei|april|ju[nl]i|augustus|september|oktober|november|december|jan\.?|feb\.?|mrt\.?|apr\.?|ju[nl]\.?|aug\.?|sep\.?|okt\.?|nov\.?|dec\.?)/i;
  ...
  hooks.defineLocale('pa-in', {
    ...
    preparse(string) {
      return string.replace(/[੧੨੩੪੫੬੭੮੯੦]/g, (match) => numberMap$c[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$d[match]);
    },
  ...
  const monthsParse$4 = [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[йя]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i];
  ...
  const months$7 = 'január_február_marec_apríl_máj_jún_júl_august_september_október_november_december'.split('_');
  ...
  hooks.defineLocale('ta', {
    ...
    preparse(string) {
      return string.replace(/[௧௨௩௪௫௬௭௮௯௦]/g, (match) => numberMap$d[match]);
    },
    postformat(string) {
      return string.replace(/\d/g, (match) => symbolMap$e[match]);
    },
