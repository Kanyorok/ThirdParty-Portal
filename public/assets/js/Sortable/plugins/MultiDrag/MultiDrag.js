...
let lastMultiDragSelect; // for selection with modifier key down (SHIFT)
let multiDragSortable;
let initialFolding = false; // Initial multi-drag fold when drag started
let folding = false; // Folding any other time
  ...
  MultiDrag.prototype = {
    ...
    dragStarted({ sortable }) {
      ...
      if (this.options.sort) {
        ...
        if (this.options.animation) {
          ...
          const dragRect = getRect(dragEl, false, true, true);
    ...
    dragOverCompleted({
      ...
      if (insertion) {
        ...
        if (options.animation && multiDragElements.length > 1 && (folding || !isOwner && !activeSortable.options.sort && !putSortable)) {
          ...
          const dragRectAbsolute = getRect(dragEl, false, true, true);
    ...
    dragOverAnimationCapture({ dragRect, isOwner, activeSortable }) {
      ...
      if (activeSortable.options.animation && !isOwner && activeSortable.multiDrag.isMultiDrag) {
        ...
        const dragMatrix = matrix(dragEl, true);
    ...
    drop({
      ...
      if (!dragStarted) {
        ...
        if (!~multiDragElements.indexOf(dragEl)) {
          ...
          if (evt.shiftKey && lastMultiDragSelect && sortable.el.contains(lastMultiDragSelect)) {
            ...
            const currentIndex = index(dragEl);
            ...
            if (~lastIndex && ~currentIndex && lastIndex !== currentIndex) {
              ...
              for (; i < n; i++) {
                ...
                const filtered = filter && (typeof filter === 'function'
                  ...
                  : filter.split(',').some((criteria) => closest(children[i], criteria.trim(), parentEl, false)));
      ...
      if (dragStarted && this.isMultiDrag) {
        ...
        if ((parentEl[expando].options.sort || parentEl !== rootEl) && multiDragElements.length > 1) {
          ...
          let multiDragIndex = index(dragEl, `:not(.${this.options.selectedClass})`);
