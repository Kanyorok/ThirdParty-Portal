...
const example3Left = document.getElementById('example3-left');
const example3Right = document.getElementById('example3-right');
const example4Left = document.getElementById('example4-left');
const example4Right = document.getElementById('example4-right');
...
const multiDragDemo = document.getElementById('multiDragDemo');
const swapDemo = document.getElementById('swapDemo');
...
const example7Sortable = new Sortable(example7, {
  animation: 150,
});

let example7SwapThreshold = 1;
const example7SwapThresholdInput = document.getElementById('example7SwapThresholdInput');
const example7SwapThresholdCode = document.getElementById('example7SwapThresholdCode');
const example7SwapThresholdIndicators = [].slice.call(document.querySelectorAll('.swap-threshold-indicator'));

const example7InvertSwapInput = document.getElementById('example7InvertSwapInput');
const example7InvertSwapCode = document.getElementById('example7InvertSwapCode');
const example7InvertedSwapThresholdIndicators = [].slice.call(document.querySelectorAll('.inverted-swap-threshold-indicator'));

const example7Squares = [].slice.call(document.querySelectorAll('.square'));

let activeIndicators = example7SwapThresholdIndicators;

const example7DirectionInput = document.getElementById('example7DirectionInput');
...
example7InvertSwapInput.addEventListener('change', (evt) => {
