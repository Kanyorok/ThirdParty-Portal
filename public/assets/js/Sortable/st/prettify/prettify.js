  ...
  (function () {
    function T(a) {
      function d(e) { let a = e.charCodeAt(0); if (a !== 92) return a; const c = e.charAt(1); return (a = w[c]) ? a : c >= '0' && c <= '7' ? parseInt(e.substring(1), 8) : c === 'u' || c === 'x' ? parseInt(e.substring(2), 16) : e.charCodeAt(1); } function f(e) { if (e < 32) return (e < 16 ? '\\x0' : '\\x') + e.toString(16); e = String.fromCharCode(e); return e === '\\' || e === '-' || e === ']' || e === '^' ? `\\${e}` : e; } function c(e) {
        ...
        } for (g = 0; g < b; ++g)a[g] === '^' && a[g + 1] !== '^' && (a[g] = ''); if (e.ignoreCase && q) for (g = 0; g < b; ++g)k = a[g], e = k.charAt(0), k.length >= 2 && e === '[' ? a[g] = c(k) : e !== '\\' && (a[g] = k.replace(/[a-zA-Z]/g, (a) => { a = a.charCodeAt(0); return `[${String.fromCharCode(a & -33, a | 32)}]`; })); return a.join('');
        ...
        }, r = [], n = 0, b = a.length; n < b; ++n) { p = a[n]; if (p.global || p.multiline) throw Error(`${p}`); r.push(`(?:${m(p)})`); } return new RegExp(r.join('|'), l ? 'gi' : 'g');
    } function U(a, d) {
      function f(a) {
    ...
    } function V(a) { for (var d = void 0, f = a.firstChild; f; f = f.nextSibling) var c = f.nodeType, d = c === 1 ? d ? a : f : c === 3 ? W.test(f.nodeValue) ? a : d : d; return d === a ? void 0 : d; } function G(a, d) {
      function f(a) {
...
+ k, v);
      ...
      const d = []; const f = []; a.tripleQuotedStrings ? d.push(['str', /^(?:\'\'\'(?:[^\'\\]|\\[\s\S]|\'{1,2}(?=[^\']))*(?:\'\'\'|$)|\"\"\"(?:[^\"\\]|\\[\s\S]|\"{1,2}(?=[^\"]))*(?:\"\"\"|$)|\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$))/,
        null, "'\""]) : a.multiLineStrings ? d.push(['str', /^(?:\'(?:[^\\\']|\\[\s\S])*(?:\'|$)|\"(?:[^\\\"]|\\[\s\S])*(?:\"|$)|\`(?:[^\\\`]|\\[\s\S])*(?:\`|$))/, null, "'\"`"]) : d.push(['str', /^(?:\'(?:[^\\\'\r\n]|\\.)*(?:\'|$)|\"(?:[^\\\"\r\n]|\\.)*(?:\"|$))/, null, "\"'"]); a.verbatimStrings && f.push(['str', /^@\"(?:[^\"]|\"\")*(?:\"|$)/, null]); let c = a.hashComments; c && (a.cStyleComments ? (c > 1 ? d.push(['com', /^#(?:##(?:[^#]|#(?!##))*(?:###|$)|.*)/, null, '#']) : d.push(['com', /^#(?:(?:define|e(?:l|nd)if|else|error|ifn?def|include|line|pragma|undef|warning)\b|[^\r\n]*)/,
...
+ d[0].length)) && a.parentNode.insertBefore(l.createTextNode(e), a.nextSibling), m(a), b || a.parentNode.removeChild(a));
      ...
      var d = a.j; try {
        var f = U(a.h, a.l); var c = f.a; a.a = c; a.c = f.c; a.i = 0; K(d, c)(a); var m = /\bMSIE\s(\d+)/.exec(navigator.userAgent); var m = m && +m[1] <= 8; var d = /\n/g; const t = a.a; const q = t.length; var f = 0; const l = a.c; const n = l.length; var c = 0; const b = a.g; let p = b.length; let w = 0; b[p] = q; let r; let e; for (e = r = 0; e < p;)b[e] !== b[e + 2] ? (b[r++] = b[e++], b[r++] = b[e++]) : e += 2; p = r; for (e = r = 0; e < p;) { for (var x = b[e], z = b[e + 1], v = e + 2; v + 2 <= p && b[v + 1] === z;)v += 2; b[r++] = x; b[r++] = z; e = v; }b.length = r; const g = a.h; a = ''; g && (a = g.style.display, g.style.display = 'none');
    ...
    var B = [B, 'case,done,elif,esac,eval,fi,function,in,local,set,then,until']; const S = /^(DIR|FILE|array|vector|(de|priority_)?queue|(forward_)?list|stack|(const_)?(reverse_)?iterator|(unordered_)?(multi)?(set|map)|bitset|u?(int|float)\d*)\b/; var W = /\S/; const X = x({
      keywords: [H, P, O, F, 'caller,delete,die,do,dump,elsif,eval,exit,foreach,for,goto,if,import,last,local,my,next,no,our,print,package,redo,require,sub,undef,unless,until,use,wantarray,while,BEGIN,END', Q, R, B], hashComments: !0, cStyleComments: !0, multiLineStrings: !0, regexLiterals: !0,
    });
    ...
    t(G([], [['atv', /^[\s\S]+/]]), ['uq.val']); t(x({
      keywords: H, hashComments: !0, cStyleComments: !0, types: S,
    }), 'c cc cpp cxx cyc m'.split(' ')); t(x({ keywords: 'null,true,false' }), ['json']); t(x({
      keywords: P, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: S,
    }), ['cs']); t(x({ keywords: O, cStyleComments: !0 }), ['java']); t(x({ keywords: B, hashComments: !0, multiLineStrings: !0 }), ['bash', 'bsh', 'csh', 'sh']); t(x({
    ...
    }), ['rb', 'ruby']); t(x({ keywords: F, cStyleComments: !0, regexLiterals: !0 }), ['javascript', 'js', 'ts', 'typescript']); t(x({
      ...
      prettyPrint: D.prettyPrint = function (a, d) {
        function f() {
          for (let c = D.PR_SHOULD_USE_CONTINUATION ? b.now() + 250 : Infinity; p < x.length && b.now() < c; p++) {
            for (var d = x[p], l = g, n = d; n = n.previousSibling;) { var m = n.nodeType; var u = (m === 7 || m === 8) && n.nodeValue; if (u ? !/^\??prettify\b/.test(u) : m !== 3 || /\S/.test(n.nodeValue)) break; if (u) { l = {}; u.replace(/\b(\w+)=([\w:.%+-]+)/g, (a, b, c) => { l[b] = c; }); break; } }n = d.className; if ((l !== g || r.test(n))
&& !e.test(n)) {
              m = !1; for (u = d.parentNode; u; u = u.parentNode) if (v.test(u.tagName) && u.className && r.test(u.className)) { m = !0; break; } if (!m) {
                d.className += ' prettyprinted'; m = l.lang; if (!m) { var m = n.match(w); var q; !m && (q = V(d)) && z.test(q.tagName) && (m = q.className.match(w)); m && (m = m[1]); } if (B.test(d.tagName))u = 1; else {
                  var u = d.currentStyle;
                  var y = t.defaultView;
                  var u = (u = u ? u.whiteSpace : y && y.getComputedStyle ? y.getComputedStyle(d, null).getPropertyValue('white-space') : 0) && u.substring(0, 3) === 'pre';
                } y = l.linenums; (y = y === 'true' || +y) || (y = (y = n.match(/\blinenums\b(?::(\d+))?/))
                  ? y[1] && y[1].length ? +y[1] : !0 : !1); y && L(d, y, u); M({
                  j: m, h: d, m: y, l: u, a: null, i: null, c: null, g: null,
                });
              }
            }
          }p < x.length ? D.setTimeout(f, 250) : typeof a === 'function' && a();
        } for (var c = d || document.body, t = c.ownerDocument || document, c = [c.getElementsByTagName('pre'), c.getElementsByTagName('code'), c.getElementsByTagName('xmp')], x = [], q = 0; q < c.length; ++q) for (let l = 0, n = c[q].length; l < n; ++l)x.push(c[q][l]); var c = null; var b = Date; b.now || (b = { now() { return +new Date(); } }); var p = 0; var w = /\blang(?:uage)?-([\w.]+)(?!\S)/; var r = /\bprettyprint\b/;
        var e = /\bprettyprinted\b/; var B = /pre|xmp/i; var z = /^code$/i; var v = /^(?:pre|code|xmp)$/i; var g = {}; f();
      },
    }; var H = D.define; typeof H === 'function' && H.amd && H('google-code-prettify', [], () => Y);
  }());
}());
