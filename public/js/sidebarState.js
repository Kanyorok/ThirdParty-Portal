...
export const SidebarState = (() => {
  ...
  function getState() {
    const s = read();
    const defaultRoute = window.__DEFAULT_ACTIVE_ROUTE__ || normalizePath(location.pathname);
    return {
      activeRouteId: s.activeRouteId ?? defaultRoute,
  ...
  return {
    init, restore: applyToDom, setActive, setOpenItemIds,
  };
})();
